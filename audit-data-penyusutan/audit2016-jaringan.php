...
$myfile = fopen ("data-selisih-jaringan-2016", "r") or die("Unable to open file!");
$aset_id_cek = fread ($myfile, filesize ("data-selisih-jaringan-2016"));
fclose ($myfile);
...
//$aset_id_cek="1867325";
//$aset_id_cek="2668813";
$query_data = "SELECT aset_id FROM `log_jaringan` WHERE kd_riwayat in (50,51) AND tglperubahan='2015-12-31 00:00:00' and aset_id in($aset_id_cek) ";
   ...
   // pr($data_log);
    ...
    foreach ($data_log as $key => $row_jaringan) {
        ...
        if($kd_riwayat == "2" || $kd_riwayat == "29") {
            ...
            /*$text_status = "51 2015 -(Kapitalisasi $kapitalisasi--NP $np_awal) update log_jaringan set NilaiBuku_Awal=$nb_awal_seharusnya,
                          NilaiBuku='$nb_seharusnya' where log_id=$log_id";*/
            $text_status = "update log_jaringan set NilaiBuku_Awal=$nb_awal_seharusnya,
                          NilaiBuku='$nb_seharusnya' where log_id=$log_id;";
        }
                            ...
                            `kondisi`, `CaraPerolehan`, `Konstruksi`, `Panjang`,
                             `Lebar`, `NoDokumen`, `TglDokumen`, `StatusTanah`, `NoSertifikat`,
                              ...
                              `UmurEkonomis`, `TahunPenyusutan`, `nilai_kapitalisasi`,
                               ...
                               '49','2016-12-31' from log_jaringan where log_id=$log_id;";
         ...
         //   pr($data[ $index ]);
            ...
            $query_penyusutan_2016="INSERT INTO `log_jaringan`(`Jaringan_ID`, `Aset_ID`, `kodeKelompok`, `kodeSatker`, `kodeLokasi`, `noRegister`, `TglPerolehan`, `TglPembukuan`, `kodeData`, `kodeKA`, `kodeRuangan`, `StatusValidasi`, `Status_Validasi_Barang`, `StatusTampil`, `Tahun`, `NilaiPerolehan`, `Alamat`, `Info`, `AsalUsul`, `kondisi`, `CaraPerolehan`, `Konstruksi`, `Panjang`, `Lebar`, `NoDokumen`, `TglDokumen`, `StatusTanah`, `NoSertifikat`, `TglSertifikat`, `Tanah_ID`, `KelompokTanah_ID`, `GUID`, 
                        `TanggalPemakaian`, `LuasJaringan`, `MasaManfaat`, 
                        `AkumulasiPenyusutan`, `NilaiBuku`, `PenyusutanPerTahun`, `UmurEkonomis`, 
                        `TahunPenyusutan`, `nilai_kapitalisasi`, `prosentase`,
                         `penambahan_masa_manfaat`, `jenis_belanja`, `kodeKelompokReklasAsal`,
                            ...
                            `kondisi`, `CaraPerolehan`, `Konstruksi`, `Panjang`,
                             `Lebar`, `NoDokumen`, `TglDokumen`, `StatusTanah`, `NoSertifikat`,
                              ...
                              '$Sisa_Masa_Manfaat', '$tahun_pelaporan', `nilai_kapitalisasi`,
                               ...
                               '$riwayat','2016-12-31' from log_jaringan where log_id=$log_final_2016;";
        ...
        if($tahun_pelaporan != 0) {
            ...
            if($kd_riwayat == "51" && $tahun_pelaporan == "2015" &&$status_revisi_2015==1) {
                ...
                <td colspan='24'>
                    ...
                    $query_update_koreksi_penyusutan = "INSERT INTO `log_jaringan`(`Jaringan_ID`, `Aset_ID`, `kodeKelompok`, `kodeSatker`,
