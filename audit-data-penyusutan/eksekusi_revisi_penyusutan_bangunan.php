...
$query_data = "SELECT  aset_id,umurekonomis,MasaManfaat,kd_riwayat,TglPerubahan,NilaiPerolehan,NilaiPerolehan_Awal,
...
while ($row = $DBVAR->fetch_array ($result)) {
    ...
    echo "$info<br/>";
    logfile($info,"eksekusiBPK-bangunan/revisi-$Aset_ID.txt");
    ...
    while($row_history=$DBVAR->fetch_array ($result_history)){
        ...
        Tahun,TglPerolehan,TglPembukuan,kodeKA,StatusValidasi,Status_Validasi_Barang,StatusTampil,jenis_hapus,
        MasaManfaat,kd_riwayat,TglPerubahan,NilaiPerolehan,NilaiPerolehan_Awal,(NilaiPerolehan-NilaiPerolehan_Awal)as np,AkumulasiPenyusutan,AkumulasiPenyusutan_Awal,(AkumulasiPenyusutan-AkumulasiPenyusutan_Awal)as akm,NilaiBuku,NilaiBuku_Awal, PenyusutanPerTahun,PenyusutanPerTahun_Awal FROM `log_bangunan` where Kd_Riwayat in(50,51) and TglPerubahan='2016-12-31'
        ...
        if($status_pertama==0){
            ...
            $PenyusutanPerTahun_log=$PenyusutanPerTahun;
                 ...
                 $query="INSERT INTO `log_bangunan`(`log_id`, `Aset_ID`, `kodeKelompok`,
