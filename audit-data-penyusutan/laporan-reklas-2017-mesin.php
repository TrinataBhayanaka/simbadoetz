...
$query_data = "SELECT Aset_ID,KodeSatker,KodeKelompok,Tahun,NoRegister,TahunPenyusutan,umurekonomis,MasaManfaat,kd_riwayat,TglPerubahan,NilaiPerolehan,NilaiPerolehan_Awal,(NilaiPerolehan-NilaiPerolehan_Awal)as np,AkumulasiPenyusutan,AkumulasiPenyusutan_Awal,(AkumulasiPenyusutan-AkumulasiPenyusutan_Awal)as akm,nilaibuku,NilaiBuku_Awal, PenyusutanPerTahun,PenyusutanPerTahun_Awal,bp_log,bp,(bp-bp_log)as selisih FROM `perhitungan_reklas_mesin` where ((bp_log-bp)>2 or (bp_log-bp)<-2) and Kd_Riwayat in(50,51) ORDER BY Aset_ID";
