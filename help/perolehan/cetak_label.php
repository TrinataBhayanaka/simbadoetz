        ...
        <div id="tengah">	
            <div id="frame_tengah">
                <div id="" style="padding: 10px">
					...
					<p align="center"><input type="button" value="<< Previous" onClick="window.location.href='<?php echo "$url_rewrite/help/perolehan/"?>validasi.php'"> &nbsp;<input type='BUTTON' value='TOC' onClick="window.location.href='<?php echo "$url_rewrite/help/perolehan/"?>'">&nbsp;  <input type='BUTTON' value='Next >>' onClick="window.location.href='<?php echo "$url_rewrite/help/perolehan/"?>cetak_dokumen_pengadaan.php'"></p>
                    </fieldset>
                </div>
            </div>
        </div>
