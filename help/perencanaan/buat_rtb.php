    ...
    <body>
        ...
        <div id="tengah1">	
            <div id="frame_tengah1">
                <div id="frame_gudang">
                    <div id='topright'><label>Help &raquo;</label><label> Perencanaan &raquo; Buat Rencana Tahunan Barang <label></div>;
                        <div id='bottomright' style='border:0px'>
							<p>Sub menu Buat Rencana Tahunan Barang memiliki 2 alur pengoperasian sebagai berikut :</p><br>
								<img src = "alur_shb.png"><br><br>
								<p>Langkah-langkah pengoperasian sub menu Buat Rencana Tahunan Barang adalah sebagai berikut:</p><br>
								<ol style="Padding-left:20px;">
									<li>Arahkan pointer mouse ke Sub menu Buat RTB.</li><br>
									<li>Klik sub menu Buat RTB</li><br>
										<img src = "rtb1.png"><br><br>
									<li>Untuk melakukan pencarian pada sub menu Buat RTB, pengguna dapat mengisi salah satu atau semua field pada seleksi pencarian, seperti contoh berikut:</li><br>
										<img src = "rtb2.png"><br><br>
								...
								<table width="100%">
									<tr>
										...
										<td style="text-align:right"> <a href="buat_rtpb.php" style="color:#0000ff;font-size:20px">Next</a></td>
									</tr>
								</table>
						</div>
				</div>
