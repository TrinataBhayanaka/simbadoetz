        ...
        <div id="tengah">	
            <div id="frame_tengah">
                <div id="" style="padding: 10px">
					...
					<br><br>
					<p style='font-size:17px' >Sub Menu Katalog Aset</p>
					<br>
					<p style='font-size:14px'>Pada sub menu Katalog Aset berfungsi untuk melihat aset pemda apa saja yang ada di dalam database SIMBADA. Kemudian pengguna dapat memilih, melihat dan mencetak daftar aset yang diinginkan. Cara menggunakannya sebagai berikut :</p>
					<br>
					<ol style="padding: 18px"><li>Klik sub menu Katalog Aset.<br><p align="center"><img  src="../katalog_aset/image/submenu_katalog.png"></p><br>
					...
					<li>Setelah dilakukan seleksi pada form seleksi pencarian, jika tombol LANJUT diklik dan akan muncul form notifikasi lalu klik OK, maka akan muncul form hasil seleksi pencarian, seperti dibawah ini : <br><br><p align="center"><img  src="../katalog_aset/image/filter.png"></p><br><br></li><br>
					<li>Klik Kembali ke halaman utama : Cari Aset, digunakan untuk kembali ke halaman seleksi pencarian aset.</li><br>
					<li>Klik Cetak Seluruh Data, digunakan untuk mencetak daftar aset secara keseluruhan dalam bentuk File PDF.</li><br>
					<li>Klik Cetak Dari Daftar Anda, digunakan untuk mencetak daftar aset berdasarkan pilihan yang diinginkan dalam bentuk File PDF.</li><br>
					<li>Klik Katalog, digunakan untuk mendownload daftar aset dalam bentik File PDF.</li>
					</li></ol>
