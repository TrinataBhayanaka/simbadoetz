            ...
            <div id="frame_tengah1">
                <div id="frame_gudang">
                    ...
                    <p>&nbsp; &nbsp; &nbsp; &nbsp;Penghapusan adalah tindakan menghapus barang milik daerah dari daftar barang dengan menerbitkan surat keputusan dari pejabat yang berwenang untuk membebaskan pengguna dan/atau kuasa pengguna dan/atau pengelola dari tanggung jawab administrasi dan fisik atas barang yang berada dalam penguasaannya. Dalam hal ini penghapusan tejadi di SKPD dimana barang yang dimaksud berada. Barang bisa dihapuskan jika barang tersebut sudah tidak layak pakai atau rusak berat.:</p><br><br>
						<p style="text-align:center"><a href="?page=help&content=perencanaan.php" ><input type="button" value="Perencanaan" style="color:#0000ff;font-size:13px"></a>------><a href="?page=help&content=perolehanaset.php"><input type="button" value="Perolehan Aset" style="color:#0000ff;font-size:13px"></a>------><a href="?page=help&content=gudang.php"><input type="button" value="Gudang" style="color:#0000ff;font-size:13px"></Gudang></a>------><a href="?page=help&content=penghapusan.php"><input type="button" value="Penghapusan"  style="color:#0000ff;font-size:13px"></a></p>
						<br>
						<br>
						<br>
