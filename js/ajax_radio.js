   ...
   function dropDownRadioButton_Kelompok(sumber_data, id_elemen,tbody)
   { 
      if (xmlHttp != null)
      {
         var obj = document.getElementById(id_elemen);
         ...
         xmlHttp.onreadystatechange = function ()
         {
            ...
            {
               //obj.innerHTML=xmlHttp.responseText;
             addRadioButtonKelompok(xmlHttp.responseText, id_elemen,tbody);
            }
         }  
...
function addRadioButtonKelompok(content,id_elemen,tbody)
{
         ...
         if (hasil[i]!=""){
           var isi_field=hasil[i].split("]");
               if(isi_field[5]!='6' ){
					...
					simbol=document.createTextNode("");
					} else {
					check2=document.createElement("input");
                    ...
                    check2.setAttribute('id',isi_field[8]);
                    check2.setAttribute('value',isi_field[6]);
					check2.setAttribute('onclick','SelectAllChild_'+tbody+'(this)');
					simbol=document.createTextNode("[+]");
					}
