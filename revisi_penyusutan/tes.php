...
$query_aset_penghapusan="select Aset_Id from log_bangunan where 
tglperubahan >='2015-01-01' group by aset_id having group_concat(kd_riwayat) like '7,49%' ";
...
$query_aset_transfer="select Aset_Id from log_bangunan where tglperubahan >='2015-01-01' 
	group by aset_id having group_concat(kd_riwayat) like '3,49%' ";

$aset_penghapusan_pemindahtangan="201072,201073,201176,201293,201702,201732";
$query_aset_penghapusan_pemindahtangan="select Aset_Id from log_bangunan where tglperubahan >='2015-01-01'
 group by aset_id having group_concat(kd_riwayat) like '26,49%' ";

$aset_ubah_data_biasa="201785,201806";
$query_aset_ubah_data_biasa="select Aset_Id from log_bangunan where tglperubahan >='2015-01-01' 
group by aset_id having group_concat(kd_riwayat) like '18,49%' ";
...
geser_log($link,$database,"log_bangunan",200971);
