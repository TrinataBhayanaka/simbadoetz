...
$PENGHAPUSAN = new RETRIEVE_PENGHAPUSAN;
	...
	// pr($_POST);
 //    exit;
		$data = $PENGHAPUSAN->update_usulan_penghapusan_asetid_pms($_POST);
    ...
    */
    echo "<script>alert('Data Berhasil DiUpdate'); document.location='$url_rewrite/module/penghapusan/dftr_review_edit_aset_usulan_pms.php?id=$id';</script>";
?>
