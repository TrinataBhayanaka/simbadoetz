   ...
   //          }
	...
	<section id="main">
		...
		<section class="formLegend">
			          ...
			          $('#usulan_pms_table').dataTable(
			                   {
			                    ...
			                    "bProcessing": true,
			                    "bServerSide": true,
			                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_usulan_pms.php?<?php echo $par_data_table?>"
			               }
			                  );
			      });
			    </script>
			...
			&nbsp;
			<div id="demo">
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="usulan_pms_table">
				<thead>
					<tr>
						<th>No</th>
						<th>Nomor Usulan</th>
