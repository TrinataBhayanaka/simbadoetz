...
?>
	...
	<?php
        ...
        // //////pr($data);        
	// //////pr($_POST);
	$data = $PENGHAPUSAN->retrieve_validasi_penghapusan_pmd($_POST);
	// ////pr($data);
	...
	<section id="main">
		<ul class="breadcrumb">
			  ...
			  <li class="active">Daftar Penetapan Penghapusan Pemindahtanganan Tervalidasi</li>
			  <?php SignInOut();?>
			</ul>
			<div class="breadcrumb">
				<div class="title">Validasi Penghapusan Pemindahtanganan</div>
				<div class="subtitle">Daftar Penetapan Penghapusan Pemindahtanganan Tervalidasi</div>
			</div>	
		...
		<section class="formLegend">
			...
			?>
			<p><a href="<?=$url_rewrite?>/module/penghapusan/dftr_penetapan_validasi_pmd.php" class="btn btn-info btn-small"><i class="icon-plus-sign icon-white"></i>&nbsp;&nbsp;Validasi Penetapan</a>
			&nbsp;
			<?php
				}
			?>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				...
				foreach($data as $key => $row)
					...
					<tr class="gradeA">
						...
						<!-- <a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penetapan_penghapusan_daftar_hapus_pmd.php?id=<?php echo "$row[Penghapusan_ID]";?>" class="btn btn-danger"> <i class="fa fa-trash"></i>
 Hapus</a>   -->
						</td>
					</tr>
					<?php $nomor++;} }?>
