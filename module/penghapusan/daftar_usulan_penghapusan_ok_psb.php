				...
				<tr>
					<td style="border: 1px solid #004933; height:50px; padding:2px;">
						<table width="100%">
							...
							$data = $PENGHAPUSAN->retrieve_usulan_penghapusan_eksekusi_tampil_psb($_GET);
							// pr($data);
							$no=1;
						...
						echo "<tr>
							...
							<tr>
								<td colspan=4 align=center>
									...
									<a href="<?php echo "$url_rewrite/module/penghapusan/daftar_usulan_penghapusan_filter_psb.php";?>"><input type="button" class="btn "name="submit2" value="Kembali ke Menu Utama"/></a>
