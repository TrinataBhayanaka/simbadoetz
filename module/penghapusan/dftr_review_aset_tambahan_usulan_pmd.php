...
?>
	...
	$data = $PENGHAPUSAN->retrieve_tambahan_usulan_penghapusan_eksekusi_pmd($POST);
	// //pr($data);
	$row=$data['dataRow'][0];
	...
	<section id="main">
		...
		<section class="formLegend">
			<form method="POST" ID="Form2" onsubmit="return confirmValidate()" action="<?php echo "$url_rewrite/module/penghapusan/"; ?>daftar_tambahan_usulan_penghapusan_usul_proses_pmd.php"> 
				...
				<thead>
					...
					<tr>
						<td colspan="10" align="Left">
								...
								<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>dftr_aset_tambahan_usulan_pmd.php?pid=1&flegAset=0" class="btn"/>Tambahkan Aset</a>
