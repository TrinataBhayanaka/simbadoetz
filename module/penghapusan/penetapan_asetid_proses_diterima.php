...
$PENGHAPUSAN = new RETRIEVE_PENGHAPUSAN;
    ...
    // $data=$DELETE->delete_update_daftar_validasi_penghapusan($id);
		...
		$data = $PENGHAPUSAN->Update_penetapan_penghapusan_asetid_diterima($_GET);
    ...
    */
    echo "<script>alert('Data Berhasil Diterima'); document.location='$url_rewrite/module/penghapusan/penetapan_penghapusan_tambah_data.php';</script>";
?>
