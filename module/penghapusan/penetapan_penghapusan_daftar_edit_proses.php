...
// $data=$UPDATE->update_daftar_penetapan_penghapusan($id,$no,$tgl,$olah_tgl,$keterangan,$submit);
	...
	$data = $PENGHAPUSAN->update_daftar_penetapan_penghapusan($_POST);
 ...
 *  * 
 */
    echo "<script>alert('Data Berhasil Disimpan'); document.location='$url_rewrite/module/penghapusan/penetapan_penghapusan_daftar_isi.php?pid=1';</script>";
