...
?>
          ...
          <section id="main">
			...
			<div class="breadcrumb">
				<div class="title">Daftar Usulan Penghapusan Sebagian</div>
						...
						<td>	
						 <!--<a href="<?php echo "$url_rewrite/report/template/PENGHAPUSAN/";?>tes_class_usulan_aset_yang_akan_dihapuskan.php?id=<?php echo "$hsl_data[Usulan_ID]";?>" target="_blank">Cetak</a> || -->
											...
											if($dataArr){
												...
												// echo "masukkkkkk";
												?>
													<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penghapusan_usulan_daftar_proses_hapus_psb.php?id=<?php echo "$hsl_data[Usulan_ID]";?>" class="btn btn-danger" onclick="return confirm('Hapus Data');">Hapus</a>
													<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penghapusan_usulan_daftar_view_edit_psb.php?id=<?php echo "$hsl_data[Usulan_ID]";?>" class="btn btn-success" onclick="return confirm('View Data');">View</a>
												<?php	
												}elseif($_SESSION['ses_uoperatorid'] == $hsl_data[UserNm]){
												?>
													<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penghapusan_usulan_daftar_proses_hapus_psb.php?id=<?php echo "$hsl_data[Usulan_ID]";?>" class="btn btn-danger" onclick="return confirm('Hapus Data');">Hapus</a>
