...
?>
	...
	<section id="main">
		...
		<section class="formLegend">
			...
			<form method="POST" action="<?php echo"$url_rewrite"?>/module/penghapusan/daftar_usulan_penghapusan_lanjut_pms.php?pid=1" onsubmit="return requiredFilter(true,false)">
			<ul><!-- 
							<li>
