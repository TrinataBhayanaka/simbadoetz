			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				...
				foreach($data as $key => $row)
					...
					<tr class="gradeA">
						...
						<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penetapan_penghapusan_daftar_hapus_pmd.php?id=<?php echo "$row[Penghapusan_ID]";?>" class="btn btn-danger btn-small"> <i class="fa fa-trash"></i>Hapus</a>  
						<?php
						}else{ ?>
							<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>dftr_review_edit_penetapan_usulan_pmd.php?id=<?php echo "$row[Penghapusan_ID]";?>" class="btn btn-success btn-small"><i class="fa fa-pencil-square-o"></i> View</a>&nbsp;
