          ...
          $('#usulan_psb_table').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_aset_tambahan_usulan_psb.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
			...
			<div id="demo">
			<form method="POST" ID="Form2" onsubmit="return confirmValidate()" action="<?php echo"$url_rewrite"?>/module/penghapusan/dftr_review_aset_tambahan_usulan_psb.php"> 
			<table cellpadding="0" cellspacing="0" border="0" class="display  table-checkable" id="usulan_psb_table">
				<thead>
					...
					<tr>
						<td colspan="10" align="center">
							...
							<span id="countcheckboxH" class="label label-success" style="display:none">Jumlah Data yang akan dibuat usulan <?=$CountData?> Data Aset</span>
						</td>
					</tr>
					<tr>
