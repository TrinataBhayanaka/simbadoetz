...
?>
	...
	<section id="main">
		...
		<section class="formLegend">
			...
			<form name="form" method="POST" action="<?php echo "$url_rewrite"; ?>/module/penghapusan/penetapan_penghapusan_daftar_isi.php?pid=1" onsubmit="return requiredFilter(false)">
			<ul>
							<!-- <li>
