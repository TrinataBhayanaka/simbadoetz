...
?>
	...
	jQuery(function($) {
		...
		function AreAnyCheckboxesChecked (item,totol) 
		{
				...
				if (!empty($data['dataRow']))
				{
					...
					<tr class="gradeA">
						...
						<td class="checkbox-column">
							...
							<input type="hidden" name="UsulanID[]" id="totol<?=$no?>"value="<?php echo $nilai[NilaiPerolehan];?>" />
							<input type="checkbox" class="checkbox" onchange="return AreAnyCheckboxesChecked(this,'totol<?=$no?>');" name="penghapusan_nama_aset[]" value="<?php echo $nilai[NilaiPerolehan];?>" >
