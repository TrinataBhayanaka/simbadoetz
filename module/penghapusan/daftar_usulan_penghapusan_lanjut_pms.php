...
<?php
	...
	// pr($data);
		...
		<section class="formLegend">
			...
			<div class="detailRight" align="right">
					...
					?>
						<ul>
							...
							<li>
								<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penghapusan_usulan_daftar_usulan_pms.php?pid=1" class="btn">
									   Daftar Barang
								 </a>
							</li>
							<li>
			...
			<div id="demo">
			<form method="POST" ID="Form2" action="<?php echo"$url_rewrite"?>/module/penghapusan/daftar_usulan_penghapusan_usul_pms.php"> 
