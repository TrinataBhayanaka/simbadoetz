...
// $data=$UPDATE->update_daftar_penetapan_penghapusan($id,$no,$tgl,$olah_tgl,$keterangan,$submit);
	...
	$data = $PENGHAPUSAN->update_daftar_penetapan_penghapusan_psb($_POST);
 ...
 *  * 
 */
    echo "<script>alert('Data Berhasil Disimpan'); document.location='$url_rewrite/module/penghapusan/dftr_penetapan_psb.php?pid=1';</script>";
