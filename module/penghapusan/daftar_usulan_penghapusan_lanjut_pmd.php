...
<?php
	...
	// pr($_POST);
	$data = $PENGHAPUSAN->retrieve_usulan_penghapusan_pmd($_POST,1);
	// pr($data);
			...
			<div class="detailRight" align="right">
					...
					?>
						<ul>
							...
							<li>
								<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penghapusan_usulan_daftar_usulan_pmd.php?pid=1" class="btn">
									   Daftar Barang
								 </a>
							</li>
							<li>
