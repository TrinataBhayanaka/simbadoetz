			...
			<table cellpadding="0" cellspacing="0" border="0" class="display table-checkable" id="example">
				...
				foreach($data as $key => $row)
					...
					<tr class="gradeA">
						...
						<a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>dftr_review_edit_penetapan_usulan_validasi_psb.php?id=<?php echo "$row[Penghapusan_ID]";?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i> Lakukan Validasi</a>&nbsp;
