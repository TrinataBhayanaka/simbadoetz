...
$PENGHAPUSAN = new RETRIEVE_PENGHAPUSAN;
    ...
    // $data=$DELETE->delete_update_daftar_validasi_penghapusan($id);
		...
		$data = $PENGHAPUSAN->delete_penetapan_penghapusan_asetid($_GET);
    ...
    */
    echo "<script>alert('Data Berhasil Dihapus'); document.location='$url_rewrite/module/penghapusan/penetapan_penghapusan_daftar_edit.php?id=$id';</script>";
?>
