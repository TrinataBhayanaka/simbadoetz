...
?>
    ...
    $(document).ready(function() {
          $('#rvw_aset_usulan_psb_table').dataTable(
                   {
                    "aoColumnDefs": [
                         { "aTargets": [2] }
                    ],
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_review_edit_aset_usulan_psb.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
	<section id="main">
		...
		<section class="formLegend">
			...
			// pr($idtable);
			?>
			<table cellpadding="0" cellspacing="0" border="0" class="display  table-checkable" id="rvw_aset_usulan_psb_table">
				<thead>
					<tr>
						...
						<td colspan="10" align="right">
							...
							?>
							<a href="dftr_usulan_psb.php" class="btn btn-success " /><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali Ke Daftar Usulan</a>
