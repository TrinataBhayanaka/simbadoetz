...
?>
	...
	<section id="main">
		...
		<section class="formLegend">
			...
			<form method="POST" action="<?php echo"$url_rewrite"?>/module/penghapusan/dftr_aset_usulan_pms.php?pid=1&flegAset=1" onsubmit="return requiredFilter(1,1, 'kodeSatker')">
				<ul>
					<li>&nbsp;</li>
					<li>
