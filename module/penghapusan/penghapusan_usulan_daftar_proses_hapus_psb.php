...
// $dataArr = $DELETE->delete_daftar_usulan_penghapusan($id);
		...
		$data = $PENGHAPUSAN->delete_daftar_usulan_penghapusan_psb($_GET);
...
*/
echo "<script>alert('Data Sudah Terhapus'); document.location='$url_rewrite/module/penghapusan/penghapusan_usulan_daftar_usulan_psb.php?pid=1';</script>";
?>
