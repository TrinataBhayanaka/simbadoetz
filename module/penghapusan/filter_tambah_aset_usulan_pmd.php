...
?>
	...
	<section id="main">
		...
		<section class="formLegend">
			...
			<form method="POST" action="<?php echo"$url_rewrite"?>/module/penghapusan/dftr_aset_tambahan_usulan_pmd.php?pid=1&flegAset=1" onsubmit="return requiredFilter(true)">
				<ul>
					<li>&nbsp;</li>
					<li>
