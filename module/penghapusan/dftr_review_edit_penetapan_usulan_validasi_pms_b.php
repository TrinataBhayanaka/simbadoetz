			...
			<table cellpadding="0" cellspacing="0" border="0" class="display  table-checkable" id="example">
				<thead>
					<tr>
						<th>No</th>
						<th>No Register</th>
						<th>StatusValidasi Aset</th>
						<th>StatusValidasi KiB</th>
						<th>Jenis KIB</th>
						<th>Satker</th>
				...
				if (!empty($data['dataRow']))
				{
					...
					if($nilai[StatusValidasiAset]==1 || $nilai[StatusValidasiKib]==1){
						$disabled="";
						$url="prosesStatusValidasi.php?asetid={$nilai[Aset_ID]}&idpenetapan={$_GET['id']}&jenisHapus=PMS";
					
					}else{
						$disabled="disabled";
						// $url="prosesStatusValidasi.php?asetid={$nilai[Aset_ID]}&idpenetapan={$_GET['id']}&jenisHapus=PMD";
					...
					<tr class="gradeA">
						...
						<td>
							<?php echo "<strong> Aset_ID <br/>[ ".$nilai[Aset_ID]." ]</strong>";//<br/> NoRegister ".$nilai[noRegister]?>
						</td>
						<td>
							<?php echo $nilai[StatusValidasiAset]?>
						</td>
						<td>
							<?php echo $nilai[StatusValidasiKib]?>
						</td>
						<td>
							 [ <?php echo $nilai[JenisKIB]?> ]
						</td>
						<td>
