          ...
          $('#usulan_pms_table').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_aset_tambahan_usulan_pms.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
			...
			<div id="demo">
			<form method="POST" ID="Form2" onsubmit="return confirmValidate()" action="<?php echo"$url_rewrite"?>/module/penghapusan/dftr_review_aset_tambahan_usulan_pms.php"> 
