                                        ...
                                        <table>
                                            ...
                                            <tr>			
                                                <td><label>Aset ID (System ID)</label><br>
                                                    <input type="text" placeholder="Aset ID..." name="mutasi_trans_filt_idaset"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>			
                                                <td><label>Nama Aset</label><br>
                                                    <input  type="text" placeholder="Nama Aset..." style="width:480px;" name="mutasi_trans_filt_nmaset"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>			
                                                <td><label>Nomor Kontrak</label><br>
                                                    <input  type="text" placeholder="Nomor Kontrak..." name="mutasi_trans_filt_nokontrak" id="posisiKolom"/>&nbsp;<span id="errmsg"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
