                ...
                <div id="frame_gudang">
                    ...
                    <script>
                        function nilai()
                        {
                            ...
                            var main=document.getElementById("p_gol7_kuantitasa");
...
<?php
$query_dokumen = " select Inventarisasi_ID,NoDokInventarisasi  from Inventarisasi order by TglDokInventarisasi desc ";
...
while ($row_dokumen = mysql_fetch_object($result_dokumen)) {
    ...
    if ($NoDokInventarisasi != "")
        ...
        ?>
                                                <option value="<?php echo $Inventarisasi_ID ?>" <?php if ($dataArr->Inventarisasi_ID == $Inventarisasi_ID) echo 'selected'; ?>><?php echo $NoDokInventarisasi ?></option>
    <?php
    //$NoBaPemeriksaan="";
}
?>
                            ...
                            <table cellspacing="6">
                                ...
                                <tr>	
                                    ...
                                    <td><input class="dokumen_penerimaanclass"  type="text" id="inv_ldahi_dokinventaris" name="inv_ldahi_dokinventaris" value="<?= $dataArr->NoDokInventarisasi ?>"size ="40"></td>					
                                </tr>
                                <tr>	 
                                    <td>Tanggal Dok. Inventarisasi</td>																		
                                    <td> <input class="dokumen_penerimaanclass" id="tanggal14" type="text"  name="inv_ldahi_tglinventaris" value="<?= $dataArr->TglDokInventarisasi ?>" size ="40"  readonly></td>					
                                </tr>
...
<?php foreach ($dataArr->lokasi_baru_ID as $value) { ?>
                                ...
                                <?php } ?>
                                <input type="submit" onClick="sendit_5()" value="Simpan" name="simpan"/>   
