...
?>
	...
	<section id="main">
		<ul class="breadcrumb">
		  ...
		  <li class="active">Rekapitulasi LMB Daerah Semesteran</li>
		  <?php SignInOut();?>
		</ul>
		<div class="breadcrumb">
			<div class="title">Rekapitulasi LMB Daerah Semesteran</div>
			...
			<ul>
							<li>
								<span class="span2">Semester</span>
								 <select name="mutasi_reklmb_smster">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                        </select>
										<select name="mutasi_reklmb_tahun">
							...
							<li>
								...
								<input type="text"  placeholder="( dd/mm/yyyy )" style="text-align:center;" name="mutasi_reklmb_tanggal" id="tanggal12"> 
							</li>
							<li>
								<span class="span2">&nbsp;</span>
								<a href="<?echo $url_rewrite.'/module/mutasi/report/rp_rekapitulasilaporanmutasibarang.php';?>" target="main"><input type="button" name="submit" class="btn btn-primary" value="Lanjut" /></a>
