		...
		<section class="formLegend">
			...
			<ul>
							...
							<li>
								...
								<input  type="text" placeholder="" name="mutasi_trans_filt_thn" id="mutasi_trans_filt_thn" style="" required="required" placeholder="Tahun (ex:2015)" maxlength="4"/>&nbsp;<span id="errmsg"></span>
							</li>
