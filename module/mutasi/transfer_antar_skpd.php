...
?>
	...
	<section id="main">
		...
		<section class="formLegend">
			...
			<form name="form" method="POST" action="<?php echo "$url_rewrite/module/mutasi/"; ?>transfer_hasil_filter.php?pid=1" onsubmit="return requiredFilter(true,true,'kodeSatker')">
			<ul>
