                        ...
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Tgl Penetapan Penggunaan Awal</td>
                                        <td><input placeholder="(dd/mm/yyyy)" type="text" name="penggu_valid_filt_tglpenet_awal" style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Tgl Penetapan Penggunaan Akhir</td>
                                        <td><input placeholder="(dd/mm/yyyy)" type="text" name="penggu_valid_filt_tglpenet_akhir" style="width:200px;" id="tanggal11"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input placeholder="No.Penetapan..." type="text" name="penggu_valid_filt_nopenet" style="width:450px;" id="posisiKolom">&nbsp;<span id="errmsg"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><input type="submit" name="tampil_validasi" value="Tampilkan Data"><input type="reset" name="reset" value="Bersihkan Filter"></td>
                                    </tr>
                                </table>
                                </form>    
