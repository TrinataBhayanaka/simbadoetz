        ...
        <div id="content">
            ...
            <div id="tengah1">	
                <div id="frame_tengah1">
                    <div id="frame_gudang">
                        <div id="topright">
                            Daftar Mutasi Barang SKPD Tahunan	
                        </div>
                        <div id="bottomright">
                            <form name="form" method="POST" action="<?php echo "$url_rewrite/module/mutasi/"; ?>proses_daftar_mutasi_barang_skpd_tahunan.php">
                            <script type="text/javascript" src="<?php echo "$url_rewrite/"; ?>JS/tabel.js"></script>	
                            <table>	
                                <tr>
                                    <td><label>Tahun :</label><br/></td>
                                    <td><select name="mutasi_daftar_tahun">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input type="text"  style="text-align:center;" name="mutasi_daftar_tanggal" id="tanggal12"> ( format tanggal : dd/mm/yyyy )
                                    </td>
                                </tr>
                            </table>
                            </form>
