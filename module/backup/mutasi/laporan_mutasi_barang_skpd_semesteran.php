        ...
        <div id="content">
            ...
            <div id="tengah1">	
                <div id="frame_tengah1">
                    <div id="frame_gudang">
                        <div id="topright">
                            Laporan Mutasi Barang SKPD Semesteran	
                        </div>
                        <div id="bottomright">
                            
                            <form name="form" method="POST" action="<?php echo "$url_rewrite/module/mutasi/"; ?>proses_laporan_mutasi_barang_skpd_semesteran.php">
                            <script type="text/javascript" src="<?php echo "$url_rewrite/"; ?>JS/tabel.js"></script>	
                            <table>	
                                <tr>
                                    <td><label>Semester </label><select name="mutasi_lap_semester">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                        </select>
                                    </td>
                                    <td><select name="mutasi_lap_tahun">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input type="text"  style="text-align:center;" name="mutasi_lap_tanggal" id="tanggal12"> ( format tanggal : dd/mm/yyyy )
                                    </td>
                                </tr>
                            </table>
                            </form>
