...
<html>
    ...
    <script>
        ...
        function sendit(){
            alert("SUCCESS");
            document.location="rekapitulasi_dmb_daerah_tahunan.php";
	}
	-->
	<!--
        function sendit_1(){
                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <input type="text"  style="text-align:center;" name="mutasi_rekdmb_tanggal" id="tanggal12"> ( format tanggal : dd/mm/yyyy )
                                        </td>
                                    </tr>
                                </table>
                            </div>
