...
$mode = $_REQUEST['mode'];
$rekapitulasi_lmb_daerah = $_REQUEST['rekapitulasi_lmb_daerah'];
...
$data=array(
    "modul"=>$modul,
    "mode"=>$mode,
    "rekapitulasi_lmb_daerah"=>$rekapitulasi_lmb_daerah,
    "tahun"=>$tahun,
	"semester"=>$semester,
...
//retrieve html
$html=$REPORT->retrieve_html_rekapitulasi_lmb_daerah($result_query, $gambar);
