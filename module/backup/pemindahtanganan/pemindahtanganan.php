...
<html>
	...
	//document.location="buat_usulan_pemindahtanganan.php";
                                            ...
                                            <div id="frame_gudang">
                                                    ...
                                                    <div id="bottomright">
                                                            ...
                                                            <form method="POST" action="<?php echo "$url_rewrite";?>/module/pemindahtanganan/daftar_pemindahtanganan_barang.php?pid=1"  name="usulan_pemindahtanganan" >
                                                                <table>
                                                                    <tr>
                                                                            <td>ID Aset (System ID)<br><input type="text" name="bupt_idaset" style="width:200px;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                            <td>Nama Aset<br><input type="text" name="bupt_namaaset" style="width:450px;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                            <td>Nomor Kontrak<br><input type="text" name="bupt_nokontrak" style="width:200px;"></td>
                                                                    </tr>
                                                                     <tr>
                                                                            <td>Tahun Perolehan<br><input type="text" name="bupt_tahun" style="width:70px;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                            <td>Kelompok<br>
