        ...
        <body onload="enable()">
                        ...
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                <div style="margin-bottom:10px; float:right;">
                                    <a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>validasi_filter.php"><input type="submit" value="Kembali ke Halaman Utama: Cari Aset"></a>
                                </div>
                                <div style="margin-bottom:10px; float:right; clear:both;">
                                    <a href="<?php echo "$url_rewrite/module/penghapusan/"; ?>penghapusan_validasi_daftar_valid.php?pid=1"><input type="submit" value="Daftar Barang"></a>
                                </div>
                                ...
                                <table  width="100%" style="padding:2px; margin-top:0px; border: 1px solid #004933; border-width: 1px 1px 1px 1px; clear:both;">
                                    <tbody>
                                        ...
                                        <tr style="background-color:#004933; color:white; height:20px;">
                                            ...
                                            <th width="100px" align="center" style="border: 1px solid #004933;">Tanggal Penghapusan</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="border: 1px solid #004933; height:100px; color: #cc3333; font-weight: bold;"><?php echo "$value[NoSKHapus]";?></td>
                                            <td align="center" style="border: 1px solid #004933; height:100px; color: #cc3333; font-weight: bold;"><?php $change=$value['TglHapus']; $change2=  format_tanggal_db3($change); echo "$change2";?></td>
                                            <td align="center" style="border: 1px solid #004933; height:100px; color: #cc3333; font-weight: bold;"><?php echo "$value[AlasanHapus]";?></td>
                                        </tr>
                                        </tr>
                                                <?php $no++; $pid++; }} ?>
                                    </tbody>
		   ...
		   $(function(){
			...
			$("#pilihHalamanIni").click(function () {
			    ...
			    var modParam = 'ValidasiPenghapusan';
