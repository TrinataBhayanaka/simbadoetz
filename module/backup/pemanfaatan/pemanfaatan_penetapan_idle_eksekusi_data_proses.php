...
$query_hapus_apl="DELETE FROM apl_userasetlist WHERE aset_action='Menganggur' AND UserSes='$_SESSION[ses_uid]'";
$exec_hapus=  mysql_query($query_hapus_apl) or die(mysql_error());

echo "<script>alert('Data Sudah Terkirim.. !!!'); document.location='$url_rewrite/module/pemanfaatan/pemanfaatan_penetapan_idle_daftar.php';</script>";
