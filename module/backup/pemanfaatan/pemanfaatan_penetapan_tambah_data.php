    <?php
        ...
        $nm_aset=$_POST['peman_penet_filt_add_nmaset'];
        $no_kontrak=$_POST['peman_penet_filt_add_nokontrak'];
        //$no_usulan=$_POST['peman_penet_filt_add_nousulan'];
        $satker=$_POST['skpd_id'];
        $idaset=$_POST['peman_penet_filt_add_idaset'];
        ...
        //open_connection();
            ...
            //$query_nama="NamaAset LIKE '%$nm_aset%'";
            }
            ...
            /*if($no_usulan!=""){
            $query_no_usulan="Usulan_ID LIKE '%$no_usulan%'";
            }*/
            ...
            if($satker!=""){
                ...
                if($idaset!=""){
                $query_id_aset="Aset_ID LIKE '%$idaset%'";
                $query_alias_asetid="UA.Aset_ID LIKE '%$idaset%'";
                }
            ...
            if($idaset!="" && $parameter_sql!=""){
            $parameter_sql=$parameter_sql." AND ".$query_id_aset;
            $parameter_sql_report=$parameter_sql_report." AND ".$query_alias_asetid;
            }
            if ($idaset!="" && $parameter_sql==""){
            $parameter_sql=$query_id_aset;
            ...
            $query_apl = "SELECT aset_list FROM apl_userasetlist WHERE aset_action = 'PenetapanPemanfaatan' AND UserSes = '$_SESSION[ses_uid]'";
            //print_r($query_apl);
        ...
        if (isset($submit)){
                if ($nm_aset=="" && $no_kontrak=="" && $satker=="" && $idaset==""){
    ?>
                            ...
                            <table  width="100%" style="padding:2px; margin-top:0px; border: 1px solid #004933; border-width: 1px 1px 1px 1px; clear:both;">
                                <tbody>
                                    ...
                                    <?php
                                                ...
                                                $query_total_record="SELECT COUNT(*) FROM UsulanAset $_SESSION[parameter_sql]  StatusPenetapan=0 AND Jenis_Usulan='MNF'";
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="border: 1px solid #004933; height:100px; color: black; font-weight: bold;">
                                                 <input type="checkbox" class="checkbox" onchange="enable()" name="PenetapanPemanfaatan" value="<?php echo $value->Aset_ID;?>" <?php for ($j = 0; $j <= count($explode); $j++){if ($explode[$j]==$value->Aset_ID) echo 'checked';}?>/>
                                        </td>
        ...
        <script>
		   ...
		   $(function(){
			...
			$("#pilihHalamanIni").click(function () {
			    ...
			    var modParam = 'PenetapanPemanfaatan';
