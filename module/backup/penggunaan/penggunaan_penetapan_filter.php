                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="penggu_penet_filt_tglawal" style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="penggu_penet_filt_tglakhir" style="width:200px;" id="tanggal13"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="penggu_penet_filt_nopenet" style="width:450px;" id="posisiKolom">&nbsp;<span id="errmsg"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
