                    ...
                    <div id="frame_tengah1">
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <tr>
                                    <td>Nama Aset</td>
                                    <td><input type="text" name="penggu_penet_filt_add_nmaset" style="width:200px;"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>Nomor Kontrak</td>
                                    <td>
                                        <input type="text" name="penggu_penet_filt_add_nokontrak" style="width:450px;" id="posisiKolom">&nbsp;<span id="errmsg"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
