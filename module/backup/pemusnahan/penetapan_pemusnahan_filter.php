                        ...
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Tanggal awal</td>
                                        <td><input type="text" name="buph_pph_tanggalawal" style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Tanggal akhir</td>
                                        <td><input type="text" name="buph_pph_tanggalakhir" style="width:200px;" id="tanggal13"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="buph_pph_noskpemusnahan" style="width:450px;" id="posisiKolom">&nbsp;<span id="errmsg"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
