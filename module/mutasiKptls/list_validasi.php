...
?>
	<section id="main">
		...
		<div class="grey-container shortcut-wrapper">
				...
				<a class="shortcut-link active" href="<?=$url_rewrite?>/module/mutasiKptls/list_validasi.php">
					<span class="fa-stack fa-lg">
				      <i class="fa fa-circle fa-stack-2x"></i>
          ...
          $('#usulan_pmd_table').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/mutasiKptls/list_validasi_mutasi.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
			...
			?>
    		<p><a href="<?=$url_rewrite?>/module/mutasiKptls/dftr_penetapan_validasi.php" class="btn btn-info btn-small"><i class="icon-plus-sign icon-white"></i>&nbsp;&nbsp;Validasi Penetapan</a>
			<?php
				}
			?>
			<p>Tahun Usulan:
