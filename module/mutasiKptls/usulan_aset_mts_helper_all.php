...
$sql = "SELECT Aset_ID FROM usulanaset where Jenis_Usulan='MTSKPTLS' AND StatusValidasi='0' AND (StatusKonfirmasi='0' OR StatusKonfirmasi='1') ORDER BY Usulan_ID DESC";
    ...
    if($ListUsul){
        ...
        foreach($resAset as $asetidAset){
            ...
            if (!isset($ListUsul[$needle])){
                ...
                $value = "'{$idUsulan}','{$needle}','MTSKPTLS'";
