...
?>
          ...
          $('#rvw_aset_penetepan').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/mutasiKptls/list_aset_penetapan_mutasi.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
	<section id="main">
		...
		<section class="formLegend">
			<form method="POST" action="<?php echo "$url_rewrite/module/mutasiKptls/"; ?>dftr_asetid_penetapan_proses_upd.php"> 
			<?php
				if($row['FixMutasi']==0){
					$disabled = "";
				}else{
			...
			<form method="POST" ID="Form2" action="<?php echo "$url_rewrite/module/mutasiKptls/"; ?>dftr_asetid_penetapan_proses_hapus.php" onsubmit="return confirmValidate()" > 
			<div id="demo">
