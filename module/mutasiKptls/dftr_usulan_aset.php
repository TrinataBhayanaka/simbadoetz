...
?>
		  ...
		  if ($("#Form2 input:checkbox:checked").length > 0)
			{
			    ...
			    updDataCheckbox('RVWPTUSMTSKPTLS');
			}
			else
			{
          ...
          $('#usulan_aset_mts').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/mutasiKptls/list_usulan_mutasi.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
	<section id="main">
		...
		<section class="formLegend">
			...
			<div id="demo">
			<form name="myform" method="POST" ID="Form2" action="<?php echo "$url_rewrite/module/mutasiKptls/"; ?>dftr_review_penetapan_usulan.php">
				...
				<thead>
					<tr>
						...
						<td align="right" colspan="2">
							<a href="<?php echo "$url_rewrite/module/mutasiKptls/"; ?>filter_usulan.php" class="btn">Kembali Ke Pencarian</a>
						</td>
					</tr>
					<tr>
						<th>No</th>
