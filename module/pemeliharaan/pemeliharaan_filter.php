...
$resetDataView = $DBVAR->is_table_exists('pemeliharaan_filter_'.$SessionUser['ses_uoperatorid'], 0);
?>
...
<script type="text/javascript">
	...
	<section id="main">
		<ul class="breadcrumb">
		  ...
		  <li class="active">Seleksi Pencarian:</li>
		  <?php SignInOut();?>
		</ul>
		...
		<section class="formLegend">
			...
			<form name="pem_filter" action="<?php echo "$url_rewrite/module/pemeliharaan/"; ?>pemeliharaan_daftar_data.php?pid=1" method="post">
			<ul>
							<li>
