...
$data = $KEBUTUHAN->retrieve_daftar_perencanaan_pengadaanPemeliharaan($_POST); 
// pr($data);
	...
	<section id="main">
		<ul class="breadcrumb">
			...
			<div class="grey-container shortcut-wrapper">
				<a class="shortcut-link active" href="<?=$url_rewrite?>/module/kebutuhan/butuh_pemeliharaan_buat_filter.php">
				...
				<a class="shortcut-link " href="<?=$url_rewrite?>/module/kebutuhan/butuh_pemeliharaan_filter.php">
					<span class="fa-stack fa-lg">
				      <i class="fa fa-circle fa-stack-2x"></i>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				...
				?>	
					 <tr>
                        ...
                        <td><a href="<?php echo"$url_rewrite";?>/module/kebutuhan/butuh_pemeliharaan_tambah.php?id=<?=$value['Rencana_ID']?>&tipe=<?=$value['TipeAset']?>" class="btn btn-info btn-small">Buat Pemeliharaan</a></td>
                     </tr>
                <?php
                }
