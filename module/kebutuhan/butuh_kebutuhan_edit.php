...
$dataDatabase = $KEBUTUHAN->retrieve_daftar_perencanaan_kebutuhan_edit($_GET); 
// pr($dataDatabase);
...
$kib=$dataDatabase['kib'];
	...
	<section id="main">
		...
		<section class="formLegendInve">
			...
			<div>
			<form action="<?php echo"$url_rewrite";?>/module/kebutuhan/butuh_kebutuhan_prosesedit.php" method="POST">
