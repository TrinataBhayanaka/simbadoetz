...
if($_POST){
$data = $KEBUTUHAN->retrieve_daftar_perencanaan_kebutuhan($_POST);
}else{

$data = $KEBUTUHAN->retrieve_daftar_perencanaan_kebutuhan($_GET);
} 
				...
				?>	
					 <tr>
                        ...
                        ?>	
                        	...
                        	<a href="<?=$url_rewrite?>/module/kebutuhan/butuh_kebutuhan_edit.php?id=<?=$value['Rencana_ID']?>&tipe=<?=$value['TipeAset']?>&satker=<?=$value['Kode_Satker']?>" class="btn btn-info btn-small">Edit</a>
                        	<a href="<?=$url_rewrite?>/module/kebutuhan/butuh_kebutuhan_delete.php?id=<?=$value['Rencana_ID']?>&tipe=<?=$value['TipeAset']?>&satker=<?=$value['Kode_Satker']?>" class="btn btn-danger btn-small" onClick="return confirm('Anda yakin akan menghapus data ini?');">Hapus</a>
                        <?php
                    	}else{
                    	?>
