	...
	<section id="main">
		<ul class="breadcrumb">
			...
			<div class="breadcrumb">
				<div class="title">Rencana Kebutuhan</div>
				<div class="subtitle">Tambah Rencana Kebutuhan</div>
			</div>	

			<div class="grey-container shortcut-wrapper">
				<a class="shortcut-link active" href="<?=$url_rewrite?>/module/kebutuhan/butuh_kebutuhan_tambah.php">
					<span class="fa-stack fa-lg">
				      <i class="fa fa-circle fa-stack-2x"></i>
				      <i class="fa fa-inverse fa-stack-1x">1</i>
				    </span>
					<span class="text">Tambah Rencana Kebutuhan</span>
				</a>
				<a class="shortcut-link" href="<?=$url_rewrite?>/module/kebutuhan/butuh_kebutuhan_filter.php">
					<span class="fa-stack fa-lg">
				      <i class="fa fa-circle fa-stack-2x"></i>
				      <i class="fa fa-inverse fa-stack-1x">2</i>
				    </span>
					<span class="text">Data Rencana Kebutuhan</span>
				</a>
			</div>		
		...
		<section class="formLegendInve">
			...
			<div>
			<form action="<?php echo"$url_rewrite";?>/module/kebutuhan/butuh_kebutuhan_prosestambah.php" method="POST">
