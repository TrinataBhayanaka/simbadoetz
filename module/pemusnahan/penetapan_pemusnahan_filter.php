		...
		<section class="formLegend">
			...
			<ul>
							<li>
								...
								<input type="text" name="buph_pph_tanggalawal" style="width:200px;" id="tanggal12" placeholder="Tanggal Awal...">
							</li>
							<li>
								<span class="span2">Tanggal akhir</span>
								<input type="text" name="buph_pph_tanggalakhir" style="width:200px;" id="tanggal13" placeholder="Tanggal Akhir...">
							</li>
							<li>
								<span class="span2">No BA Pemusnahan</span>
								 <input type="text" name="buph_pph_noskpemusnahan" style="width:450px;" id="posisiKolom" placeholder="No BA Pemusnahan...">&nbsp;<span id="errmsg">
							</li>
							<li>
