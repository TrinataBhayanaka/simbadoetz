                        ...
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Tanggal awal</td>
                                        <td><input type="text" name="bupt_cdpt_tanggalawal" placeholder="Pilih Tanggal Awal..." style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Tanggal akhir</td>
                                        <td><input type="text" name="bupt_cdpt_tanggalakhir" placeholder="Pilih Tanggal Akhir..." style="width:200px;" id="tanggal13"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="bupt_cdpt_noskpemindahtanganan" placeholder="Isi No BAST Pemindahtanganan..." style="width:450px;">&nbsp;<span id="errmsg"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
