...
?>
	...
	<section id="main">
		<ul class="breadcrumb">
		  ...
		  <li><a href="#">Penyusutan Satuan</a><span class="divider"><b>&raquo;</b></span></li>
		  <li class="active">Penyusutan</li>
		  <?php SignInOut();?>
		</ul>
		<div class="breadcrumb">
			<div class="title">Penyusutan Daftar Aset Penyusutan</div>
			<div class="subtitle">Filter Daftar Aset Penyusutan</div>
		</div>
		
		
		<section class="formLegend">
			
			<form method="POST" action="<?php echo"$url_rewrite"?>/module/penyusutan2satuan/penyusuan_aset_daftar.php" >
				<ul>
					<li>&nbsp;</li>
