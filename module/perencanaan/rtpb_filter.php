			...
			<ul>
							...
							<li>
								...
								<div class="input-append">
										<input type="text" name="rtpb_skpd" id="rtpb_skpd" class="span5" readonly="readonly" value="<?php echo $_SESSION['ses_satkername'] ; ?>">
							...
							<li>
								...
								<div class="input-append">
									<input type="text" name="rtpb_lokasi" id="rtpb_lokasi" class="span5" readonly="readonly" value="">
																<input type="button" name="idbtnlookupkelompok" id="idbtnlookupkelompok" class="btn" value="Pilih" onclick = "showSpoiler(this);">
																<div class="inner" style="display:none;">
																	<?php
							...
							<li>
								...
								<div class="input-append">
									<input type="text" name="rtpb_njb" id="rtpb_njb" class="span5" readonly="readonly" value="">
																<input type="button" name="idbtnlookupkelompok" id="idbtnlookupkelompok" class="btn" value="Pilih" onclick = "showSpoiler(this);">
																<div class="inner" style="display:none;">
																	<?php
