						...
						<div id="bottomright">
							...
							<div>
								<table border=0 width=100%>
									<tr>		
										<td align=right>
											<a href="<?php echo"$url_rewrite/module/perencanaan/rkpb_import_data.php";?>">
											<input type="button" value="Tambah Data: Import" >
											<a href="<?php echo"$url_rewrite/module/perencanaan/rkpb_tambah_data.php?pid=1";?>">
											<input type="button" value="Tambah Data: Manual" >
										</td>
									</tr>
									<tr align=right>
										<td><a href="<?php echo"$url_rewrite/module/perencanaan/rkpb_filter.php";?>">
								...
								<table cellpadding="0" cellspacing="0" border="1" class="display" id="example" width="100%">	
									<thead>
										...
										<tr>
											...
											<th width=15% align="center" class="style2">Total Harga Pemeliharaan</th>
										...
										<tr>
											...
											<td align="center" class="style5">
												<!--<form method="POST" action="rkpb_edit_data.php" onsubmit="return confirm('Apakah data nama/jenis barang = <?php echo show_kelompok($hsl_data->Kelompok_ID);?> ini ingin diedit?'); ">
