						...
						<div id="bottomright">                                                                                                              
								...
								<table border=0 width=100%>
									<tr>		
										...
										<td width=25% align="right">
											<a href="<?php echo "$url_rewrite/module/perencanaan/rtpb_daftar_data.php"; ?>">
							...
							<div id="perencanaan_new">
								<table width="100%" class="style1">
									<tr bgcolor="#004933">
										<td class="white" colspan="2" align=left>Informasi Data RTPB</td>
									</tr>
									<tr>
														...
														<table width="100%" class="style1">
															<tbody>
																<tr>
																	...
																	<td>
																		<input class="w30" name="tahun" type="text" value="10" readonly="readonly"></td>
																</tr>
																<tr>
																	<td width="25%">Jumlah berdasarkan Buku Inventaris</td>
																	<td>
																		<input class="w30" name="tahun" type="text" value="7" readonly="readonly"></td>
																</tr>
																<tr>
																	<td width="25%">RKB yang dianjurkan yaitu <=</td>
																	<td>
																		<input class="w30" name="tahun" type="text" value="3" readonly="readonly"></td>
																</tr>
															</tbody>
														</table>
													</div>
									...
									<tr>
										...
										<td>
											<input class="w150" name="koderekening" type="integer" value="111222111" readonly="readonly"></td>
									</tr>
									<tr>
										<td width="25%" class="style6">Jumlah Barang</td>
										<td>
											<input class="w30" name="hargabarang" type="integer" value="3" readonly="readonly"></td>
									</tr>
									<tr>
