...
<?php
	...
	include"$path/menu.php";
		...
		<ul class="breadcrumb">
		  ...
		  <li class="active">Buat RTPB</li>
		  <?php SignInOut();?>
		</ul>
		<div class="breadcrumb">
			<div class="title">Buat RTPB</div>
			<div class="subtitle">Validasi Data </div>
		</div>				
		<section class="formLegend">
			...
			<div class="detailRight" align="right">
						...
						<ul>
							<li>
								<a href="<?php echo "$url_rewrite/module/perencanaan/"; ?>rtpb_daftar_data.php" class="btn">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				...
				<thead>
					<tr>
						...
						?>
						<input type="submit" class="btn btn-primary" value="Lakukan Validasi RTPB" name="validasi" disabled="<?php echo $classDisabled;?>" >
