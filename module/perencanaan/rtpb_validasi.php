...
$USERAUTH->FrontEnd_check_akses_menu($menu_id,$SessionUser);
	...
	$get_data_filter = $RETRIEVE->retrieve_rtpb_validasi(array('param'=>$_POST, 'menuID'=>$menu_id, 'type'=>'checkbox', 'paging'=>$paging));
?>
					...
					<div id="frame_gudang">
						...
						<div id="bottomright">
							...
							<div id="perencanaan_new">
								<table border=0 width=100%>
									<tr>
										<td align="right" colspan=7><a href="<?php echo "$url_rewrite/module/perencanaan/"; ?>rtpb_daftar_data.php">
								...
								<form method="POST" action="rtpb-proses.php">
								<table border="0" width=100% >
								...
								<table cellpadding="0" cellspacing="0" border="1" class="display" id="example" width="100%">
									<thead>
										<tr>
											<td align="right" colspan=7>
												<input type="submit" value="Lakukan Validasi RTPB" name="validasi">
											</td>
										</tr>
										<tr>
											<th align="center" colspan="7" class="style2">Daftar Rencana Kebutuhan Pemeliharaan Barang</th>
										</tr>
										<tr>
									...
									<tfoot>
										<tr>
											<th colspan="4">Daftar Rencana Kebutuhan Pemeliharaan </th>
										</tr>
									</tfoot>
								</table>
