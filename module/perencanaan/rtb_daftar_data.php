	...
	include"$path/menu.php";
		...
		<section class="formLegend">
			...
			<div class="detailRight" align="right">
						...
						<ul>
							<li>
								<a href="<?php echo "$url_rewrite/module/perencanaan/"; ?>rtb_filter.php" class="btn">
									   Kembali ke halaman utama : Form Filter
								 </a>
							</li>
							<li>
								<a href="<?php echo "$url_rewrite/module/perencanaan/"; ?>rtb_validasi.php" class="btn">
									   Lakukan Validasi Untuk RTB
								 </a>
							</li>
							<li>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				<thead>
					<tr>
						<td colspan="4" align="right"><input type="submit" class="btn" value="Batalkan Validasi" name="novalidasi"></td>
					</tr>
					<tr>
						<th>No</th>
						<th>Pilih</th>
				...
				?>
					<tr class="gradeA">
						...
						<td>	
							<?php echo number_format($hsl_data->NilaiAnggaran,2,',','.')?>
						</td>
					</tr>
