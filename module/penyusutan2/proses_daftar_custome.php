...
// exit;
// if($status_daftar=="1"){
     $query="insert into penyusutan_tahun_berjalan(kodeSatker,KelompokAset,Tahun,StatusRunning,UserNm) "
     ...
     . "       window.location.href=\"$url_rewrite/module/penyusutan2/penyusutan.php\"</script>";
/*}else{
