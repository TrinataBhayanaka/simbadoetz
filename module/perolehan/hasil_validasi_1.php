...
<table width='100%' border='1' style="border-collapse:collapse;border: 1px solid #dddddd;">
    ...
    }else
    {
        ...
        if($parameter_sql!=''){
            $query = "SELECT a.Aset_ID, a.NamaAset, a.NomorReg, a.Kelompok_ID, a.LastSatker_ID,
                            a.Lokasi_ID, a.LastKondisi_ID,
                            ...
                            WHERE $parameter_sql AND StatusValidasi=0 LIMIT $paging, 10";
        }
        if($parameter_sql==''){
        $query = "SELECT a.Aset_ID,a.NomorReg, a.NamaAset,  a.LastSatker_ID,
                            a.Lokasi_ID, a.LastKondisi_ID,
                            d.NamaLokasi, e.KodeSatker, e.NamaSatker, f.InfoKondisi
                            FROM Aset AS a 
                            ...
                            WHERE StatusValidasi=0 LIMIT $paging, 10";
        }
    ...
    <tr>
        ...
        <td style="border: 2px solid #dddddd;">
                ...
                <table>
                    ...
                    <tr>
                        <td width="30%"> Nilai Kontrak</td> <td><?php echo $value->NilaiKontrak?></td>
                    </tr>
                    <tr>
