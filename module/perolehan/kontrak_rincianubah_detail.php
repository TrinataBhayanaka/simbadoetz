...
?>
	...
	<?php
		...
		// pr($kontrak);
		    ...
		    {
		    	// pr($_POST);exit;
				$dataArr = $STORE->store_upd_asetdetail($_POST);
		    }
				 ...
				 <div class="formKontrak">
						...
						<ul>
							...
							<li>
								...
								<input type="text" readonly class="span3" name="Kuantitas" id="jumlah" value="<?=$dataArr['aset']['Kuantitas']?>" onchange="return totalHrg()" required/>
							</li>
							<li>
