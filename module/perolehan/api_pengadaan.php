<?php
  ...
  if($foto!=""){
       ...
       $hiden_id = $no - 1;
          echo "<tr>
                              ...
                              <td><input type=\"radio\" name=\"radio_foto\" size='2' value=\"$hiden_id\"/></td>
  ...
  if($nota!=""){
       ...
       $hiden_id = $no - 1;
          echo "<tr>
                              <td width=\"3%\">$no</td>
                              <td><input type=\"radio\" name=\"radio_nota\" size='2' value=\"$hiden_id\"/></td>
        ...
        echo"
          ...
          <tr>
               ...
               <tr>
                    ...
                    <td colspan='2'><input type='text' class=\"kontrak_pengadaan$no\" id=\"p_pengadaan_nokontrak$no\" name=\"p_pengadaan_nokontrak[]\" value=\"\"size='48px' readonly>
