...
$mode = $_REQUEST['mode'];
$rekapitulasi_buku_inventaris = $_REQUEST['rekapitulasi_buku_inventaris'];
...
$data=array(
    "modul"=>$modul,
    "mode"=>$mode,
    "rekapitulasi_buku_inventaris"=>$buku_inventaris,
    "tahun"=>$tahun,
...
//retrieve html
$html=$REPORT->retrieve_html_rekapitulasi_buku_inventaris($result_query, $gambar);
