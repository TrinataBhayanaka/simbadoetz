...
$resetDataView = $DBVAR->is_table_exists('hasil_validasi_'.$SessionUser['ses_uoperatorid'], 0);
?>
...
<script type="text/javascript">
	 ...
	 /*function validateForm() {
		var id=document.getElementById("kd_idaset").value;
		var nm_aset=document.getElementById("kd_namaaset").value;
		var klmpk_id=document.getElementById("kelompok_id").value;
		if (id == "" && nm_aset == "" && klmpk_id == "") {
			var r=confirm('Tidak ada isian filter');
				if (r==true){
					document.location="<?php echo "$url_rewrite/module/perolehan/";?>hasil_validasi.php?pid=1";
					alert("lanjut");
				}else{
					// document.location="<?php echo "$url_rewrite/module/perolehan/";?>validasi.php";
					document.myform.action ="<?php echo "$url_rewrite/module/perolehan/";?>validasi.php";
					alert("tidak lanjut");
				}
			return false;	
		}else{
	...
	function OnSubmitForm()
	{
		...
		if(id == '' && nm_aset == '' && kd_tahun == '' && kd_nokontrak == '' && klmpk_id == '' && skpd_id == '' && lokasi_id == ''){
			var r=confirm('Tidak ada isian filter');
				if (r==true){
					document.myform.action ="<?php echo "$url_rewrite/module/perolehan/";?>hasil_validasi.php?pid=1";
				}else{
					document.myform.action ="<?php echo "$url_rewrite/module/perolehan/";?>validasi.php";
				}
		}else{
