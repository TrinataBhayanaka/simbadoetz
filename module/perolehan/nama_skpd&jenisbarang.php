...
<table cellspacing="6">
        <tr>
            <td>Jenis Barang<br>	
                     <input type="text" name="p_jenisbarang" id="lda_kelompok3" style="width:450px;" readonly="readonly" value="<?=$dataArr->Uraian  ?>" placeholder="(Semua Jenis Barang)">
       ...
       <tr>
          ...
          <td>
                   <select name="p_bersejarah" value="">
                        <option value="1">Tidak Bersejarah</option>
                        <option value="2">Bernilai Sejarah</option>    
                   </select>
          </td>
        </tr>
</table>
