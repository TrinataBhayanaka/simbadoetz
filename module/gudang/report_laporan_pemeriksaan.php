...
$mode = $_REQUEST['mode'];
$laporan_pemeriksaan = $_REQUEST['laporan_pemeriksaan'];
...
$data=array(
    "modul"=>$modul,
    "mode"=>$mode,
    "laporan_pemeriksaan"=>$laporan_pemeriksaan,
    "tahun"=>$tahun,
...
//retrieve html
$html=$REPORT->retrieve_html_laporan_pemeriksaan($result_query, $gambar);
