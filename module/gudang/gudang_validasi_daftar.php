...
<?php
	...
	if(isset($_POST['aset'])){
		...
		<section class="formLegend">
			...
			<form action="" method=POST name="checks" ID="Form2" onsubmit="return confirm('Data yang sudah divalidasi tidak dapat dirubah atau di unposting kembali. Yakin validasi?');">
