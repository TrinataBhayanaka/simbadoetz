...
$dataArr = $STORE->store_distribusi_barang_tambah(
					$no_dokumen,
					$tanggal_proses,
					$alasan,
					$no_spbb,
...
echo"<script>alert('Data Berhasil Disimpan');window.location.href='".$url_rewrite."/module/gudang/distribusi_barang_daftar.php?pid=1'</script>";
