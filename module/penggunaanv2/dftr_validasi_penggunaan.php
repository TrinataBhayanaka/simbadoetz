...
?>
	<section id="main">
		...
		<div class="grey-container shortcut-wrapper">
			<a class="shortcut-link " href="<?=$url_rewrite?>/module/penggunaanv2/dftr_usulan_penggunaan.php">
			...
			<a class="shortcut-link active" href="<?=$url_rewrite?>/module/penggunaanv2/dftr_validasi_penggunaan.php">
				<span class="fa-stack fa-lg">
			      <i class="fa fa-circle fa-stack-2x"></i>
          ...
          $('#usulan_pmd_table').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_penggunaan_validasi.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
    		<p><a href="<?=$url_rewrite?>/module/penggunaanv2/dftr_penetapan_validasi_penggunaan.php" class="btn btn-info btn-small"><i class="icon-plus-sign icon-white"></i>&nbsp;&nbsp;Validasi Penetapan</a>
			<p>Tahun Penetapan:
				<?=$tahun?>
			</p>
			<?php
