...
$query = "DELETE FROM penggunaan where Penggunaan_ID = '{$idUsulan}' " or die("Error in the consult.." . mysqli_error($link));
    
//echo "query usulan : ".$query."\n\n";           
$exec = $link->query($query);

$query2 = "DELETE FROM penggunaanaset where Penggunaan_ID = '{$idUsulan}' " or die("Error in the consult.." . mysqli_error($link));
