                            ...
                            <div id="bottomright">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
										<?php 
											$id=$_GET['id'];
											/*$query="SELECT c.Aset_ID,c.LastSatker_ID,c.TglPerolehan, c.AsetOpr, c.Kuantitas, c.Satuan,c.OrigSatker_ID,c.Ruangan, 
														   c.SumberAset, c.NilaiPerolehan,c.Alamat, c.RTRW, c.Pemilik, c.NomorReg, c.NamaAset,c.TglPerolehan, 
														   k.NoKontrak, s.NamaSatker, s.KodeSatker, f.NamaLokasi,h.Kode,h.Uraian
											...
											$query="SELECT c.Aset_ID,c.LastSatker_ID,c.TglPerolehan, c.AsetOpr, c.Kuantitas, c.Satuan,c.OrigSatker_ID,c.Ruangan, 
														   c.SumberAset, c.NilaiPerolehan,c.Alamat, c.RTRW, c.Pemilik, c.NomorReg, c.NamaAset,c.TglPerolehan, 
														   k.NoKontrak, s.NamaSatker, s.KodeSatker, f.NamaLokasi,h.Kode,h.Uraian
														   FROM bast_pengembalian AS a
															JOIN bast_pengembalianaset AS b ON a.BAST_Pengembalian_ID = b.BAST_Pengembalian_ID
															JOIN aset AS c ON b.Aset_ID = c. Aset_ID
															LEFT JOIN KontrakAset AS ka  ON ka.Aset_ID = c.Aset_ID
															LEFT JOIN Kontrak AS k ON k.Kontrak_ID = ka.Kontrak_ID
															JOIN Lokasi AS f  ON c.Lokasi_ID=f.Lokasi_ID
															JOIN Satker AS s ON c.LastSatker_ID=s.Satker_ID
															JOIN Kelompok AS h ON c.Kelompok_ID=h.Kelompok_ID
															WHERE a.BAST_Pengembalian_ID ='$id'";				
											...
											while($nilai = mysql_fetch_object($exec))
											{
												...
												echo "<tr>
													...
													<td></td>
													<td>$no.</td>
													<input type='hidden' name='peman_pengem_eks_aset[]' value='$nilai->Aset_ID'>
                                ...
                                <tr>
                                    <td>Nomor BAST</td>
                                    <td>
                                        <input type="text" style="width:200px"  name="peman_pengem_eks_nobast" required="required" id="" value="<?php echo "$row2[NoBAST]";?>">&nbsp;<span id="errmsg"></span>
                                    </td>
                                    <td style="width:200px">Tanggal BAST</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_tglbast" id="tanggal12" required="required" value="<?php $change=$row2[TglBAST]; $hasil=format_tanggal_db3($change); echo "$hasil";?>"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan=3><input type="text" style="width:200px" name="peman_pengem_eks_lokasi_serah_terima" required="required" size="92" value="<?php echo "$row2[LokasiBAST]";?>"/>
                                ...
                                <tr>
                                    <td>Nama</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_nm1" required="required" value="<?php echo "$row2[NamaPihak1]";?>"></td>
                                    <td>Nama</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_nm2" required="required" value="<?php echo "$row2[NamaPihak2]";?>"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>Jabatan</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_jabatan1" required="required" value="<?php echo "$row2[JabatanPihak1]";?>"></td>
                                    <td>Jabatan</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_jabatan2" required="required" value="<?php echo "$row2[JabatanPihak2]";?>"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>NIP</td>
                                    <td>
                                        <input type="text" style="width:200px" name="peman_pengem_eks_nip1" required="required" id="posisiKolom2" value="<?php echo "$row2[NIPPihak1]";?>">&nbsp;<span id="errmsg2"></span>
                                    </td>
                                    <td>NIP</td>
                                    <td>
                                        <input type="text" style="width:200px" name="peman_pengem_eks_nip2" required="required" id="posisiKolom3" value="<?php echo "$row2[NIPPihak2]";?>">&nbsp;<span id="errmsg3"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>Lokasi</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_lokasi1" required="required" value="<?php echo "$row2[LokasiPihak1]";?>"></td>
                                    <td>Lokasi</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_lokasi2" required="required" value="<?php echo "$row2[LokasiPihak2]";?>"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td colspan=4 align=center><input type="submit" name="submit" value="Pengembalian"/>
									&nbsp;<input type="button" value="Batal" onclick="window.location='pemanfaatan_pengembalian_daftar.php?pid=1'"/></td>
