                    ...
                    <div id="frame_tengah1">
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <?php
                                $id = $_POST['PengembalianPemanfaatan'];
                                $cols = implode(', ',array_values($id));
								$sql = "UPDATE apl_userasetlist SET aset_list = '$cols' WHERE aset_action = 'PengembalianPemanfaatan[]' AND UserSes = '$_SESSION[ses_uid]'";
								$result_1 = mysql_query($sql) or die (mysql_error());
								$query_1 = "SELECT aset_list FROM apl_userasetlist WHERE aset_action = 'PengembalianPemanfaatan[]' AND UserSes = '$_SESSION[ses_uid]'";		
								...
								if($dataID){
									foreach($dataID as $dataImplode){
										...
										$query = "SELECT a.Aset_ID,a.LastSatker_ID,a.TglPerolehan, a.AsetOpr, a.Kuantitas, a.Satuan,a.OrigSatker_ID,a.Ruangan, 
														...
														b.Aset_ID, 
														c.NoKontrak, e.NamaSatker, e.KodeSatker, f.NamaLokasi, g.NoSKKDH, g.TglSelesai, h.Kode,h.Uraian
														...
														JOIN Kelompok AS h ON a.Kelompok_ID=h.Kelompok_ID
                                ...
                                <tr>
                                    <td>Nomor BAST</td>
                                    <td>
                                        <input type="text" style="width:200px" name="peman_pengem_eks_nobast" placeholder="" required="required" id="">&nbsp;<span id="errmsg"></span>
                                    </td>
                                    <td style="width:200px">Tanggal BAST</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_tglbast" placeholder="" id="tanggal12" required="required"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_lokasi_serah_terima" placeholder="" required="required" size="92"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>Nama</td>
                                    <td ><input type="text" style="width:200px" name="peman_pengem_eks_nm1" placeholder="" required="required"></td>
                                    <td>Nama</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_nm2" placeholder="" required="required"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>Jabatan</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_jabatan1" placeholder="" required="required"></td>
                                    <td>Jabatan</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_jabatan2" placeholder="" required="required"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>NIP</td>
                                    <td>
                                        <input type="text" style="width:200px" name="peman_pengem_eks_nip1" placeholder="" required="required" id="posisiKolom2">&nbsp;<span id="errmsg2"></span>
                                    </td>
                                    <td>NIP</td>
                                    <td>
                                        <input type="text" style="width:200px" name="peman_pengem_eks_nip2" placeholder="" required="required" id="posisiKolom3">&nbsp;<span id="errmsg3"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>Lokasi</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_lokasi1" placeholder="" required="required"></td>
                                    <td>Lokasi</td>
                                    <td><input type="text" style="width:200px" name="peman_pengem_eks_lokasi2" placeholder="" required="required"></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
									<td colspan="4" align=center><input type="submit" name="submit" value="Pengembalian"/><input type="button" value="Batal" onclick="window.location='pemanfaatan_pengembalian_tambah_data.php?pid=1'"/></td>
                                </tr>
                                </table>
                                </form>    
