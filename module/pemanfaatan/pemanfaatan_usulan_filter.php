...
?>
	...
	<section id="main">
		...
		<section class="formLegend">
			...
			<ul>
							<li>
								<span class="span2">ID Aset</span>
								<input type="text" name="peman_usulan_filt_asetid" placeholder="" style="width:200px;">
							</li>
							<li>
								<span class="span2">Nama Aset</span>
								<input type="text" name="peman_usulan_filt_nmaset" placeholder="" style="width:480px;">
							</li>
							<li>
