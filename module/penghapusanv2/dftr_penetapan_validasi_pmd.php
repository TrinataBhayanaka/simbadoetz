			...
			<table cellpadding="0" cellspacing="0" border="0" class="display table-checkable" id="penghapusan8">
				...
				foreach($data as $key => $row)
					...
					<tr class="gradeA">
						...
						<td align="center">	
						<a href="<?php echo "$url_rewrite/module/penghapusanv2/"; ?>validasi_proses_penetapan_pmd.php?id=<?php echo "$row[Penghapusan_ID]";?>" class="btn btn-warning"><i class="fa fa-check"></i> Lakukan Validasi</a>&nbsp;
						</td>
					</tr>
					<?php $nomor++;} }?>
				</tbody>
