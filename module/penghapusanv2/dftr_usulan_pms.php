          ...
          $('#usulan_pmd_table').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_usulan_pms_rev.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
    		<p><a href="<?=$url_rewrite?>/module/penghapusanv2/tambah_usulan_pms.php" class="btn btn-info btn-small"><i class="icon-plus-sign icon-white"></i>&nbsp;&nbsp;Tambah Usulan</a>
			<p>Tahun Usulan:
				<?=$tahun?>
			</p>
			<?php
