...
include"$path/menu.php";
    ...
    $(document).ready(function() {
          $('#usulan_pmd_table').dataTable(
			...
			<div id="demo">
			<form method="POST" ID="Form2" onsubmit="return confirmValidate()"  action="<?php echo"$url_rewrite"?>/module/penghapusanv2/daftar_tambahan_usulan_penghapusan_usul_proses_pmd.php"> 
					...
					<tr>
						...
						<?php
							if($flegAset==0){
								if($data_post){
						?>
							<a href="<?php echo"$url_rewrite"?>/module/penghapusanv2/dftr_review_aset_usulan_pmd.php" class="btn" id="btnback" <?=$btndis?>>Kembali ke Aset Usulan</a>
						<?php
									}
							}
						?>
						...
						<td colspan="3" align="right">
							<a href="<?php echo"$url_rewrite"?>/module/penghapusanv2/filter_tambah_aset_usulan_pmd.php?usulanID=<?php echo $_POST[usulanID] ?>" class="btn">Kembali Ke Pencarian</a>
						</td>
					</tr>
					<tr>
						<th>No</th>
