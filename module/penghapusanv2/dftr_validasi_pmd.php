          ...
          $('#usulan_pmd_table').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_list_validasi_pmd_rev.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
			...
			?>
    		<p><a href="<?=$url_rewrite?>/module/penghapusanv2/dftr_penetapan_validasi_pmd.php" class="btn btn-info btn-small"><i class="icon-plus-sign icon-white"></i>&nbsp;&nbsp;Validasi Penetapan</a>
			<?php
				}
			?>
			<p>Tahun Usulan:
