...
?>
          ...
          $('#penetapan_pms_table').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_penetapan_pms_rev.php?<?php echo $par_data_table?>"
               }
                  );
      });
    </script>
	<section id="main">
		...
		<section class="formLegend">
			...
			?>
			<p><a href="<?=$url_rewrite?>/module/penghapusanv2/tambah_penetapan_pms.php" class="btn btn-info btn-small"><i class="icon-plus-sign icon-white"></i>&nbsp;&nbsp;Tambah Penetapan Penghapusan</a>
			&nbsp;</p>
			<p>Tahun Penetapan:
				<?=$tahun?>
			</p>
			...
			?>
			<div id="demo">
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="penetapan_pms_table">
				<thead>
					<tr>
						<th>No</th>
