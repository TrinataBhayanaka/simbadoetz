...
<table border="0" cellspacing="6">	
       ...
       <table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                    <input type="text" name="p_gol5_kuantitas3a" id="p_gol5_kuantitas3a" style="text-align:right" value="<?=$dataArr->Kuantitas !=0 ?  number_format($dataArr->Kuantitas,0,',','.') : 0 ?>"required=" required" onblur="return format_nilaikuantitas3();"disabled>
					<input type="hidden" name="p_gol5_kuantitas3" id="p_gol5_kuantitas3" style="text-align:right;" value="<?=$dataArr->Kuantitas?>" disabled>
                </td>
                <td>
...
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input type="text" name="p_gol5_kuantitas2a" id="p_gol5_kuantitas2a"  style="text-align:right" value="<?=$dataArr->Kuantitas !=0 ?  number_format($dataArr->Kuantitas,0,',','.') : 0 ?>"required=" required" onchange="return format_nilaikuantitas2();"disabled>
						<input type="hidden" name="p_gol5_kuantitas2"  id="p_gol5_kuantitas2"style="text-align:right;" value="<?=$dataArr->Kuantitas?>" disabled>
                </td>
                <td>
...
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input type="text" name="p_gol5_kuantitas1a" id="p_gol5_kuantitas1a" style="text-align:right" value="<?=$dataArr->Kuantitas !=0 ?  number_format($dataArr->Kuantitas,0,',','.') : 0 ?>"required=" required" onchange="return format_nilaikuantitas1();"disabled>
						<input type="hidden" name="p_gol5_kuantitas1" id="p_gol5_kuantitas1" style="text-align:right;" value="<?=$dataArr->Kuantitas?>" disabled>
                </td>
                <td>
