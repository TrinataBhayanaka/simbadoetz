...
<body>
            ...
            // pr($_POST);
				if ($_POST['submit'])
                    {
					if($_POST['kd_idaset'] == "" && $_POST['kd_namaaset'] == "" && $_POST['kd_nokontrak'] == "" && $_POST['kd_tahun'] == "" && $_POST['kelompok_id5'] == "" && $_POST['lokasi'][0] == "" && $_POST['skpd_id'] == ""){
						?>
							<script type="text/javascript" charset="utf-8">
							var r=confirm('Tidak ada isian filter');
							if (r==false)
							{
								document.location="<?php echo "$url_rewrite/module/inventarisasi/entri/";?>entri_hasil_inventarisasi.php";
							}
							</script>
			...
			$data['sql_where'] = TRUE;
			$data['sql'] = "StatusValidasi = 1 AND Status_Validasi_Barang = 1";
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	<thead>
		<tr>
			<th style="background-color: #eeeeee; border: 1px solid #dddddd; font-weight:bold;" width="20px" >No</th>
							...
							<tr>
								...
								<td align="right">
								      ...
								      if (($_SESSION['ses_uaksesadmin'] == 1)){
										...
										<span style="padding:1px 5px 1px 5px; background-color:#eeeeee; border: 1px solid #cccccc;horizontal-align:'right';font-weight:bold;">
											<a href="<?php echo "$url_rewrite/module/inventarisasi/daftar_inventarisasi_barang.php"; ?>?id=<?php echo $value->Aset_ID ?>">Detail Inventarisasi</a></span>
