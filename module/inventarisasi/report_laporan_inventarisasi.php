...
$mode = $_REQUEST['mode'];
$laporan_inventarisasi = $_REQUEST['laporan_inventarisasi'];
...
$data=array(
    "modul"=>$modul,
    "mode"=>$mode,
    "laporan_inventarisasi"=>$laporan_inventarisasi,
    "tahun"=>$tahun,
...
//retrieve html
$html=$REPORT->retrieve_html_laporan_inventarisasi($result_query, $gambar);
