...
if(isset($_GET['id'])){
	...
	$dataArr = $RETRIEVE_INVENTARISASI->importing_xls2html_tanah($_FILES,$_POST);
          ...
          $('#importxls').dataTable(
                   {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?=$url_rewrite?>/api_list/api_import_xls_kiba.php?<?php echo $par_data_table?>"
               }
                  );
		...
		<section class="formLegend">
			...
			<div style="height:5px;width:100%;clear:both"></div>
				<form action="" name="checks" ID="Form2">
					<p><a href="hasil_kiba.php?id=<?=$_GET['id']?>"><button type="button" class="btn btn-success btn-small" id="btn-dis" disabled><i class="icon-plus-sign icon-white"></i>&nbsp;&nbsp;Import</button></a>
							&nbsp;</p>
