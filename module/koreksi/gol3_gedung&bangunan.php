...
<table border="0" cellspacing="6">
	...
	&nbsp;
                ...
                <td>
                        <input type="text" name="p_gdg_jumlah_lantai" value="<?=$dataArr->JumlahLantaiBangunan?>"size="20" >
                </td>
                <td>
	&nbsp;
                </td>  
                <td>
						<input type="text" name="p_gdg_luaslantai1" id="p_gdg_luaslantai1" value="<?=$dataArr->LuasLantaiBangunan !=0 ? number_format($dataArr->LuasLantaiBangunan,0,',','.') : 0 ?>"required=" required" onchange="return format_nilailuaslantai();";>M<sup>2</sup>
                        <input type="hidden" name="p_gdg_luaslantai" id="p_gdg_luaslantai" value="<?=$dataArr->LuasLantaiBangunan?>"size="20" >
                </td>  
        </tr>
</table>
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input type="text" name="p_gdg_dinding" value="<?=$dataArr->Dinding?>"size="45" >
                </td>
        </tr>
</table>
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input type="text" name="p_gdg_lantai" value="<?=$dataArr->Lantai?>"size="45" >
                </td>
        </tr>
</table>
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input type="text" name="p_gdg_plafon" value="<?=$dataArr->LangitLangit?>"size="45" >
                </td>
        </tr>
</table>
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input type="text" name="p_gdg_atap" value="<?=$dataArr->Atap?>"size="45" >
                </td>
        </tr>
</table>
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input type="text" name="p_gdg_nodokumen" value="<?=$dataArr->NoSurat?>" >
                </td>
                <td>
                        <input id="tanggal6"type="text" name="p_gdg_tgldokumen" value="<?=$dataArr->TglSurat?>" >
                </td>
...
<table border="0" cellspacing="6">
        ...
        <tr>
                <td>
                        <input id="tanggal5"type="text" name="p_gdg_tglpemakaian" value="<?=$dataArr->TglPakai?>" >
                </td>         
        </tr>
</table>
<table border="0" cellspacing="6">	
...
<table border="0" cellspacing="6">		
        ...
        <tr>
                <td>
                     <input type="text" name="p_gdg_asettanah" id="p_gdg_asettanah" style="width:450px;" readonly="readonly" value="<?=$dataArr->KelompokTanah_IDBangunan?>">
	<input type="button" name="idbtnlookupasettanah2" id="idbtnlookupasettanah2" value="Pilih" onclick = "showSpoiler(this);">
...
<table border="0" cellspacing="6">		
        ...
        <tr>
                <td>
               <input type="text" name="p_gdg_kodetanah" id="p_gdg_kodetanah" style="width:450px;" readonly="readonly" value="<?=$dataArr->Tanah_IDBangunan?>">
...
<table border="0" cellspacing="6">
        <tr>
                ...
                <tr>
                <td>
                        <input type="text" name="p_gdg_no_imb" value="<?=$dataArr->NoIMB?>" >
                </td>
                <td>
                        <input id="tanggal4"type="text" name="p_gdg_tglimb" value="<?=$dataArr->TglIMB?>" >
                </td>
        </tr>
</table>
