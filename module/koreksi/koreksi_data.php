							...
							<li>
								...
								<div class="control">
									<div class="input-prepend">
										...
										<input type="text" class="span2" name="tglPerolehan" id="tglPerolehan" value="<?=$dataArr['aset']['TglPerolehan']?>"/>
									</div>
								</div>
							</li>
							<li>
								...
								<div class="control">
									<div class="input-prepend">
										<span class="add-on"><i class="fa fa-calendar"></i></span>
										<input type="text" class="span2" name="tglPembukuan" id="tglPembukuan" value="<?=$dataArr['aset']['TglPembukuan']?>" />
									</div>
								</div>
							</li>
						</ul>
