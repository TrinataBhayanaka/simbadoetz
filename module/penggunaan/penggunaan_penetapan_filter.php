                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
                                        <td><input placeholder="" type="text" name="tglawal" style="width:200px;" id="tanggal12"></td>
                                    </tr>
									<tr>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
                                        <td><input placeholder="" type="text" name="tglakhir" style="width:200px;" id="tanggal13"></td>
                                    </tr>
									<tr>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="lda_skpd" id="lda_skpd" style="width:450px;" readonly="readonly" placeholder=" Tekan Tombol Pilih..." value="<?php echo $_SESSION['ses_satkername'] ; ?>">
