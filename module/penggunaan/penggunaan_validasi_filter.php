...
?>
	...
	<section id="main">
		...
		<section class="formLegend">
			...
			<form name="form" method="POST" action="<?php echo "$url_rewrite/module/penggunaan/"; ?>penggunaan_validasi_daftar.php?pid=1" onsubmit="return requiredFilter(false,true,'kodeSatker')">
			<ul>
                <!--
							<li>
							...
							<li>
								<span class="span2">Tgl Penetapan Penggunaan Akhir</span>
								<input placeholder="" type="text" name="penggu_valid_filt_tglpenet_akhir" style="width:200px;" id="tanggal11">
							</li>
							<li>
