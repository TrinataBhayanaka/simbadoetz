                    ...
                    <div id="frame_tengah1">
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <tr>
                                    <td>Nama Aset<br>
                                    <input placeholder="" type="text" name="penggu_penet_filt_add_nmaset" style="width:200px;"></td>
                                </tr>
                                <tr>
                                    <td>Nomor Kontrak<br>
										<input placeholder="" type="text" name="penggu_penet_filt_add_nokontrak" style="width:450px;" id="posisiKolom">&nbsp;<span id="errmsg"></span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><input type="submit" name="tampil2" value="Lanjut"></td>
                                    <td></td>
                                </tr>
