            ...
            <div id="tengah1">	
                <div id="frame_tengah1">
                    <div id="frame_gudang">
                        ...
                        <!--==================-->
                        <div id="bottomright">
                            <form method="post" enctype="multipart/form-data" action="proses_kiba.php">
                            <table border=0 cellspacing="6">
                                ...
                                <tr>
                                    ...
                                    <td>.</td>
                                    <td>
                                        <input type="text" name="p_noreg_kab" value="10"  size=1 maxlength="2"  id="posisiKolom2" readonly/>
                                    </td>
                                    <td>.</td>
                                    <td>
                            ...
                            <table>
                                <tr>
                                    <td style="font-weight:bold; text-decoration:underline;">Kabupaten</td>
                                    
                                </tr>
                                <tr>
                                    <td>
                                        <select id="p_kabupaten" name="p_kabupaten"  onchange="change_kabupaten();">
                                            <option value="10">Bireun</option>
                                            <option value="11">Banda Aceh</option>
                                            <option value="72">Sabang</option>
                                            <option value="0">DPKKA</option>
                                        </select>
                                    </td>
