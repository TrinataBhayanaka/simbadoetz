...
echo "<form action='proses_kibb_hasil.php' method='post' name='sheet'>";
...
echo "
		...
		<input type='checkbox' $require value='$nm_brg|$kd_brg|$noreg|$lokasi_id|$merk|$ukuran|$bahan|$tahun_pengadaan|
		$pabrik|$rangka|$mesin|$polisi|$bpkb|$asalusul|$harga_unit|$skpd_id|$ket|$user' />
		</td><td>$nm_brg</td><td $require_brg>$kd_brg</td><td>$noreg</td><td>$lokasi_id</td><td>$merk</td><td>$ukuran</td><td>$bahan</td><td $require_thn>$tahun_pengadaan</td><td>
		$pabrik</td><td>$rangka</td><td>$mesin</td><td>$polisi</td><td>$bpkb</td><td>$asalusul</td><td $require_harga>$harga_unit</td><td>$ket</td>
		</tr>		
	";
...
echo "
		...
		<td width='50' style='text-align:center'>
		<input type='checkbox' $require value='$nm_brg|$kd_brg|$noreg|$lokasi_id|$merk|$ukuran|$bahan|$tahun_pengadaan|
		$pabrik|$rangka|$mesin|$polisi|$bpkb|$asalusul|$harga|$skpd_id|$ket|$user' />
		</td><td>$nm_brg</td><td $require_brg>$kd_brg</td><td>$noreg</td><td>$lokasi_id</td><td>$merk</td><td>$ukuran</td><td>$bahan</td><td $require_thn>$tahun_pengadaan</td><td>
		$pabrik</td><td>$rangka</td><td>$mesin</td><td>$polisi</td><td>$bpkb</td><td>$asalusul</td><td $require_harga>$harga</td><td>$ket</td>
		</tr>		
	";
	}
  }
...
&nbsp<a href='kibb.php'><input type='button' value='Cancel' style='width:100px'/></a></div>
</form>";
