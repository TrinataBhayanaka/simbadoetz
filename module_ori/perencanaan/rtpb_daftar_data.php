						...
						<div id="bottomright">
							...
							<div id="perencanaan_new">
								<table border=0 width=100%>
									<tr align=right>
										<td>
											<a href="<?php echo "$url_rewrite/module/perencanaan/"; ?>rtpb_filter.php">
											<input type="button" value="Kembali ke halaman utama : Form Filter" >
											<a href="<?php echo "$url_rewrite/module/perencanaan/"; ?>rtpb_validasi.php">
											<input type="button" value="Lakukan Validasi dari data RTB" >
										</td>
									</tr>
									<tr>
										<td align=right>&nbsp;</td>
								...
								<form method="POST" action="rtpb-proses.php" onsubmit="return confirm('Apakah data yang dipilih ingin divalidasi?'); ">
								<table border="0" width=100% >
								...
								<table cellpadding="0" cellspacing="0" border="1" class="display" id="example" width="100%">	
									<thead>
										<tr>
											<td align="right" colspan="7">
												<input type="submit" value="Batalkan Validasi RTPB" name="novalidasi">
											</td>
										</tr>

										<tr>
											<th align="center" colspan="7" class="style2">Daftar Rencana Tahunan Pemeliharaan Barang</th>
										</tr>
										<tr>
										...
										<tr>
											...
											<th align="center" class="style2">Total Harga Pemeliharaan</th>
										</tr>
										</thead>
										<tbody>
										<?php
										...
										<tr>
											...
											<td align="center" class="style5"><?php echo $hsl_data->Pemeliharaan?> </td>
									...
									<tfoot>
										<tr>
											<th colspan="4">Daftar Rencana Tahunan Pemeliharaan Barang</th>
										</tr>
									</tfoot>
								</table>
