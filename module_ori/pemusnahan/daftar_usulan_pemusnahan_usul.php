     ...
     if (isset($submit))
                                {
                                            ...
                                            $data = $RETRIEVE->retrieve_usulan_pemusnahan_eksekusi($id);
                                } 
                                                            ...
                                                            <td style="border: 1px solid #004933; height:50px; padding:2px;">
                                                                <table width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top">
                                                                        <b><input type="hidden" name="pemusnahan_usul_nama_aset[]" value="<?php echo "$nilai[Aset_ID]";?>)<br/><?php echo "$nilai[NomorReg]";?><br/><?php echo "$nilai[NamaAset]";?>"/><?php echo "$nilai[Aset_ID]";?> (Aset ID)<br/><br/><?php echo "$nilai[NomorReg]";?><br/><br/><?php echo "$nilai[NamaAset]";?></b>
                                                                        </td>
