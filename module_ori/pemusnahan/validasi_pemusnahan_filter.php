                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="buph_val_noskpemusnahan" style="width:200px;" id="" placeholder="No BA Pemusnahan..."></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Tanggal Awal</td>
                                        <td><input type="text" name="buph_val_tgl_awal" style="width:200px;" id="tanggal13" placeholder="Tanggal Awal..."></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Tanggal Akhir</td>
                                        <td><input type="text" name="buph_val_tgl_akhir" style="width:200px;" id="tanggal12" placeholder="Tanggal Akhir..." /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
