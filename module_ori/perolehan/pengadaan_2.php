...
?>			
                        ...
                        <form action="<?php echo "$url_rewrite" ?>/module/perolehan/pengadaan_proses.php" method="post" enctype="multipart/form-data">
                            ...
                            <table border=0 cellspacing="6">
                                ...
                                <tr>
                                    ...
                                    <td>.</td>
                                    <td>
                                        <input type="text" id="p_noreg_satker" name="p_noreg_satker" value="00.00"  size=5 maxlength="5"  id="posisiKolom3" readonly="readonly"/>
                                    ...
                                    <td>.</td>
                                    <td>
                                        <input type="text" name="p_noreg_unit" value="00"  size=10 maxlength="2"  readonly="readonly" id="posisiKolom5"/><span id="errmsg"></span>
                                    </td>
                                </tr>
                            </table>
                            <table border=0 cellspacing="6">	
                                <tr>
                                    <td width="10">
                                        <input type="text" name="p_noreg_info_kel" value="" readonly="readonly" size="20" >
                                    </td>
                                    <td width="10">.</td>
                                    <td width="10">
                                    ...
                                    <td width="10">s/d</td>
                                    <td>
                                        <input type="text" name="p_noreg_noreg2"  value=""  size="6">
                                    </td>
                                <tr>
                                    <td colspan=5><i>
                            ...
                            <table border=0 cellspacing="6">
                                ...
                                <tr>
                                    ...
                                    <td>.</td>
                                    <td><input type="text" id="p_kodeaset" name="p_kodeaset" value=""  readonly="readonly"></td>
                                </tr>		
                            </table>
                            <table cellspacing="6">
                                <tr>
                                ...
                                <tr>
                                    <td><input type="text" name="p_nama_aset" size="67" value=""required=" required" ></td>
                                </tr>
                            </table>
                            <table cellspacing="6">
                                <tr>
 ...
 radioruang($style2,"p_ruang","ruang_id","ruanganbody","rprefix",$parameter);*/
                                            ...
                                            <tr>
                                                    ...
                                                    <tr>
                                                            <td>
                                                                    <input type="text" name="lda_lokasi" id="lda_lokasi" style="width:450px;" readonly="readonly" value="(Semua Lokasi)">
