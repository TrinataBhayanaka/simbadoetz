...
$mode = $_REQUEST['mode'];
$rekapitulasi_pemeliharaan_bmd = $_REQUEST['rekapitulasi_pemeliharaan_bmd'];
...
$data=array(
    "modul"=>$modul,
    "mode"=>$mode,
    "rekapitulasi_pemeliharaan_bmd"=>$rekapitulasi_pemeliharaan_bmd,
    "tahun"=>$tahun,
...
//retrieve html
$html=$REPORT->retrieve_html_rekapitulasi_pemeliharaan_bmd($result_query, $gambar);
