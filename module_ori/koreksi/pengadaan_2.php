                                ...
                                <tr>
                                        ...
                                        <tr>
                                            ...
                                            <table cellspacing="6">
                                                ...
                                                <tr>
                                                    <td><input type="text" id="p_ruangan"  name="p_ruangan" size="40" value="<?=$dataArr->Ruangan?>" readonly  >
                                                ...
                                                <br />
                                                    <tr>
                                                        <td valign="top" nowrap="true" align="left">
                                                            <textarea name="p_keterangantambahan"  style="width:500px; height :150px;"><?=$dataArr->KeteranganPenerimaan?></textarea> 
                                                        </td>
                                                    </tr>
                                                </table>
                                                <br />
...
function showdata_penerimaan_pengadaan(id,element_update){
    ...
    ambilDataPenerimaan(url,element_update);
                                                ...
                                                <tr>
                                                        ...
                                                        <?php foreach ($dataArr->SP2D_ID as $value){?>
                                                        <input type="hidden" name="SP2D_ID[]" value="<?=$value?>" >
                                                        <?php } ?>
                                                        <?php foreach ($dataArr->Kontraktor_ID as $value){?>
                                                                                                                            <input type="hidden" name="kontraktor_ID[]" value="<?=$value?>" >
                                                        <?php } ?>
                                                        <?php foreach ($dataArr->Kontrak_ID as $value){?>
                                                        ...
                                                        <input type="submit" onClick="sendit_6()" value="&nbsp;Hapus&nbsp;" name="hapus"/>
                                                </tr>
                                        </table>  
