...
<table border=0 cellspacing="6">
        <tr>
			...
			<td><input type="text" name="p_gtanah_luaskeseluruhan1" id="p_gtanah_luaskeseluruhan1" size='20' value="<?= $dataArr->LuasTotal!=0 ? number_format($dataArr->LuasTotal,0,',','.') : 0 ?>"required=" required" style="text-align:right;" onchange="return format_nilaikeseluruhan();" disabled>M<sup>2</sup></td>
            <td><input type="hidden" name="p_gtanah_luaskeseluruhan" id="p_gtanah_luaskeseluruhan" size='20' value="<?=$dataArr->LuasTotal?>" disabled></td>
            <td>Luas Untuk bangunan</td>
			<td><input type="text" name="p_gtanah_luasbangunan1" id="p_gtanah_luasbangunan1" size='20' value="<?= $dataArr->LuasBangunan!=0 ? number_format($dataArr->LuasBangunan,0,',','.') : 0 ?>"required=" required" style="text-align:right;" onchange="return format_nilailuasbangunan();" disabled>M<sup>2</sup></td>
            <td><input type="hidden" name="p_gtanah_luasbangunan" id="p_gtanah_luasbangunan" size=20 value="<?=$dataArr->LuasBangunan?>" disabled></td>
        </tr>
        <tr>
            <td>Luas Sarana Lingkungan</td>
			<td><input type="text" name="p_gtanah_saranalingkungn1" id="p_gtanah_saranalingkungn1" value="<?= $dataArr->LuasSekitar!=0 ? number_format($dataArr->LuasSekitar,0,',','.') : 0 ?>"required=" required" style="text-align:right;" onchange="return format_nilaisaranalingkungan();" disabled>M<sup>2</sup></td> 
            <td><input type="hidden" name="p_gtanah_saranalingkungn" id="p_gtanah_saranalingkungn" value="<?=$dataArr->LuasSekitar?>" size='20' disabled></td>
            <td>Luas Tanah Kosong</td>
			<td><input type="text" name="p_gtanah_tanahkosong1"id="p_gtanah_tanahkosong1" value="<?=$dataArr->LuasKosong!=0 ? number_format($dataArr->LuasKosong,0,',','.'): 0 ?>"required=" required" style="text-align:right;"  onchange="return format_nilaitanahkosong();" disabled >M<sup>2</sup></td>
            <td><input type="hidden" name="p_gtanah_tanahkosong" id="p_gtanah_tanahkosong" value="<?=$dataArr->LuasKosong?>" size='20' disabled></td>
        </tr>
