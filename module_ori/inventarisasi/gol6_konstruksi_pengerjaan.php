...
<table border="0" cellspacing="6">
            ...
            &nbsp;
                    ...
                    <td>
                            <input type="text" name="p_gjal_panjang1" id="p_gjal_panjang1" value="<?=$dataArr->JumlahLantai !=0 ? number_format($dataArr->JumlahLantai,0,',','.') : 0 ?>"required=" required" onblur="return format_nilaipanjang();"; size='20'style="text-align:right;" disabled>
							<input type="hidden" name="p_gjal_panjang" id="p_gjal_panjang" value="<?=$dataArr->JumlahLantai?>"size=20 disabled>
                    </td>
                    <td>
                    &nbsp;
                    </td>  
                    <td>
                            <input type="text" name="p_gol6_luas_lantai1" id="p_gol6_luas_lantai1" value="<?=$dataArr->LuasLantai !=0 ? number_format($dataArr->LuasLantai,0,',','.') : 0 ?>"required=" required" onblur="return format_nilailuaslantai();"; size='20' style="text-align:right;"disabled>m2
							<input type="hidden" name="p_gol6_luas_lantai" id="p_gol6_luas_lantai" value="<?=$dataArr->LuasLantai?>" size=20 style="text-align:right;" disabled>
                    </td>  
            </tr>
</table>
<table border="0" cellspacing="6">
            ...
            <tr>
                    <td>
                            <input id="tanggal16"type="text" name="tanggal_pembangunan" value="<?=$dataArr->TglMulai?>" disabled>
                    </td>
