...
<table border="0" cellspacing="6">
        <tr>
                ...
                <td><input type="hidden" name="p_jaringan_panjang" id="p_jaringan_panjang"size="5" value="<?=$dataArr->Panjang?>" disabled></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>Lebar</td>
                ...
                <td><input type="hidden" name="p_jaringan_lebar" id="p_jaringan_lebar" size="5" value="<?=$dataArr->Lebar?>" disabled></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>Luas</td>
                ...
                <td><input type="hidden" name="p_jaringan_luas" id="p_jaringan_luas" size="5"  value="<?=$dataArr->LuasJaringan?>" disabled></td>
        </tr>
</table>
<table border="0" cellspacing="6">
        <tr>
