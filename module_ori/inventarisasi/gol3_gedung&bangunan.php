...
<table border="0" cellspacing="6">
	...
	&nbsp;
                ...
                <td>
						<input type="text" name="p_gdg_luaslantai1" id="p_gdg_luaslantai1" value="<?=$dataArr->LuasLantaiBangunan !=0 ? number_format($dataArr->LuasLantaiBangunan,0,',','.') : 0 ?>"required=" required" onchange="return format_nilailuaslantai();" disabled>M<sup>2</sup>
                        <input type="hidden" name="p_gdg_luaslantai" id="p_gdg_luaslantai" value="<?=$dataArr->LuasLantaiBangunan?>"size="20" disabled>
                </td>  
        </tr>
</table>
<table border="0" cellspacing="6">
