                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>	
                                        <td><input placeholder="" type="text" name="penggu_valid_filt_tglpenet_awal" style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>	
                                        <td><input placeholder="" type="text" name="penggu_valid_filt_tglpenet_akhir" style="width:200px;" id="tanggal11"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>	
                                        <td>
                                            <input type="text" name="lda_skpd" id="lda_skpd" style="width:450px;" readonly="readonly" placeholder="">
