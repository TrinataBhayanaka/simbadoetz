                    ...
                    <div id="frame_tengah1">
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <form name="form" method="POST" action="<?php echo "$url_rewrite/"; ?>/module/penghapusan/validasi_lanjut.php?pid=1">
                                <table>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="bup_val_noskpenghapusan" placeholder="" style="width:200px;" id="">&nbsp;<span id="errmsg"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
                                        <td><input type="text" name="bup_val_tglskpenghapusan" placeholder="" style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
