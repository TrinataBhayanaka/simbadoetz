                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td valign="top" align="left" >
                                                                                    <input type="text" name="NoBASP" placeholder="Masukkan No Penetapan" style="width:180px;" required="required">
                                                                                </td>
                                                                                ...
                                                                                <!-- Tanggal Ketetapan -->
                                                                                <td valign="top" align="left" >
                                                                                    <input type="text" name="TglBAST" placeholder="Masukkan Tgl Penetapan" id="tanggal12" required="required">
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="4">&nbsp;</td>
                                                                        ...
                                                                        <!-- Nomor BASP -->
                                                                                ...
                                                                                <td valign="top" align="left" >
                                                                                    <input type="text" name="bupt_bast_nobast" placeholder="Masukkan No BAST" required="required">
                                                                                </td>
                                                                                <td valign="top" align="left" width="120px">
                                                                                    Tanggal&nbsp;BAST
                                                                                </td>
                                                                                <!-- Tanggal BASP -->
                                                                                <td valign="top" align="left" >
                                                                                    <input type="text" name="bupt_bast_tglbast" placeholder="Masukkan Tgl BAST" id="tanggal13" required="required">
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="4">&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td valign="top" align="left" colspan="3"><input type="text" name="LokasiBASP" placeholder="Masukkan Lokasi Serah Terima" required="required">
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="4">&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td valign="top" align="left" colspan="3">
                                                                                    <select name="bupt_bast_tipepemindahtanganan" placeholder="Pilih Tipe Pemindahtanganan" style="width:490px" required="required">
                                                                                            <option value="">-</option>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td valign="top" align="left" colspan="3">
                                                                                    <select name="bupt_bast_peruntukan" placeholder="Pilih Peruntukan" style="width:490px" required="required">
                                                                                          <option value="">-</option>
                                                                                    ...
                                                                                    <textarea name="bupt_bast_alamat" placeholder="Masukkan Alamat Pihak Kedua" style="width:490px" required="required">
                                                                                    </textarea>
                                                                                </td>
                                                                       </tr>
                                                                       <tr>
                                                                                    ...
                                                                                    <table width="100%">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td valign="top" align="left"><input type="text" style="width:95%;" 
                                                                                                        name="bupt_bast_nama_1" required="required" placeholder="Masukkan Nama1">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td valign="top" align="left"><input type="text" style="width:95%;" 
                                                                                                        name="bupt_bast_jabatan_1" required="required" placeholder="Masukkan Jabatan1">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td valign="top" align="left"><input type="text" style="width:95%;" 
                                                                                                        name="bupt_bast_nip_1" required="required" placeholder="Masukkan NIP1"></td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td valign="top" align="left"><input type="text" style="width:95%;" 
                                                                                                        name="bupt_bast_lokasi_1" required="required" placeholder="Masukkan Lokasi1">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
                                                                                ...
                                                                                <td valign="top" align="left" colspan="2">
                                                                                    ...
                                                                                    <table width="100%">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="95px" valign="top" align="left">Nama</td>
                                                                                                <td valign="top" align="left"><input type="text" style="width:95%;" 
                                                                                                        name="bupt_bast_nama_2" required="required" placeholder="Masukkan Nama2">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td valign="top" align="left">
                                                                                                        ...
                                                                                                        name="bupt_bast_jabatan_2" required="required" placeholder="Masukkan Jabatan2">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td valign="top" align="left">
                                                                                                    <input type="text" style="width:95%;" 
                                                                                                        name="bupt_bast_nip_2" required="required" placeholder="Masukkan NIP2">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="*" valign="top" align="left">Lokasi</td>
                                                                                                <td valign="top" align="left"><input type="text" style="width:95%;" 
                                                                                                        name="bupt_bast_lokasi_2" required="required" placeholder="Masukkan Lokasi2">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2">&nbsp;</td>
