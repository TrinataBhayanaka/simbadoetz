                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="buph_val_noskpemusnahan" style="width:200px;" id=""></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Tgl Awal</td>
                                        <td><input type="text" name="buph_val_tgl_awal" style="width:200px;" id="tanggal13"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Tgl Akhir</td>
                                        <td><input type="text" name="buph_val_tgl_akhir" style="width:200px;" id="tanggal12""></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
