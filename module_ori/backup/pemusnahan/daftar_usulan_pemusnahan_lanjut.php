...
$USERAUTH->FrontEnd_check_akses_menu($menu_id, $SessionUser);
    ...
    $aset_id=$_POST['buph_idaset'];
    $nama_aset=$_POST['buph_namaaset'];
    $nomor_kontrak=$_POST['buph_nokontrak'];
    $tahun_perolehan=$_POST['buph_tahun'];
    ...
    if (isset($submit))
                        {
                                    ...
                                    $data = $RETRIEVE->retrieve_usulan_pemusnahan_filter($parameter);
                        }
                                                ...
                                                Buat Usulan Pemusnahan
                                                    ...
                                                    <div id="bottomright">
                                                        <div style="margin-bottom:10px; float:right;">
                                                            <a href="<?php echo "$url_rewrite/module/pemusnahan/"; ?>daftar_usulan_pemusnahan_filter.php"><input type="submit" value="Kembali ke Halaman Utama: Cari Aset"></a>
                                                        </div>
                                                        <?php
                                                        ...
                                                        <div style="margin-bottom:10px; float:right; clear:both;">
                                                            <a href="<?php echo "$url_rewrite/report/template/PEMUSNAHAN/tes_class_daftar_pemusnahan_filter_cetak_seluruh.php?menu_id=46&mode=1&parameter=$param";?>" target="_blank"><input type="submit" value="Cetak seluruh data"></a>
                                                            <a href="<?php echo "$url_rewrite/report/template/PEMUSNAHAN/tes_class_daftar_pemusnahan_filter_dengan_pilihan.php?menu_id=46&mode=1";?>"  target="_blank"><input type="submit" value="Cetak dari daftar anda"></a>
                                                        </div>
                                                        <div style="margin-bottom:10px; float:right; clear:both;">
                                                            <a href="<?php echo "$url_rewrite/module/pemusnahan/"; ?>pemusnahan_usulan_daftar_usulan.php?pid=1"><input type="submit" value="Daftar Barang"></a>
                                                        </div>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td colspan=3><p style="float:left;"><u onmouseover="this.style.backgroundColor='orange'" onmouseout="this.style.backgroundColor=''" id="pilihHalamanIni">Pilih halaman ini</u>&nbsp;&nbsp; || 
                                                                                                ...
                                                                                                <?php
                                                                                                    $cek=$data['asetList'];
                                                                                                ?>
                                                                                                <p style="float:right;"><input type="submit" name="submit" value="Usul Pemusnahan" id="submit" disabled/></p>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" style="border: 1px solid #004933; height:100px; color: black; font-weight: bold;">
                                                                        <input type="checkbox"   class="checkbox" onchange="enable()" name="PemusnahanUsul" value="<?php echo $value->Aset_ID;?>" <?php for ($j = 0; $j <= count($data['asetList']); $j++){if ($data['asetList'][$j]==$value->Aset_ID) echo 'checked';}?>/>
                                                                    </td>
