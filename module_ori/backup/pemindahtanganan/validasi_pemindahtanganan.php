                        ...
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <div style="margin-bottom:10px; float:right;">
                                    <a href="<?php echo "$url_rewrite/module/pemindahtanganan/"; ?>validasi_filter_pemindahtanganan.php"><input type="submit" value="Kembali ke Halaman Utama: Cari Aset"></a>
                                </div>
                                <div style="margin-bottom:10px; float:right; clear:both;">
                                    <a href="<?php echo "$url_rewrite/module/pemindahtanganan/"; ?>validasi_pemindahtanganan_daftar_valid.php?pid=1"><input type="submit" value="Daftar Barang"></a>
                                </div>
                                ...
                                <table  width="100%" style="padding:2px; margin-top:0px; border: 1px solid #004933; border-width: 1px 1px 1px 1px; clear:both;">
                                    <tbody>
                                        ...
                                        <tr style="background-color:#004933; color:white; height:20px;">
                                            ...
                                            <th width="100px" align="center" style="border: 1px solid #004933;">Tanggal Pemindahtanganan</th>
                                            <th width="80px" align="center" style="border: 1px solid #004933;">Lokasi Pemindahtanganan</th>
                                        </tr>
