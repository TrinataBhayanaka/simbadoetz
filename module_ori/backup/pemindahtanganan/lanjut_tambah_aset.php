    <?php
        ...
        if (isset($submit)){
                if ($asetid=="" && $nm_aset=="" && $no_kontrak=="" && $lokasi=="" && $satker==""){
    ?>
	...
	<div id="content">
                                                    ...
                                                    <div id="topright">
                                                            ...
                                                            <div id="bottomright">
                                                                ...
                                                                <div style="margin-bottom:10px; float:right;">
                                                                    <a href="<?php echo "$url_rewrite/module/pemindahtanganan/"; ?>tambah_aset_pemindahtanganan.php"><input type="submit" value="Kembali ke Halaman Utama: Cari Aset"></a>
                                                                </div>
                                                                <div style="margin-bottom:10px; float:right; clear:both;">
                                                                    ...
                                                                    //echo "$param";
                                                                    ?>
                                                                    <a href="<?php echo "$url_rewrite/report/template/PEMINDAHTANGANAN/tes_class_penetapan_pemindahtanganan_cetak_seluruh.php?menu_id=43&mode=1&parameter=$param";?>" target="_blank"><input type="submit" value="Cetak Daftar Aset (PDF)"></a>
                                                                </div>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" style="border: 1px solid #004933; height:100px; color: black; font-weight: bold;">
                                                                                    <input type="checkbox" class="checkbox" onchange="enable()" name="PemindahtangananPenetapan" value="<?php echo $value->Aset_ID;?>" <?php for ($j = 0; $j <= count($data['asetList']); $j++){if ($data['asetList'][$j]==$value->Aset_ID) echo 'checked';}?>/>
                                                                            </td>
		   ...
		   $(function(){
			...
			$("#pilihHalamanIni").click(function () {
			    ...
			    var modParam = 'PemindahtangananPenetapan';
