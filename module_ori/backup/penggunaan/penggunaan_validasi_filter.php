                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="penggu_valid_filt_tglpenet_awal" style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="penggu_valid_filt_tglpenet_akhir" style="width:200px;" id="tanggal11"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="penggu_valid_filt_nopenet" style="width:450px;" id="posisiKolom">&nbsp;<span id="errmsg"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>		
