    <?php
        ...
        $aset_id=$_POST['peman_usulan_filt_asetid'];
        $nama_aset=$_POST['peman_usulan_filt_nmaset'];
        $no_kontrak=$_POST['peman_usulan_filt_nokontrak'];
        ...
        //open_connection();
            ...
            $query_alias_asetid="MGRA.Aset_ID LIKE '%$aset_id%'";
            }
            ...
            //$query_no_kontrak="NoKontrak LIKE '%$no_kontrak%'";
            }
            ...
            if($satker!=""){
                ...
                $query_alias_satker="MGRA.Aset_ID IN ($gabung)";
            }
		...
		$parameter_sql_report="WHERE ".$parameter_sql_report." AND ";
            ...
            $query_apl = "SELECT aset_list FROM apl_userasetlist WHERE aset_action = 'UsulanPemanfaatan' AND UserSes = '$_SESSION[ses_uid]'";
            //print_r($query_apl);
        ...
        if (isset($submit)){
                if ($aset_id=="" && $nama_aset=="" && $no_kontrak=="" && $satker==""){
    ?>
        ...
        <body onload="enable()">
                    ...
                    <div id="frame_tengah1">
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <div style="margin-bottom:10px; float:right; clear:both;">
                                    <a href="<?php echo "$url_rewrite/module/pemanfaatan/"; ?>pemanfaatan_usulan_daftar_usulan.php"><input type="submit" value="Daftar Barang"></a>
                                </div>
                                <form name="form" method="POST" action="<?php echo "$url_rewrite/module/pemanfaatan/"; ?>pemanfaatan_usulan_eksekusi_data.php">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan=3><p style="float:left;"><u onmouseover="this.style.backgroundColor='orange'" onmouseout="this.style.backgroundColor=''" id="pilihHalamanIni">Pilih halaman ini</u>&nbsp;&nbsp; || 
                                                                        ...
                                                                        <p style="float:right;"><input type="submit" name="submit" value="Usul Pemanfaatan" id="submit" disabled/></p>
                                            </td>
                                        </tr>
                                        ...
                                        <?php
                                                ...
                                                $query="SELECT Aset_ID FROM MenganggurAset $_SESSION[parameter_sql] StatusUsulan =0 ORDER BY Aset_ID ASC limit $offset, $jmlperhalaman";
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="border: 1px solid #004933; height:100px; color: black; font-weight: bold;">
                                                 <input type="checkbox" class="checkbox" onchange="enable()" name="UsulanPemanfaatan" value="<?php echo $value->Aset_ID;?>" <?php for ($j = 0; $j <= count($explode); $j++){if ($explode[$j]==$value->Aset_ID) echo 'checked';}?>/>
                                            </td>
		   ...
		   $(function(){
			...
			$("#pilihHalamanIni").click(function () {
			    ...
			    var modParam = 'UsulanPemanfaatan';
