                    ...
                    <div id="frame_tengah1">
                        <div id="frame_gudang">
                            ...
                            <div id="bottomright">
                                ...
                                <form name="form" method="POST" action="<?php echo "$url_rewrite/module/pemanfaatan/"; ?>pemanfaatan_penetapan_tambah_data.php">
                                <table>
                                    ...
                                    <tr>
                                        <td>Aset ID</td>
                                        <td><input type="text" name="peman_penet_filt_add_idaset" style="width:200px;"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Nama Aset</td>
                                        <td><input type="text" name="peman_penet_filt_add_nmaset" style="width:200px;"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>Nomor Kontrak</td>
                                        <td>
                                            <input type="text" name="peman_penet_filt_add_nokontrak" style="width:450px;" id="posisiKolom">&nbsp;<span id="errmsg"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    ...
                                    <!--<tr>
                                        <td>Nomor Usulan</td>
                                        <td>
                                            <input type="text" name="peman_penet_filt_add_nousulan" style="width:450px;" id="posisiKolom2">&nbsp;<span id="errmsg2"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
