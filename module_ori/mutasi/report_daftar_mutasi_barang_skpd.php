...
$mode = $_REQUEST['mode'];
$daftar_mutasi_barang_skpd = $_REQUEST['daftar_mutasi_barang_skpd'];
...
$data=array(
    "modul"=>$modul,
    "mode"=>$mode,
    "daftar_mutasi_barang_skpd"=>$daftar_mutasi_barang_skpd,
    "tahun"=>$tahun,
...
//retrieve html
$html=$REPORT->retrieve_html_daftar_mutasi_barang_skpd($result_query, $gambar);
