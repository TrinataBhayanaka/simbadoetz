...
<table cellspacing="6">
        <tr>
            <td>Jenis Barang<br>	
                     <input type="text" name="p_jenisbarang" id="lda_kelompok3" style="width:450px;" disabled placeholder="<?php if ($dataArr->Uraian !=''){echo $dataArr->Uraian;} else {echo '(Semua Jenis Barang)';}?>">
...
<table border="0" cellspacing="6">	
       ...
       <tr>
           <td>
                  <select name="p_jenisaset" disabled>
          ...
          <td>
                   <select name="p_bersejarah" value="" disabled>
