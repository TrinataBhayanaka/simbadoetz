                                                                    ...
                                                                    <tbody><tr><td style="height: 5px;"><!-- just give a space --></td></tr>
                                                                            <tr>
                                                                                    <td>ID&nbsp;Aset&nbsp;(System&nbsp;ID)<br>
                                                                                            <input placeholder="Aset ID..." style="width: 200px;"  name="kd_idaset" type="text" ></td>
                                                                            </tr>
                                                                            <tr>
                                                                                    <td>Nama&nbsp;Aset<br>
                                                                                                <input placeholder="Nama Aset..." isdatepicker="true" style="width: 480px;"  name="kd_namaaset"  type="text"></td>
                                                                            </tr>
                                                                            <tr>
                                                                                    <td>Nomor&nbsp;Kontrak<br>
                                                                                                <input placeholder="Nomor Kontrak..." isdatepicker="true" style="width: 200px;" name="kd_nokontrak"  type="text"></td>
                                                                            </tr>
                                                                            <tr>
                                                                                    <td>Tahun&nbsp;Perolehan<br>
                                                                                    <input placeholder="Tahun..." name="kd_tahun"  type="text" ></td>
