                            ...
                            <div id="bottomright">
                                ...
                                <table>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
									   <td><input type="text" name="peman_valid_filt_tglpenet" placeholder="" style="width:200px;" id="tanggal12"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
                                        <td><input type="text" name="peman_valid_filt_tipe" placeholder="" style="width:450px;"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
										...
										<td>&nbsp;</td>
                                        <td><input type="text" name="peman_valid_filt_alasan" placeholder="" style="width:450px;"></td>
