											...
											<tbody><tr><td style="height: 5px;"><!-- just give a space --></td></tr>
													<tr>
															<td>ID&nbsp;Aset&nbsp;(System&nbsp;ID)<br>
																	<input style="width: 200px;" id="lda_ia" name="kd_idaset" type="text" ></td>
													</tr>
													<tr>
															<td>Nama&nbsp;Aset<br>
													...
													<tr>
															<td>Nomor&nbsp;Kontrak<br>
																		<input isdatepicker="true" style="width: 200px;" id="lda_nk" name="kd_nokontrak"  type="text"></td>
													</tr>
													<tr>
															<td>Tahun&nbsp;Perolehan<br>
															<input name="kd_tahun" id="lda_tp"  type="text" ></td>
