...
open_connection();  
	...
	$sql = mysql_query("SELECT * FROM kelompok WHERE {$cond} AND (Uraian LIKE '%{$term}%' OR Kode LIKE '{$term}%') ORDER BY Kelompok_ID ASC LIMIT 5");	
...
>>>>>>> 465116af63254368fc98fb9ff506df812a81fbfc
?>