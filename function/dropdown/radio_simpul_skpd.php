...
switch ($level) {
     ...
     case "3"://Kelompok
          $spasi="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		  $tambahan_query="and KodeUnit is not null and Gudang is null";
          $kode_field="KodeUnit";
		  $titik=".";
      $titik2="";
          break;
	case "4"://Kelompok
          $spasi="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
          $tambahan_query="and Gudang is not null";
          $kode_field="Gudang";
          $titik=".";
          $titik2=".";
          $last="stop";
...
if($kode!=""&&$paramater_sql!=""){
  ...
  //  echo "<table width=\"100%\" align=\"left\" border=\"0\" class=\"tabel\">";
     ...
     while($row=  mysql_fetch_object($result)){
          ...
          $kode=$row->KodeSatker.$titik.$row->KodeUnit.$titik2.$row->Gudang;
          $uraian=$row->NamaSatker;
               $kode_for_js="$prefix-skpd_row_1|$kode|$level";
		 $kodesatker=$row->KodeSatker;
		 if($level==2){
		$query_cek="Select * from Satker where KodeSatker='$kodesatker' and KodeUnit is not NULL and NGO='0'";
		$cek_isi=mysql_query($query_cek);
		$isi=mysql_num_rows($cek_isi);
		if($isi==0)
		$last="stop";
		else $last="";
		}		
