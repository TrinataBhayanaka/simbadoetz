...
while($row = mysql_fetch_object($result))
{
               ...
               echo "<tr id='$kode_for_js'>";
                    echo "<td> &nbsp;<input type=\"radio\" name=\"$tbody_name"."[]\" id=\"$prefix"."_$kode\" value=\"$ngo_id\" onclick=\"SelectAllChild_$tbody_name(this);\"></td>";
...
{	
     ...
     echo "<tr id='$kode_for_js'>";
          echo "<td> &nbsp;&nbsp;&nbsp;&nbsp;<input type=\"radio\" id=\"$prefix"."_$kode\" name=\"$tbody_name"."[]\" value=\"$ngo_id\" onclick=\"SelectAllChild_$tbody_name(this)\"></td>";
