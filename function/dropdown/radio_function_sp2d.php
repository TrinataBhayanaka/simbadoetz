...
function js_radiosp2d($alamat_simpul,$alamat_search,$parsing,$save_element,$tbody_name,$prefix,$data,$root_api){
     
   echo"<script type=\"text/javascript\">
function add_sp2d$prefix(kode_for_js,kode){
  ...
  echo "<script type=\"text/javascript\">
			...
			document.getElementById('preload_sp2d').value='Mencari..';
			document.getElementById('preload_sp2d').disabled=true;
			document.getElementById('$parsing').value='(Semua Kontrak)';
			id=document.getElementById('search_sp2d$prefix').value;
...
function radiosp2d($style_div,$save_element,$tbody_name,$prefix){
     ...
     echo " <tr>
               ...
               <input type=\"text\" style=\"width: 70%;\" value=\"\" id=\"search_sp2d$prefix\">
               <input type=\"button\" id=\"preload_sp2d\" value=\"Cari\" onClick=\"recp$prefix()\">
               </th>
               </tr>
               <tr>
       ...
       if($update!=""){
         radio_updatesp2d($update,$prefix, $tbody_name);
 ...
 function radio_updatesp2d($update,$prefix, $tbody_name){
