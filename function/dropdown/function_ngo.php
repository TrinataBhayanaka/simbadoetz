...
function js_checkboxngo($alamat_simpul,$alamat_search,$parsing,$save_element,$tbody_name,$prefix){
...
function add_ngo$prefix(kode_for_js,kode){
  ...
  echo "
		  ...
		  function SelectAllChild_$tbody_name(id) {
                   ...
                   setCheckBox_ngo_$tbody_name(\"$tbody_name\", \"input\", b, m);
         ...
         <script>
              function setCheckBox_ngo_$tbody_name(container, selectorTag, prefix,nilai,element_update) {
               var items = [];
               var hasil='';
               var myPosts = document.getElementById(container).getElementsByTagName(selectorTag);
               var c=1;
...
function checkboxngo($style_div,$save_element,$tbody_name,$prefix){
