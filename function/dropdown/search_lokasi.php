<?php
  ...
  $total=0;
  if($id!=""){
  $sql=mysql_query("SELECT * FROM Lokasi WHERE KodeLokasi NOT LIKE '__' and KodeLokasi LIKE '11%' and NamaLokasi LIKE '%$id%' ORDER BY KodeLokasi ASC");
  } else {
...
while($row = mysql_fetch_object($result))
{
     ...
     echo "<tr id='$kode_for_js'>";
          echo "<td> &nbsp;<input type=\"checkbox\" id=\"$prefix"."_$kode\" name=\"$tbody_name"."[]\" value=\"$lokasi_id\" onclick=\"SelectAllChild_$tbody_name(this);\"></td>";
