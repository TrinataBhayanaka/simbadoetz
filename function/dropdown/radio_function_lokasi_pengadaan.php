...
function js_radiopengadaanlokasi($alamat_simpul,$alamat_search,$parsing,$save_element,$tbody_name,$provinsi,$kabupaten,$kecamatan,$desa,$prefix){
...
function add_lokasi$prefix(kode_for_js,kode){
  ...
  ceking=2;
                   ...
                   if(count==1)
                    {
                                document.getElementById('$provinsi').value=lokasi[0];
                    ...
                    {
                                document.getElementById('$provinsi').value=lokasi[1];
                                document.getElementById('$kabupaten').value=lokasi[0];
                                document.getElementById('$kecamatan').value='-';
                                document.getElementById('$desa').value='-';
                    }
                    else if(count==3)
                    {
                                document.getElementById('$provinsi').value=lokasi[2];
                                document.getElementById('$kabupaten').value=lokasi[1];
                                document.getElementById('$kecamatan').value=lokasi[0];
                                document.getElementById('$desa').value='-';
                    }
                    else if(count==4)
                    {
                                document.getElementById('$provinsi').value=lokasi[3];
                                document.getElementById('$kabupaten').value=lokasi[2];
                                document.getElementById('$kecamatan').value=lokasi[1];
                                document.getElementById('$desa').value=lokasi[0];
                    }
         ...
         <script>
              function setCheckBox_lokasi(container, selectorTag, prefix,nilai,element_update) {
               var items = [];
               var hasil='';
               var myPosts = document.getElementById(container).getElementsByTagName(selectorTag);
               var c=1;
...
function radiopengadaanlokasi($style_div,$save_element,$tbody_name,$prefix){
     ...
     echo " <tr>
        ...
        <tbody id='$tbody_name'>";
      if($update!=""){
          radio_update_lokasi_pengadaan($update,$prefix, $tbody_name);
 ...
 function radio_update_lokasi_pengadaan($update,$prefix, $tbody_name){
      $total=0;
          if($update!=""){
