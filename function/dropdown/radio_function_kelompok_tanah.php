...
function js_radiokelompoktanah($alamat_simpul,$alamat_search,$parsing,$save_element,$tbody_name,$prefix){
...
function radiokelompoktanah($style_div,$save_element,$tbody_name,$prefix){
     ...
     if($update!=""){
          kelompok_update_kelompoktanah($update,$prefix, $tbody_name);
 ...
 function kelompok_update_kelompoktanah($id,$prefix,$tbody_name){
