...
function js_radiopengadaankelompok($alamat_simpul,$alamat_search,$parsing,$save_element,$tbody_name,$show_element,$prefix){
...
function add_kelompok$prefix(kode_for_js,kode){
  ...
  echo "
		  ...
		  function SelectAllChild_$tbody_name(id) {
                  ...
                  if (document.getElementById(b).checked == \"true\" ||document.getElementById(b).checked == \"1\" )
                  {
                         switch (ceking_parent){
                              case '01':
...
function radiopengadaankelompok($style_div,$save_element,$tbody_name,$prefix){
     ...
     if($update!=""){
      //echo 'nilai update'.$update;
          radio_update_kelompok_pengadaan($update,$prefix, $tbody_name);
 ...
 function radio_update_kelompok_pengadaan($id,$prefix,$tbody_name){
      $total=0;
