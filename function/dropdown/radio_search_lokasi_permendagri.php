<?php
  ...
  $total=0;
  if($id!=""){
  $sql=mysql_query("SELECT * FROM Lokasi_Permendagri WHERE KodeLokasi NOT LIKE '__' and NamaLokasi LIKE '%$id%' ORDER BY KodeLokasi ASC");
  } else {
...
while($row = mysql_fetch_object($result))
{
     ...
     echo "<tr id='$kode_for_js'>";
          echo "<td> &nbsp;<input type=\"hidden\" id=\"$prefix"."_$kode\" name=\"$tbody_name"."[]\" value=\"$lokasi_id\" onclick=\"SelectAllChild_$tbody_name(this);\"></td>";
...
{	
	 ...
	 $sql_lvl2=mysql_query("select * from Lokasi_Permendagri where IndukLokasi='$induk_lvl2' and KodeLokasi='$kode_lvl2' ORDER by KodeLokasi ASC");
...
{	
	 ...
	 $sql_lvl3=mysql_query("select * from Lokasi_Permendagri where IndukLokasi='$induk_lvl3' and KodeLokasi='$kode_lvl3' ORDER by KodeLokasi ASC");
