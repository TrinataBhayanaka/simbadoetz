...
function js_radiopengadaanskpd($alamat_simpul, $alamat_search, $parsing, $save_element, $tbody_name, $show_element, $show_element2, $prefix, $url_rewrite=false) {

// function js_radiopengadaanskpd($alamat_simpul, $alamat_search, $parsing, $save_element, $tbody_name, $show_element, $show_element2, $prefix) {
		  ...
		  function SelectAllChild_$tbody_name(id) {
               ...
               h=document.getElementById(b).value;
                   ...
                   document.getElementById('$show_element').value=show[1];
                    ...
                    add_ruangan$prefix(h,'isi_ruangan');
...
function radiopengadaanskpd($style_div, $save_element, $tbody_name, $prefix) {
     ...
     if ($_SESSION['ses_satkerid'] != 0) {
          $satker_id = $_SESSION['ses_satkerid'];
          radio_sessionskpd_pengadaan($satker_id, $prefix, $tbody_name);
     } else {



          if ($update != "") {
               radio_updateskpd_pengadaan($update, $prefix, $tbody_name);
          } else {
...
function radio_updateskpd_pengadaan($update, $prefix, $tbody_name) {
...
function radio_sessionskpd_pengadaan($update, $prefix, $tbody_name) {
