...
echo "<table table id='myTable' class='tablesorter'>
<thead>
<tr>
<th>SELEKSI</th>
<th>NAMA BARANG</th>
...
echo "
		<tr id>
		<td width='50' style='text-align:center'><input type='checkbox' name='formDoor[]' value='$nama|$kd_brg|$tgl_fix|$merk|$bahan|$ket|$harga|$thn|$satuan' />
		</td><td>$nama</td><td>$kd_brg</td><td>$tanggal</td>
		<td>$merk</td><td>$bahan</td><td>$satuan</td><td>$ket</td><td>$harga</td>
		</tr>		
	";
