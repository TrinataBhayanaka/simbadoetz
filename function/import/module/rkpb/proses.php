...
// import data excel mulai baris ke-6 (karena baris pertama adalah nama kolom)

echo "<table id='table' cellspacing='0' class='tablesorter'>
<thead>
<tr>
<th>SELEKSI</th>
<th>TAHUN</th>
...
echo "
		...
		<td>$merk_tipe</td><td>$kode_rek</td><td>$jml_brg</td><td>$harga</td><td>$ttl_harga</td><td style='".$change."'>$status</td>
		</tr>		
	";
	}
}
