...
class core_api_report extends DB {
		...
		//==============================================================	
		  ...
		  */
		  ...
		  $query_kir_condition = "select A.Aset_ID,A.LastSatker_ID, A.Ruangan, A.NamaAset,A.Tahun,M.Merk, M.NoSeri, M.Ukuran, M.Material, M.TahunBuat, A.Kuantitas, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, A.NilaiPerolehan, A.Info, A.Ruangan,
								...
								left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
								left outer join Kondisi KDS on A.Aset_ID=KDS.Aset_ID
								where A.Ruangan is not null AND $parameter_sql 
								order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
		 ...
		 $query_kir_default = "select A.Aset_ID,A.LastSatker_ID, A.Ruangan, A.NamaAset,A.Tahun, M.Merk, M.NoSeri, M.Ukuran, M.Material, M.TahunBuat, A.Kuantitas, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, A.NilaiPerolehan, A.Info, A.Ruangan,
          ...
          $query_pengadaan_bmd_condition = "select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.Kuantitas, A.TglPerolehan, 
											...
											D.Kode, D.Uraian, D.Satuan,  K.NoKontrak,K.TglKontrak, S.TglSP2D, S.NoSP2D from Aset A 
    ...
    public function get_report_rekap_inv_daerah($tahun)
    {
        ...
        $query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    ...
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.Tahun = '$tahun' where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
        $query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.Tahun = '$tahun' where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
        $query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.Tahun = '$tahun' where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
        $query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.Tahun = '$tahun' where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.Tahun = '$tahun' where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.Tahun = '$tahun' where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.Tahun = '$tahun' where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
    ...
    public function get_report_rekap_inv_skpd($parameter,$tahun)
    {
        foreach ($parameter as $Satker_ID => $value)
        {
            ...
            $query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' and a.Tahun = '$tahun' where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
            $query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' and a.Tahun = '$tahun' where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' and a.Tahun = '$tahun' where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode  ";
            $query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' and a.Tahun = '$tahun' where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' and a.Tahun = '$tahun' where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' and a.Tahun = '$tahun' where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' and a.Tahun = '$tahun' where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
    ...
    public function get_report_rekap_pengadaan_BMD($param)
		...
		foreach ($param['Satker_ID'] as $Satker_ID => $value)
		{
			...
			$query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID where  k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID where  k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID where  k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID where  k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID where  k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID where  k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID where  k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
 ...
 //Rekapitulasi Pemeliharaan BMD
    public function get_report_rekap_pemeliharaan_BMD($param)
    {
		...
		foreach ($param['Satker_ID'] as $Satker_ID => $value)
		{
        $query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
 ...
 //Rekapitulasi Penerimaan Barang Dari Pihak III
    public function get_report_rekap_penerimaan_pihak_ketiga($param)
    {
		...
		foreach ($param['Satker_ID'] as $Satker_ID => $value)
		{
			$query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' $tanggal_awal $tanggal_akhir left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
    ...
    public function show_status_download()
    {
        ...
        <div style="border-style:solid; width:40%; margin:20px auto; border-width:1px; box-shadow:5px 5px 5px #ccd" align="center">
            <table border="0">
                ...
                <tr>
                    <td align="center" height="50px"><input type="button" value="Kembali ke halaman sebelumnya" onclick="window.location.href ='<?php echo $this->url_rewrite?>';"></td>
                </tr>
