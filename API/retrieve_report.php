...
class RETRIEVE_REPORT extends DB {
     ...
     public function daftar_barang_berdasarkan_sk_penghapusan($no_sk) {
          $query = "select  A.kodeLokasi,A.kodeSatker,A.kodeKelompok,A.Tahun,A.AkumulasiPenyusutan,A.Kondisi,A.NilaiPerolehan,A.Info,A.noRegister  from penghapusanaset PA left join penghapusan P on 
      ...
      public function daftar_barang_berdasarkan_usulan_penghapusan($no_usulan) {
          $query = "select  A.kodeLokasi,A.kodeSatker,A.kodeKelompok,A.Tahun,A.AkumulasiPenyusutan,A.Kondisi,A.NilaiPerolehan,A.Info,A.noRegister  from usulanaset US left join usulan U on 
