	 ...
	 public function delete_update_daftar_validasi_penghapusan($data,$debug=false)
    {
	 ...
	 public function store_usulan_penghapusan_pms($data,$debug=false){	
				...
				$aset=implode(',',$nmaset);
				 ...
				 $sql = array(
							'table'=>'Usulan',
							'field'=>'Aset_ID, Jenis_Usulan, UserNm, TglUpdate, GUID, FixUsulan',
                ...
                for($i=0;$i<$panjang;$i++){
					...
					$sql1 = array(
						'table'=>'UsulanAset',
						'field'=>"Usulan_ID,Aset_ID,Jenis_Usulan,StatusPenetapan",
             ...
             // exit;
                ...
                $res = $this->db->lazyQuery($sql,$debug,1);
                    ...
                    for($i=0;$i<$panjang;$i++){
                        ...
                        $sql1 = array(
                            'table'=>'UsulanAset',
                            'field'=>"Usulan_ID,Aset_ID,Jenis_Usulan,StatusPenetapan,NilaiPerolehanTmp,kondisiTmp",
