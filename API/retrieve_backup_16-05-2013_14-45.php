...
$offset = @$_POST['record'];
		...
		if($rtb_lokasi!="")
	{
		...
		$query = "SELECT * FROM Perencanaan ".$_SESSION['ses_retrieve_filter_'.$parameter['menuID'].'_'.$SessionUser->UserSes['ses_uid']]." StatusPemeliharaan = 1 AND StatusValidasi= 12 limit $parameter[paging], 10";
        //print_r($query);
	...
	{
		$query = "SELECT * FROM Perencanaan WHERE StatusPemeliharaan = 1 AND StatusValidasi= 11 limit $parameter[paging], 10";
        //print_r($query);
	...
	{
		$query = "SELECT * FROM Perencanaan WHERE StatusPemeliharaan is not null AND StatusValidasi= 10 limit $parameter[paging], 10";
        //print_r($query);
		...
		if($rtb_lokasi!="")
	{
		...
		$query = "SELECT * FROM Perencanaan ".$_SESSION['ses_retrieve_filter_'.$parameter['menuID'].'_'.$SessionUser->UserSes['ses_uid']]." StatusPemeliharaan IS NOT NULL AND StatusValidasi= 11 or StatusValidasi= 12 limit $parameter[paging], 10";
        //print_r($query);
	...
	public function retrieve_distribusi_barang_tambah_data($parameter)
    {
		...
		*/
		$data['kd_namaaset'] = $parameter['param']['gdg_add_ddb_na'];
		$data['kd_nokontrak'] = $parameter['param']['gdg_add_ddb_nk'];
		$data['satker'] = $parameter['param']['skpd_id'];
		$data['paging'] = $_GET['pid'];
		$data['sql_where'] = TRUE;
		$data['sql'] = "StatusValidasi = 1 AND (OrigSatker_ID is not NULL OR OrigSatker_ID!='0')
...
$offset = @$_POST['record'];
		...
		if($tujuan!="")
	{
		...
		if($_SESSION['ses_retrieve_filter_'.$parameter['menuID'].'_'.$this->UserSes['ses_uid']]=="")
		{
		 $query="SELECT DISTINCT t.NoDokumen FROM Transfer AS t, Aset AS a WHERE a.Aset_ID=t.Aset_ID AND a.OrigSatker_ID!=0
                    AND a.OriginDbSatker!=0 $query_satker_fix";
		} else
		{
		$query = "  SELECT DISTINCT t.NoDokumen FROM Transfer AS t, Aset AS a WHERE ".$_SESSION['ses_retrieve_filter_'.$parameter['menuID'].'_'.$this->UserSes['ses_uid']]." AND a.Aset_ID=t.Aset_ID
                        AND a.OrigSatker_ID!=0 AND a.OriginDbSatker!=0 $query_satker_fix";
		}
        //echo $query;
		...
		if($tujuan!="")
	{
        ...
        //print_r($query);
        $queryfix="SELECT DISTINCT(a.Aset_ID) ".$query;
        //pr($queryfix);
...
/* Menu Penilaian - Syafrizal AS*/
  ...
  public function  retrieve_penetapan_pemindahtanganan_eksekusi()
    ...
    public function retrieve_daftar_penetapan_pemindahtanganan($parameter)
    {
		...
		$query="SELECT BASP_ID FROM BASP ".$_SESSION['parameter_sql']." $sql_param ORDER BY BASP_ID ASC LIMIT $parameter[paging], 10";
		// pr($query);
		$result = $this->query($query) or die($this->error());
		$rows = $this->num_rows($result);
		$data = '';
    ...
    public function retrieve_usulan_penghapusan($parameter)
    {
			...
			$data['sql'] = "StatusValidasi = 1 AND (OrigSatker_ID is not NULL OR OrigSatker_ID!='0')
					AND (OriginDBSatker is not NULL OR OriginDBSatker!='0') AND
					(LastSatker_ID is not NULL OR LastSatker_ID!='0') AND Status_Validasi_Barang=1 AND NotUse=0 AND Dihapus=0";
...
$offset = @$_POST['record'];
        ...
        echo '</pre>';
			...
			$uid=$_SESSION['ses_uoperatorid'];
					 foreach ($dataArray as $Aset_ID)
                    {
                        ...
                        $query1 = "SELECT Aset_ID FROM Aset
                                            WHERE Aset_ID = $Aset_ID->Aset_ID AND UserNm=$uid
                                            ";
                        //print_r($query1);
                        //$queryKontrak = "SELECT a.NoKontrak, b.Aset_ID FROM Kontrak AS a INNER JOIN KontrakAset As b ON a.Kontrak_ID = b.Kontrak_ID
                          //              WHERE b.Aset_ID = $Aset_ID->Aset_ID";
			   $result1 = $this->query($query1) or die($this->error());
                        ...
                        while ($data1 = $this->fetch_object($result1))
                        {
                            $dataArr1[] = $data1->Aset_ID;
	                        }
                    }
	...
	//print_r($asetList);
        ...
        // nilai kembalian dalam bentuk array
        $parameter_sql_report_fix=$_SESSION['ses_report_filter_'.$parameter['menuID'].'_'.$this->UserSes['ses_uid']];
        return array('dataArr'=>$dataArr, 'asetList'=>$asetList, 'parameter'=>$parameter_sql_report_fix, 'asetuser'=>$dataArr1);
    }
        ...
        echo '</pre>';
                ...
                if ($dataArray !='')
                {
                    foreach ($dataArray as $Penghapusan_ID)
                    {
                        ...
                        $query = "SELECT p.Penghapusan_ID,p.NoSKHapus,p.TglHapus,p.AlasanHapus,p.Status,p.UserNm,p.FixPenghapusan
						,a.Aset_ID 
                                        FROM Penghapusan as p, PenghapusanAset as a
                                        WHERE  p.Penghapusan_ID = $Penghapusan_ID->Penghapusan_ID AND p.Penghapusan_ID=a.Penghapusan_ID
                                        ORDER BY p.Penghapusan_ID asc  ";
                        //print_r($query);
                        //$queryKontrak = "SELECT a.NoKontrak, b.Aset_ID FROM Kontrak AS a INNER JOIN KontrakAset As b ON a.Kontrak_ID = b.Kontrak_ID
                          //              WHERE b.Aset_ID = $Aset_ID->Aset_ID";
			...
			foreach ($dataArray as $Penghapusan_ID)
                    {
                        ...
                        $query1 = "SELECT Penghapusan_ID 
                                        FROM Penghapusan
                                        WHERE  Penghapusan_ID = $Penghapusan_ID->Penghapusan_ID AND UserNm='$uid'
                                        ORDER BY Penghapusan_ID asc  ";
                        //print_r($query);
                        //$queryKontrak = "SELECT a.NoKontrak, b.Aset_ID FROM Kontrak AS a INNER JOIN KontrakAset As b ON a.Kontrak_ID = b.Kontrak_ID
                          //              WHERE b.Aset_ID = $Aset_ID->Aset_ID";
			...
			foreach ($dataArr1 as $value)
                    {
                        ...
                        $query2 = "SELECT Aset_ID
                                        FROM PenghapusanAset
                                        WHERE  Penghapusan_ID = '$value'
                                        ";
                        //print_r($query2);
                        //$queryKontrak = "SELECT a.NoKontrak, b.Aset_ID FROM Kontrak AS a INNER JOIN KontrakAset As b ON a.Kontrak_ID = b.Kontrak_ID
                          //              WHERE b.Aset_ID = $Aset_ID->Aset_ID";
  ...
  public function retrieve_usulan_pemusnahan_filter($parameter)
    {
			...
			$data['sql'] = "StatusValidasi = 1 AND (OrigSatker_ID is not NULL OR OrigSatker_ID!='0')
					AND (OriginDBSatker is not NULL OR OriginDBSatker!='0') AND
					(LastSatker_ID is not NULL OR LastSatker_ID!='0') AND Status_Validasi_Barang=1
					AND Usulan_Pemusnahan_ID is NULL";
...
$offset = @$_POST['record'];
    ...
    */
     ...
     public function retrieve_validasi_pemusnahan($parameter)
    {
		...
		$parameter_sql="WHERE ".$parameter_sql." AND ";
            ...
            //echo "$parameter_sql";
                ...
                //print_r($_SESSION);
                $query="SELECT DISTINCT(BAPemusnahan_ID) FROM BAPemusnahan ".$_SESSION['ses_retrieve_filter_'.$parameter['menuID'].'_'.$this->UserSes['ses_uid']]." $sql_param ORDER BY BAPemusnahan_ID ASC LIMIT $parameter[paging], 10";
            ...
            echo '</pre>';
                ...
                if ($dataArray !='')
                {
                    foreach ($dataArray as $Aset_ID)
                    {
                        ...
                        $query = "SELECT a.LastSatker_ID, a.NamaAset, a.Aset_ID, a.NomorReg, 
                                             e.NamaSatker, e.KodeSatker, f.NamaLokasi, g.Kode,k.NoKontrak 
                                            FROM Aset AS a 
                                            INNER JOIN Lokasi AS f  ON a.Lokasi_ID=f.Lokasi_ID
                                            INNER JOIN Satker AS e ON a.LastSatker_ID=e.Satker_ID
                                            INNER JOIN Kelompok AS g ON a.Kelompok_ID=g.Kelompok_ID
    ...
    {
        $query = "SELECT DISTINCT(aset_list) FROM apl_userasetlist WHERE aset_action = 'Penggunaan' AND UserSes = '$parameter[ses_uid]'";
        //print_r($query);
        $result = $this->query($query) or die ($this->error());
    ...
    public function retrieve_validasi_penggunaan($parameter)
    {
        ...
        echo '</pre>';
                ...
                //print_r($_SESSION);
                $query="SELECT DISTINCT(Penggunaan_ID) FROM Penggunaan ".$_SESSION['ses_retrieve_filter_'.$parameter['menuID'].'_'.$this->UserSes['ses_uid']]." $sql_param ORDER BY Penggunaan_ID ASC LIMIT $parameter[paging], 10";
    ...
    public function retrieve_daftar_validasi_penggunaan($parameter)
    {
        ...
        echo '</pre>';
                ...
                //print_r($_SESSION);
                $query="SELECT DISTINCT(Penggunaan_ID) FROM Penggunaan WHERE $sql_param ORDER BY Penggunaan_ID ASC LIMIT $parameter[paging], 10";
