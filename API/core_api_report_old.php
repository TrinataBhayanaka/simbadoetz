...
class core_api_report extends DB {
	 ...
	 var $kir;
	 var $buku_inventaris;
	 var $rekapitulasi_buku_inventaris;
	 var $buku_induk_inventaris;
	 var $rekapitulasi_buku_induk_inventaris;
	 var $pengadaan_bmd;
	 var $rekapitulasi_pengadaan_bmd;
	 var $pemeliharaan_bmd;
	 var $rekapitulasi_pemeliharaan_bmd;
	 var $barang_dari_pihak3;
	 var $rekapitulasi_barang_dari_pihak3;
	 var $label;
	 var $kartu1;
	 var $kartu_ph;
	 var $persediaan1;
	 ...
	 var $buku1;
	 var $buku_ph;
	 var $laporan_pemeriksaan;
	 var $laporan_mutasi_barang;
	 var $daftar_mutasi_barang_skpd;
	 var $rekapitulasi_lmb_daerah;
	 var $rekapitulasi_dmb_daerah;
	 var $laporan_inventarisasi;
	 var $daftar_pemanfaatan;
	 var $daftar_penghapusan;
	 var $daftar_pemindahtanganan;
	 var $daftar_pemusnahan;
	 var $aset_id;
	 var $nama_aset;
	 var $no_kontrak;
	 var $lokasi;
     ...
     protected $KODE_KABUPATEN="11";
	 protected $KODE_PROVINSI="01";
	 protected $NAMA_KABUPATEN="Bireun";
	 protected $NAMA_PROVINSI="Propinsi Nanggroe Aceh Darussalam";
	 protected $ASALUSUL="Pengadaan";
     ...
     public function set_data($data){
          ...
          /*$this->nama_satker=$hasil_data['nama_satker'];
          $this->aset_id=$hasil_data['aset_id'];
          $this->nama_aset=$hasil_data['nama_aset'];
          $this->no_kontrak=$hasil_data['no_kontrak'];
          $this->lokasi=$hasil_data['lokasi'];
          $this->ngo=$hasil_data['ngo'];
          $this->kir=$hasil_data['kir'];
		  $this->paramater_sql=$hasil_data['paramater_sql'];
		  $this->paramater_sql=$hasil_data['kir'];
		  $this->paramater_sql=$hasil_data['buku_inventaris'];
		  $this->paramater_sql=$hasil_data['rekapitulasi_buku_inventaris'];
		  $this->paramater_sql=$hasil_data['buku_induk_inventaris'];
		  $this->paramater_sql=$hasil_data['rekapitulasi_buku_induk_inventaris'];
		  $this->paramater_sql=$hasil_data['pengadaan_bmd'];
		  $this->paramater_sql=$hasil_data['rekapitulasi_pengadaan_bmd'];
		  $this->paramater_sql=$hasil_data['pemeliharaan_bmd'];
		  $this->paramater_sql=$hasil_data['rekapitulasi_pemeliharaan_bmd'];
		  $this->paramater_sql=$hasil_data['barang_dari_pihak3'];
		  $this->paramater_sql=$hasil_data['rekapitulasi_barang_dari_pihak3'];
		  $this->paramater_sql=$hasil_data['label'];
		  $this->paramater_sql=$hasil_data['kartu1'];
		  $this->paramater_sql=$hasil_data['kartu_ph'];
		  $this->paramater_sql=$hasil_data['persediaan1'];
		  $this->paramater_sql=$hasil_data['persediaan_ph'];
		  $this->paramater_sql=$hasil_data['penerimaan1'];
		  $this->paramater_sql=$hasil_data['penerimaan_ph'];
		  $this->paramater_sql=$hasil_data['pengeluaran1'];
		  $this->paramater_sql=$hasil_data['pengeluaran_ph'];
		  $this->paramater_sql=$hasil_data['buku1'];
		  $this->paramater_sql=$hasil_data['buku_ph'];
		  $this->paramater_sql=$hasil_data['laporan_pemeriksaan'];
		  $this->paramater_sql=$hasil_data['laporan_mutasi_barang'];
		  $this->paramater_sql=$hasil_data['daftar_mutasi_barang_skpd'];
		  $this->paramater_sql=$hasil_data['rekapitulasi_lmb_daerah'];
		  $this->paramater_sql=$hasil_data['rekapitulasi_dmb_daerah'];
		  $this->paramater_sql=$hasil_data['laporan_inventarisasi'];
		  $this->paramater_sql=$hasil_data['daftar_pemanfaatan'];
		  $this->paramater_sql=$hasil_data['daftar_penghapusan'];
		  $this->paramater_sql=$hasil_data['daftar_pemindahtanganan'];
		  $this->paramater_sql=$hasil_data['daftar_pemusnahan'];*/
     ...
     public function list_query(){
          ...
          $lokasi=$this->lokasi;
          $ngo=$this->ngo;
		  $buku_inventaris=$this->buku_inventaris;
		  $rekapitulasi_buku_inventaris=$this->rekapitulasi_buku_inventaris;
		  $buku_induk_inventaris=$this->buku_induk_inventaris;
		  $rekapitulasi_buku_induk_inventaris=$this->rekapitulasi_buku_induk_inventaris;
		  $pengadaan_bmd=$this->pengadaan_bmd;
		  $rekapitulasi_pengadaan_bmd=$this->rekapitulasi_pengadaan_bmd;
		  $pemeliharaan_bmd=$this->pemeliharaan_bmd;
		  $rekapitulasi_pemeliharaan_bmd=$this->rekapitulasi_pemeliharaan_bmd;
		  $barang_dari_pihak3=$this->barang_dari_pihak3;
		  $rekapitulasi_barang_dari_pihak3=$this->rekapitulasi_barang_dari_pihak3;
		  $label=$this->label;
		  $kartu1=$this->kartu1;
		  $kartu_ph=$this->kartu_ph;
		  $persediaan1=$this->persediaan1;
		  $persediaan_ph=$this->persediaan_ph;
		  $penerimaan1=$tgis->penerimaan1;
		  $penerimaan_ph=$this->penerimaan_ph;
		  $pengeluaran1=$this->pengeluaran1;
		  $pengeluaran_ph=$this->pengeluaran_ph;
		  $buku1=$this->buku1;
		  $buku_ph=$this->buku_ph;
		  $laporan_pemeriksaan=$this->laporan_pemeriksaan;
		  $laporan_mutasi_barang=$this->laporan_mutasi_barang;
		  $daftar_mutasi_barang_skpd=$this->daftar_mutasi_barang_skpd;
		  $rekapitulasi_lmb_daerah=$this->rekapitulasi_lmb_daerah;
		  $rekapitulasi_dmb_daerah=$this->rekapitulasi_dmb_daerah;
		  $laporan_inventarisasi=$this->laporan_inventarisasi;
		  $daftar_pemanfaatan=$this->daftar_pemanfaatan;
		  $daftar_penghapusan=$this->daftar_penghapusan;
		  $daftar_pemindahtanganan=$this->daftar_pemindahtanganan;
		  $daftar_pemusnahan=$this->daftar_pemusnahan;*/
		...
		//==============================================================	
         ...
         if($tgl_update!=""){
			...
			if($skpd_id!=""){
                ...
                $query_change_satker="SELECT KodeSektor, KodeSatker, NamaSatker FROM Satker as S 
                                                    WHERE $query_satker";
                ...
                while($proses_kode=mysql_fetch_array($exec_query_change_satker)){
                    ...
                    $query_return_kode="SELECT Satker_ID FROM Satker as S WHERE NGO=0 AND (KodeSatker LIKE '".$proses_kode['KodeSektor']."%' OR KodeSatker='$proses_kode[KodeSatker]')";
                    }
                    if($proses_kode['KodeSektor']!="" && $proses_kode['KodeSatker']==""){
                        $query_return_kode="SELECT Satker_ID FROM Satker as S WHERE NGO=0 AND (KodeSatker LIKE '".$proses_kode['KodeSektor']."%')";
                    }
                    //ini dari ka andreas
         ...
         $Modul_1_Mode_1_Case_a_condition = "select A.Aset_ID, A.Lokasi_ID,A.LastSatker_ID,  A.NomorReg, A.NamaAset,A.NilaiPerolehan, A.Alamat, A.Info, A.TglPerolehan,A.Tahun,A.AsalUsul, 
									...
									left outer join Satker C on C.KodeSektor=S.KodeSektor and C.KodeSatker=S.KodeSatker and C.KodeUnit is null
									left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
									where A.TipeAset = 'A' AND $parameter_sql
          ...
          $Modul_1_Mode_1_Case_b_condition = "select A.Aset_ID,A.LastSatker_ID,A.Lokasi_ID,A.NomorReg,A.NamaAset,A.NilaiPerolehan,A.Info,A.Tahun,A.AsalUsul, 
											...
											left outer join Satker C on C.KodeSektor=S.KodeSektor and C.KodeSatker=S.KodeSatker and C.KodeUnit is null
											left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
											where A.TipeAset='B' AND $parameter_sql order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
          ...
          $Modul_1_Mode_1_Case_b_default = "select A.Aset_ID,A.LastSatker_ID,A.Lokasi_ID,A.NomorReg,A.NamaAset,A.NilaiPerolehan,A.Info,A.Tahun,A.AsalUsul, 
											...
											left outer join Satker C on C.KodeSektor=S.KodeSektor and C.KodeSatker=S.KodeSatker and C.KodeUnit is null
											left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
											where A.TipeAset='B' order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
          ...
          $Modul_1_Mode_1_Case_c_condition = "select A.Aset_ID, A.LastSatker_ID,A.Lokasi_ID,A.NomorReg, A.NamaAset,A.NilaiPerolehan, A.Info, A.Tahun,A.AsalUsul, A.Alamat, 
                                            ...
                                            where  A.TipeAset='C'AND $parameter_sql order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
          ...
          $Modul_1_Mode_1_Case_c_default = "select A.Aset_ID, A.LastSatker_ID,A.Lokasi_ID,A.NomorReg, A.NamaAset,A.NilaiPerolehan, A.Info, A.Tahun,A.AsalUsul, A.Alamat, 
                                            ...
                                            left outer join Tanah T on A.Aset_ID=T.Aset_ID
                                            left outer join Tanah Z on B.Aset_ID=Z.Aset_ID
                                            where  A.TipeAset='C'order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
          ...
          $Modul_1_Mode_1_Case_d_condition = "select A.Aset_ID, A.LastSatker_ID,A.Lokasi_ID, A.NamaAset,A.NomorReg,A.AsalUsul,A.NilaiPerolehan, A.Info,A.Alamat, 
                                            ...
                                            T.LuasTotal
                                            from  Aset as A  
                                            left outer join Jaringan J on A.Aset_ID=J.Aset_ID
                                            left outer join Satker S on A.LastSatker_ID=S.Satker_ID
                                            left outer join Satker C on C.KodeSektor=S.KodeSektor and C.KodeSatker=S.KodeSatker and C.KodeUnit is null
											left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID
                                            left outer join Tanah T on A.Aset_ID=T.Aset_ID 
                                            where A.TipeAset='D' AND $parameter_sql order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
          ...
          $Modul_1_Mode_1_Case_e_condition = "select A.Aset_ID, A.LastSatker_ID,A.Lokasi_ID, A.NamaAset, A.AsalUsul, A.NilaiPerolehan, A.Info,A.NomorReg,A.TglPerolehan,A.Kuantitas,   
                                              AL.Judul, AL.Spesifikasi, AL.AsalDaerah, AL.Pengarang, AL.Material, AL.Ukuran, AL.TahunTerbit, 
                                              S.KodeSatker,  S.Satker_ID, S.KodeUnit,S.NamaSatker,
                                              K.Kode, K.Uraian, K.Satuan 
                                              from  Aset A
                                              left outer join AsetLain AL on A.Aset_ID=AL.Aset_ID
                                              left outer join Satker S on A.LastSatker_ID=S.Satker_ID
                                              left outer join Satker C on C.KodeSektor=S.KodeSektor and C.KodeSatker=S.KodeSatker and C.KodeUnit is null

                                              left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID
                                              where A.TipeAset='E' AND $parameter_sql 
                                             ORDER BY S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";

          $Modul_1_Mode_1_Case_e_default = "select A.Aset_ID, A.LastSatker_ID,A.Lokasi_ID, A.NamaAset, A.AsalUsul, A.NilaiPerolehan, A.Info,A.NomorReg,A.TglPerolehan,A.Kuantitas,   
                                              AL.Judul, AL.Spesifikasi, AL.AsalDaerah, AL.Pengarang, AL.Material, AL.Ukuran, AL.TahunTerbit, 
                                              S.KodeSatker,  S.Satker_ID, S.KodeUnit,S.NamaSatker,
                                              K.Kode, K.Uraian, K.Satuan 
                                              from  Aset A
          ...
          $Modul_1_Mode_1_Case_f_condition = "select A.Aset_ID,A.LastSatker_ID,A.Lokasi_ID,A.NamaAset,A.Alamat,A.SumberDana,A.NilaiPerolehan,A.Info,
                                              ...
                                              KTR.NilaiKontrak 
                                              from Aset A
                                              left outer join KDP KDPA on A.Aset_ID=KDPA.Aset_ID
                                              left outer join Satker S on A.LastSatker_ID=S.Satker_ID 
                                              left outer join Satker C on C.KodeSektor=S.KodeSektor and C.KodeSatker=S.KodeSatker and C.KodeUnit is null

                                              left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
                                              left outer join KontrakAset KTRA on A.Aset_ID=KTRA.Aset_ID
                                              left outer join Kontrak KTR on KTR.Kontrak_ID=KTRA.Kontrak_ID 
                                              where A.TipeAset = 'F' AND $parameter_sql 
                                              ORDER BY S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";

          $Modul_1_Mode_1_Case_f_default = "select A.Aset_ID,A.LastSatker_ID,A.Lokasi_ID,A.NamaAset,A.Alamat,A.SumberDana,A.NilaiPerolehan,A.Info,
                                              KDPA.Konstruksi, KDPA.JumlahLantai, KDPA.Beton, KDPA.LuasLantai, KDPA.NoSertifikat, KDPA.TglSertifikat,
                                              S.KodeSatker,S.Satker_ID,S.KodeUnit,S.NamaSatker,
                                              K.Kode,K.Uraian,K.Satuan,
                                              KTRA.Kontrak_ID,
		  ...
		  $query_kir_condition = "	select A.Aset_ID,A.LastSatker_ID, A.Ruangan, A.NamaAset, M.Merk, M.NoSeri, M.Ukuran, M.Material, M.TahunBuat, A.Kuantitas, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, A.NilaiPerolehan, A.Info, A.Ruangan,
									S.KodeSatker, S.Satker_ID, S.KodeUnit, S.NamaSatker,
									K.Kode, K.Uraian, K.Satuan
									from Aset A
									left outer join Mesin M on A.Aset_ID=M.Aset_ID
									...
									left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
									left outer join Kondisi KDS on A.Aset_ID=KDS.Aset_ID
									where 1=1 AND $parameter_sql
									order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";



		 $query_kir_default = " 	select A.Aset_ID,A.LastSatker_ID, A.Ruangan, A.NamaAset, M.Merk, M.NoSeri, M.Ukuran, M.Material, M.TahunBuat, A.Kuantitas, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, A.NilaiPerolehan, A.Info, A.Ruangan,
									S.KodeSatker, S.Satker_ID, S.KodeUnit, S.NamaSatker,
									K.Kode, K.Uraian, K.Satuan
									from Aset A
									left outer join Mesin M on A.Aset_ID=M.Aset_ID
		  ...
		  //Buku Inventaris
          $query_buku_inventaris_condition =  "select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.NilaiPerolehan, 
									...
									left join Satker S on A.LastSatker_ID=S.Satker_ID 
									left join Mesin M on A.Aset_ID=M.Aset_ID 
									left outer join Bangunan B on A.Aset_ID=B.Aset_ID 
									left outer join Kondisi KDS on KDS.Kondisi_ID=A.LastKondisi_ID 
									left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
									where 1=1 AND $parameter_sql order by A.LastSatker_ID, K.Kode $limit";

          $query_buku_inventaris_default = "select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.NilaiPerolehan, 
											A.Alamat, A.Kuantitas, A.TipeAset, A.Tahun, S.KodeSatker, S.NamaSatker, S.Satker_ID, S.KodeUnit,
											K.Kode, K.Uraian, K.Satuan, B.Konstruksi, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, M.Merk, M.Model, 
											M.NoRangka, M.NoMesin, M.NoBPKB, M.Material from Aset A 
											left join Satker S on A.LastSatker_ID=S.Satker_ID 
											...
											left outer join Kondisi KDS on KDS.Kondisi_ID=A.LastKondisi_ID 
											left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
											where 1=1 order by A.LastSatker_ID, K.Kode $limit";
          ...
          $query_pengadaan_bmd_condition = "select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.Kuantitas, A.TglPerolehan, 
											...
											D.Kode, D.Uraian, D.Satuan,  K.NoKontrak, S.TglSP2D, S.NoSP2D from Aset A 
											...
											left outer join SP2D S on SP.SP2D_ID= S.SP2D_ID where A.SumberAset = 'sp2d' and
											$parameter_sql
          ...
          $query_pengadaan_bmd_default =   "select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.Kuantitas, A.TglPerolehan,
			...
			$query_pemeliharaan_bmd_condition=	"select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.NilaiPerolehan, A.Alamat, A.Info, 
												...
												left join Satker CC on A.LastSatker_ID=CC.Satker_ID 
												left outer join Kelompok D on A.Kelompok_ID=D.Kelompok_ID 
												where 1 = 1 and $parameter_sql order by A.LastSatker_ID, D.Kode, PML.TglPemeliharaan $limit";
			...
			$query_pemeliharaan_bmd_default=		"select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.NilaiPerolehan, A.Alamat, A.Info, 
												...
												left join Satker CC on A.LastSatker_ID=CC.Satker_ID 
												left outer join Kelompok D on A.Kelompok_ID=D.Kelompok_ID 
												where 1 = 1 order by A.LastSatker_ID, D.Kode, PML.TglPemeliharaan $limit";
		
		
		//Penerimaan Barang dari Pihak Ketiga
		 $query_penerimaan_barang_pihak_ketiga_condition = "select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.NilaiPerolehan, A.Alamat, A.LastSatker_ID, O.NamaSatker as NamaDonor, A.Kuantitas,A.Tahun, S.KodeSatker, S.NamaSatker, S.KodeUnit, K.Kode, K.Uraian, K.Satuan, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, M.Merk, M.Model, M.NoRangka, M.NoMesin, M.NoBPKB, M.Material from Aset A 
														left join Mesin M on A.Aset_ID=M.Aset_ID 
														left outer join Satker O on A.OrigSatker_ID=O.Satker_ID 
														left outer join Satker S on A.LastSatker_ID=S.Satker_ID 
														left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
														left outer join Kondisi KDS on KDS.Kondisi_ID=A.LastKondisi_ID 
														where A.SumberAset = 'hibah' AND $parameter_sql order by A.LastSatker_ID $limit";									
         
         $query_penerimaan_barang_pihak_ketiga_default = "select A.LastSatker_ID, A.NomorReg, A.NamaAset, A.Pemilik, A.SumberAset, A.NilaiPerolehan, A.Alamat, A.LastSatker_ID, O.NamaSatker as NamaDonor, A.Kuantitas,A.Tahun, S.KodeSatker, S.NamaSatker, S.KodeUnit, K.Kode, K.Uraian, K.Satuan, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, M.Merk, M.Model, M.NoRangka, M.NoMesin, M.NoBPKB, M.Material from Aset A 
														left join Mesin M on A.Aset_ID=M.Aset_ID 
														left outer join Satker O on A.OrigSatker_ID=O.Satker_ID 
														left outer join Satker S on A.LastSatker_ID=S.Satker_ID 
														left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID 
														left outer join Kondisi KDS on KDS.Kondisi_ID=A.LastKondisi_ID 
														where A.SumberAset = 'hibah' order by A.LastSatker_ID $limit";	 
         ...
         $query_kartu_barang_inventaris_condition ="select A.Aset_ID, A.LastSatker_ID, A.TglPerolehan, TR.TglTransfer, A. Kuantitas, TR.InfoTransfer, A.NamaAset, A.Satuan, A.TipeAset, STD.Spesifikasi,
													...
													where K.Golongan='01' or K.Golongan='02' or K.Golongan='03' or K.Golongan='04' or K.Golongan='05' or K.Golongan='06' or K.Golongan='07'
         ...
         $query_buku_persediaan_barang_pakai_habis_condition ="select A.Aset_ID, A.LastSatker_ID, TR.TglTransfer, PNR.TglPenerimaan, PNR.NoBAPenerimaan, A.Kuantitas, A.NilaiPerolehan, TR.InfoTransfer, A.NamaAset, A.Satuan, A.Tahun, A.TipeAset, STD.Spesifikasi, A.TglPerolehan,
																...
																left outer join Transfer TR on A.Aset_ID=TR.Aset_ID
																left outer join StandarHarga STD on STD.Kelompok_ID=K.Kelompok_ID
																where K.Golongan='07' AND $parameter_sql 
																order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
		 ...
		 $query_buku_penerimaan_barang_inventaris_condition =  "select A.Aset_ID, A.LastSatker_ID, A.TglPerolehan, TR.TglTransfer, PNR.NamaPenyedia, PNR.TglPenerimaan, PNR.NoBAPenerimaan, A.NamaAset, A.Kuantitas, A.NilaiPerolehan, TR.InfoTransfer, A.TipeAset,
																...
																left outer join Kelompok K on A.Kelompok_ID=K.Kelompok_ID
																left outer join Transfer TR on A.Aset_ID=TR.Aset_ID
																where K.Golongan='01' or K.Golongan='02' or K.Golongan='03' or K.Golongan='04' or K.Golongan='05' or K.Golongan='06' or K.Golongan='07' AND $parameter_sql
																order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
		...
		$query_buku_barang_inventaris_condition = "	select A.Aset_ID, A.LastSatker_ID, PNR.TglPenerimaan, A.NamaAset, STD.Merk, A.Tahun, A.Kuantitas, KTR.NoKontrak, PNR.TglPemeriksaan, PNR.NoBAPemeriksaan, TR.TglTransfer, PNR.KeteranganPenerimaan, TR.Nama_Penyimpan,
													...
													where TR.FromSatker_ID or TR.ToSatker_ID and K.Golongan='01' or K.Golongan='02' or K.Golongan='03' or K.Golongan='04' or K.Golongan='05' or K.Golongan='06' or K.Golongan='07' AND $parameter_sql
													order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
		 ...
		 $query_buku_barang_inventaris_default = " 	select A.Aset_ID, A.LastSatker_ID, PNR.TglPenerimaan, A.NamaAset, STD.Merk, A.Tahun, A.Kuantitas, KTR.NoKontrak, PNR.TglPemeriksaan, PNR.NoBAPemeriksaan, TR.TglTransfer, PNR.KeteranganPenerimaan, TR.Nama_Penyimpan,
													...
													left outer join StandarHarga STD on STD.Kelompok_ID=K.Kelompok_ID
													left outer join Transfer TR on TR.Aset_ID=A.Aset_ID
													where TR.FromSatker_ID or TR.ToSatker_ID and K.Golongan='01' or K.Golongan='02' or K.Golongan='03' or K.Golongan='04' or K.Golongan='05' or K.Golongan='06' or K.Golongan='07'
													order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
		...
		$query_buku_barang_pakai_habis_condition = "	select A.Aset_ID, A.LastSatker_ID, PNR.TglPenerimaan, A.NamaAset, STD.Merk, A.Tahun, A.Kuantitas, KTR.NoKontrak, PNR.TglPemeriksaan, PNR.NoBAPemeriksaan, TR.TglTransfer, PNR.KeteranganPenerimaan, TR.Nama_Penyimpan,
														...
														left outer join StandarHarga STD on STD.Kelompok_ID=K.Kelompok_ID
														left outer join Transfer TR on TR.Aset_ID=A.Aset_ID
														where TR.FromSatker_ID or TR.ToSatker_ID and K.Golongan='07' AND $parameter_sql
														order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
		 ...
		 $query_buku_barang_pakai_habis_default = " 	select A.Aset_ID, A.LastSatker_ID, PNR.TglPenerimaan, A.NamaAset, STD.Merk, A.Tahun, A.Kuantitas, KTR.NoKontrak, PNR.TglPemeriksaan, PNR.NoBAPemeriksaan, TR.TglTransfer, PNR.KeteranganPenerimaan, TR.Nama_Penyimpan,
														...
														left outer join StandarHarga STD on STD.Kelompok_ID=K.Kelompok_ID
														left outer join Transfer TR on TR.Aset_ID=A.Aset_ID
														where TR.FromSatker_ID or TR.ToSatker_ID and K.Golongan='07'
														order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
         ...
         $query_laporan_pemeriksaan_barang_atau_gudang_condition = "select A.Aset_ID, A.LastSatker_ID, A.NamaAset, A.Kuantitas, A.Satuan, A.NilaiPerolehan, PMRG.NoBAPemeriksaanGudang, PMRG.AlasanPemeriksaanGudang, A.TipeAset, TR.TglTransfer, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, KDS.TidakDitemukan,
																	...
																	left outer join Kelompok K on A.Kelompok_ID = K.Kelompok_ID
																	left outer join Transfer TR on A.Aset_ID = TR.Aset_ID
																	where 1=1 AND $parameter_sql order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
         ...
         $query_laporan_pemeriksaan_barang_atau_gudang_default = "select A.Aset_ID, A.LastSatker_ID, A.NamaAset, A.Kuantitas, A.Satuan, A.NilaiPerolehan, PMRG.NoBAPemeriksaanGudang, PMRG.AlasanPemeriksaanGudang, A.TipeAset, TR.TglTransfer, KDS.Baik, KDS.RusakRingan, KDS.RusakBerat, KDS.TidakDitemukan,
																	...
																	left outer join Kelompok K on A.Kelompok_ID = K.Kelompok_ID
																	left outer join Transfer TR on A.Aset_ID = TR.Aset_ID
																	where 1=1 order by S.KodeSatker, S.KodeUnit, K.Kode, A.NomorReg $limit";
		
		
		//Standar Harga Barang
		$query_standarhargabarang_default=  "select STD.Spesifikasi,STD.NilaiStandar,STD.Keterangan,STD.TglUpdate,
		...
		$query_standarhargabarang_condition= 	"select STD.Spesifikasi,STD.NilaiStandar,STD.Keterangan,STD.TglUpdate,
												K.Kelompok_ID,K.Uraian from StandarHarga as STD 
												left outer join Kelompok as K on STD.Kelompok_ID=K.Kelompok_ID  
		...
		$query_rkbu_condition = 	"select PRC.NamaAset,PRC.Merk,PRC.Kuantitas,PRC.Lokasi_ID,PRC.KodeRekening,PRC.Tahun,PRC.KeteranganPerencanaan,
									...
									join StandarHarga STD on PRC.Kelompok_ID=STD.Kelompok_ID
									left outer join Lokasi L on PRC.Lokasi_ID=L.Lokasi_ID
									LEFT OUTER JOIN Aset A ON PRC.Satker_ID = A.LastSatker_ID
									where PRC.StatusPemeliharaan is not null 
									AND $parameter_sql $limit";
	   ...
	   $query_rtpb_condition = "select PRC.NamaAset,PRC.Merk,PRC.UraianPemeliharaan,PRC.Kuantitas,PRC.Lokasi_ID,PRC.KodeRekening,PRC.Tahun,PRC.KeteranganPerencanaan,
		...
		$query_cetaklabel_condition = 	"select A.NamaAset,A.NomorReg, S.KodeSatker, S.KodeUnit, S.NamaSatker,S.Satker_ID, K.kode
										...
										join Kelompok K on A.Kelompok_ID = K.Kelompok_ID
										join Satker S on S.Satker_ID = A.LastSatker_ID
										order by S.KodeSatker, S.KodeUnit, K.Kelompok_ID IN $parameter_sql $limit";
    ...
    public function _cek_data_satker_($tahun){
		...
		//echo 'ada'.$tahun;
        $query = "  select a.LastSatker_ID, b.NamaSatker from Aset as a left outer join Satker as b on a.LastSatker_ID = b.Satker_ID
    ...
    public function getLogo($NAMA_KABUPATEN)
    {
	/*
        if ($dataLogo !='')
	{
		switch ($dataLogo)
		{
			case 'bireun':
			{
				$path = "http://localhost/simbada_v8/report/images/bireun.gif";
			...
			case 'aceh':
			{
				$path = "http://localhost/simbada_v8/report/images/aceh.jpg";
        ...
        */
        $query = "SELECT app_admin_logo FROM tbl_app_config WHERE app_location_desc = '$NAMA_KABUPATEN'";    
        
        $result = $this->query($query) or die ($this->error());
        if ($this->num_rows($result))
        {
            $data = $this->fetch_object($result);
            $dataArr = $data->app_admin_logo;
            
            $path = "http://localhost/simbada_v8/page_admin/css/$dataArr";
    ...
    public function get_report_rekap_inv_daerah()
    {
        $query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
        $query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
        $query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
        $query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                    left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                    left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
    ...
    public function get_report_rekap_inv_skpd($parameter)
    {
        ...
        foreach ($parameter as $Satker_ID => $value)
        {
            ...
            $query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
            $query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode  ";
            $query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
            $query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian,count(a.Aset_ID)as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k 
                                        left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang 
                                        left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID = '$Satker_ID' where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
 ...
 //Rekapitulasi Pemeliharaan BMD
    public function get_report_rekap_pemeliharaan_BMD($parameter, $tanggal_awal, $tanggal_akhir)
    {
        //$Satker_ID = $parameter['Satker_ID'];
        //$Satker_ID = '11077, 10257';
		foreach ($parameter as $Satker_ID => $value)
		{
        $query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' and p.TglPemeliharaan >= '$tanggal_awal' and p.TglPemeliharaan <= '$tanggal_akhir' where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' and p.TglPemeliharaan >= '$tanggal_awal' and p.TglPemeliharaan <= '$tanggal_akhir' where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' and p.TglPemeliharaan >= '$tanggal_awal' and p.TglPemeliharaan <= '$tanggal_akhir' where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' and p.TglPemeliharaan >= '$tanggal_awal' and p.TglPemeliharaan <= '$tanggal_akhir' where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' and p.TglPemeliharaan >= '$tanggal_awal' and p.TglPemeliharaan <= '$tanggal_akhir' where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' and p.TglPemeliharaan >= '$tanggal_awal' and p.TglPemeliharaan <= '$tanggal_akhir' where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
        $query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, count(a.Aset_ID) as Jumlah, sum(p.Biaya) as Biaya from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join (Aset a join Pemeliharaan p on p.Aset_ID=a.Aset_ID) on a.Kelompok_ID = x.Kelompok_ID and a.LastSatker_ID='$Satker_ID' and p.TglPemeliharaan >= '$tanggal_awal' and p.TglPemeliharaan <= '$tanggal_akhir' where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
 ...
 //Rekapitulasi Penerimaan Barang Dari Pihak III
    public function get_report_rekap_penerimaan_pihak_ketiga($parameter, $tanggal_awal, $tanggal_akhir)
    {
        //print_r($parameter);
		...
		foreach ($parameter as $Satker_ID => $value)
		{
			//echo $Satker_ID;
			//$Satker_ID = '11077, 10257';
			$query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			$query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan, o.NamaSatker from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'hibah' and a.LastSatker_ID='$Satker_ID' left outer join Satker o on a.OrigSatker_ID=o.Satker_ID left outer join Satker cc on a.LastSatker_ID=cc.Satker_ID left outer join Satker c on c.KodeSektor=cc.KodeSektor and c.KodeSatker=cc.KodeSatker and c.KodeUnit is null left outer join Kelompok d on a.Kelompok_ID=d.Kelompok_ID left outer join Kondisi e on e.Kondisi_ID=a.LastKondisi_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode ";
			
			$dataGolongan = array('query_get_golongan_1', 'query_get_golongan_2', 'query_get_golongan_3', 'query_get_golongan_4', 'query_get_golongan_5', 'query_get_golongan_6', 'query_get_golongan_7');
			//print_r($$dataGolongan[0]);
			//echo '<br><br>';
        for ($i = 0; $i <=6; $i++)
        {
            $result_golongan = $this->query($$dataGolongan[$i]) or die ($this->error('error golongan'));
...
//Rekapitulasi Pengadaan BMD	
    public function get_report_rekap_pengadaan_BMD($parameter, $tanggal_awal, $tanggal_akhir)
    {
		...
		*/
		...
		foreach ($parameter as $Satker_ID => $value)
		{
			...
			//exit;
			//$Satker_ID = '11077, 10257';
			$query_get_golongan_1 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where  k.Golongan='01' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_2 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where  k.Golongan='02' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_3 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where  k.Golongan='03' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_4 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where  k.Golongan='04' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_5 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where  k.Golongan='05' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_6 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where  k.Golongan='06' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
			$query_get_golongan_7 = "   select k.Kode, k.Golongan, k.Bidang, k.Uraian, sum(a.Kuantitas) as Jumlah, sum(a.NilaiPerolehan) as NilaiPerolehan from Kelompok k left outer join Kelompok x on x.Golongan = k.Golongan and x.Bidang = k.Bidang left outer join Aset a on a.Kelompok_ID = x.Kelompok_ID and a.SumberAset = 'sp2d' and a.LastSatker_ID='$Satker_ID' left join Satker CC on a.LastSatker_ID=CC.Satker_ID left outer join KontrakAset KA on KA.Aset_ID= a.Aset_ID left outer join Kontrak KO on KO.Kontrak_ID= KA.Kontrak_ID left outer join KontrakSP2D KS on KS.Kontrak_ID= KO.Kontrak_ID left outer join SP2D S on S.SP2D_ID= KS.SP2D_ID and a.TglPerolehan >= '$tanggal_awal' and a.TglPerolehan <= '$tanggal_akhir' where  k.Golongan='07' and k.Kelompok is null and k.Sub is null and k.SubSub is null group by k.Kode, k.Golongan, k.Bidang, k.Uraian order by k.Kode";
    ...
    public function show_status_download()
    {
        ...
        <head>
                ...
                <title>Simbada Versi 7</title>
                <!-- include css file -->
                
                <link rel="stylesheet" href="http://localhost/simbada_v8/css/simbada.css" type="text/css" media="screen" />
                <link rel="stylesheet" href="http://localhost/simbada_v8/css/jquery-ui.css" type="text/css">
                <link rel="stylesheet" href="http://localhost/simbada_v8/css/example.css" TYPE="text/css" MEDIA="screen">
        ...
        <div style="border-style:solid; width:40%; margin:20px auto; border-width:1px; box-shadow:5px 5px 5px #ccd" align="center">
            <table border="0">
                ...
                <tr>
                    <td align="center" height="50px"><input type="button" value="Kembali ke halaman sebelumnya" onclick="history.back()"></td>
                </tr>
            </table>
