        ...
        case 'get_rekap_pengadaan':
            {
                ...
                $url = "http://localhost/simbada_versi_2.0/services/?param=$param&tgl_awal=$tgl_awal&tgl_akhir=$tgl_akhir";
                $XML = new DOMDocument();
        ...
        case 'store_std_harga_barang':
            {
                ...
                $url = "http://localhost/simbada_v8/services/?param=$param&kel=$kelompok&merk=$merk&tgl_update=$tgl_update&nilai=$nilai_standar&ket=$keterangan&spec=$spesifikasi"; 
            }
            break;
        case 'get_std_harga_barang':
            {
                $url = "http://localhost/simbada_v8/services/?param=$param";
...
?>
    ...
    <div align="center" style="border-style:solid; background: url('http://localhost/simbada_v8/css/img_temp/map.jpg') no-repeat; width: 700px; height: 300px; margin: 0px auto;">
    </div>
    ...
    <form method="POST" action="loader.php">
       ...
       <div style="width: 90%; margin-top:10px; display: ''" id="rekap">
        <table border="1" style="border-collapse:collapse; width: 100%">
            <tr>
                <td rowspan="5" align="center"><img src="http://localhost/simbada_v8/report/images/bireun.gif" width="200px" height="200px" ></td>
