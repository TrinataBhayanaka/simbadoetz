<?php /* Smarty version Smarty-3.1.15, created on 2015-12-02 16:21:24
...
report/template/PEROLEHAN/report_perolehanaset_cetak_non_aset.php?menuID=&mode=&tab=&skpd_id={{satker}}&tglawalperolehan={{tahunAwal}}&tglakhirperolehan={{tahunAkhir}}&tipe_file=3" target="_blank"><?php echo $_smarty_tpl->tpl_vars['baseApplication']->value;?>
report/template/PEROLEHAN/report_perolehanaset_cetak_non_aset.php?menuID=&mode=&tab=&skpd_id={{satker}}&tglawalperolehan={{tahunAwal}}&tglakhirperolehan={{tahunAkhir}}&tipe_file=3</a>
                </span>
              </div>
              <!-- /.box-footer -->
            </form>
