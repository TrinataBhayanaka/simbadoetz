					...
					switch ($_GET['p'])
					{
						...
						case 'h':
						{
							...
							echo "<table border='0' width='100%'>";
								...
								$queryGroup = " SELECT Hak_Akses FROM Operator WHERE OperatorID = '$_GET[a]'";
								...
								{  
									...
									$dataArr['user']['Hak_Akses'] = $dataGroup->Hak_Akses;
									
								}
							
								$accessMenu = explode(',',$dataArr['user']['Hak_Akses']);
								
								$queryDisable = " SELECT groupShowMenu FROM tbl_user_group WHERE groupID = ".$_GET['a'];
