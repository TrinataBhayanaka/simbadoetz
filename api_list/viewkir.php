...
$aColumns = array('Satker_ID','Tahun','Kd_Ruang','NamaSatker');
$test = count($aColumns);
...
while ($aRow = $DBVAR->fetch_array($rResult)) {
	...
	$edit ="<a style=\"display:display\" data-toggle=\"modal\" href=\"#editruang\" class=\"btn btn-warning btn-small\" id=\"editruangkir\" value=\"{$id}\" ><i class=\"fa fa-pencil\" align=\"center\"></i>&nbsp;&nbsp;Edit</a>";
	$delete="<a style=\"display:display\" data-toggle=\"modal\" href=\"#delruang\" class=\"btn btn-danger btn-circle\" id=\"delruangan\" value=\"{$Kd_Ruang}\" title=\"Hapus\"><i class=\"fa fa-trash simbol\">&nbsp;Hapus</i></a>";
