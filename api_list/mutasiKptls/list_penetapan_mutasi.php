                  ...
                  if($value['FixMutasi']==0){
                      ...
                      if($_SESSION['ses_ujabatan']==1){
                           $tindakan="<a href=\"{$url_rewrite}/module/mutasiKptls/dftr_review_edit_aset_penetapan.php?id={$value[Mutasi_ID]}\" class=\"btn btn-success btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i> View</a>&nbsp;
                            <a href=\"$url_rewrite/module/mutasiKptls/penetapan_daftar_hapus.php?id={$value[Mutasi_ID]}\" class=\"btn btn-danger btpenetapanl\" onclick=\"return confirm('Hapus Data');\" style=\"margin-top:3px\"> <i class=\"fa fa-trash\"></i>Hapus</a>";
                      }else{
                          $tindakan="<a href=\"{$url_rewrite}/module/mutasiKptls/dftr_review_edit_aset_penetapan.php?id={$value[Mutasi_ID]}\" class=\"btn btn-success btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i> View</a>";
                      }
                }elseif($value['FixMutasi']==1){
