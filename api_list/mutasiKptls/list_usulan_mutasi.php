...
$data = $MUTASI->retrieve_penetapan_list_usulan($dataParam); 
//pr($data);
//exit;
...
$sQuery = "
    ...
    WHERE  us.Jenis_Usulan = 'MTSKPTLS' AND us.StatusPenetapan = 0
...
foreach ($data as $key => $value)
              ...
              $totalNilaiPerolehan = $MUTASI->TotalNilaiPerolehanRev($value[Usulan_ID]);
