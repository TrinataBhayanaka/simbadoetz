...
foreach ($data as $key => $value)
              ...
              $tindakan="<a href=\"{$url_rewrite}/module/mutasiKptls/penghapusan_usulan_daftar_proses_hapus.php?id={$value[Usulan_ID]}\" class=\"btn btn-danger btn-small\" onclick=\"return confirm('Hapus Data');\" style=\"margin-top:3px\"><i class=\"fa fa-trash\"></i>&nbsp;Hapus</a>
              
              <a href=\"{$url_rewrite}/module/mutasiKptls/dftr_review_edit_aset_usulan.php?id={$value[Usulan_ID]}\" class=\"btn btn-success btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;View</a>
            ...
            <a target=\"_blank\" href=\"{$url_rewrite}/report/template/MUTASI/cetak_usulan_mutasi.php?idusulan={$value[Usulan_ID]}&noUsul={$value[NoUsulan]}&tglHapus={$value[TglUpdate]}\" class=\"btn btn-info btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-file-pdf-o\"></i> Pdf</a>&nbsp
             <a target=\"_blank\" href=\"{$url_rewrite}/report/template/MUTASI/cetak_usulan_mutasi.php?idusulan={$value[Usulan_ID]}&noUsul={$value[NoUsulan]}&tglHapus={$value[TglUpdate]}&tipe_file=2\" class=\"btn btn-info btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-file-excel-o\"></i> Excel</a>&nbsp";
                 ...
                 $tindakan="<a href=\"{$url_rewrite}/module/mutasiKptls/dftr_review_edit_aset_usulan.php?id={$value[Usulan_ID]}\" class=\"btn btn-success btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;View</a>
