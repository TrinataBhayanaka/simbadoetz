...
$data = $PENGGUNAAN->retrieve_daftar_penetapan_penggunaan_view_validasi($dataParam); 
//pr($data);
...
$tahun = $_GET['tahun'];
$paramfilter = "AND (p.FixPenggunaan = 0 or p.FixPenggunaan is null)  
...
foreach ($data as $key => $value)
						{      
              $tindakan="<a href=\"{$url_rewrite}/module/penggunaanv2/validasi_penggunaan.php?id={$value[Penggunaan_ID]}\" class=\"btn btn-success btn-small\" onclick=\"return confirm('Validasi Data');\" style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;Validasi</a>";
