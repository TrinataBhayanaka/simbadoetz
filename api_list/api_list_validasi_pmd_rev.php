...
$data = $PENGHAPUSAN->retrieve_list_validasi_pmd_rev($dataParam); 
//pr($data);
...
if($thnParam!= ''){
  $paramCount = " WHERE YEAR(TglHapus) ='{$thnParam}' AND FixPenghapusan=1 AND Jenis_Hapus='PMD' AND Status = '1'"; 
}else{
  $paramCount = "";
}
$sQuery = "
