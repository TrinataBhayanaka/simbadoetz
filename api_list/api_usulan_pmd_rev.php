...
$data = $PENGHAPUSAN->retrieve_daftar_usulan_penghapusan_pmd_rev($dataParam); 
//pr($data);
...
if($thnParam!= ''){
  $paramCount = " WHERE YEAR(Usl.TglUpdate) ='{$thnParam}' AND Usl.FixUsulan=1 AND Usl.Jenis_Usulan='PMD'"; 
}else{
  $paramCount = "";
}
$sQuery = "
