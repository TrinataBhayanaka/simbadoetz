...
$data = $PENGGUNAAN->retrieve_daftar_penetapan_penggunaan_v2($dataParam); 
//pr($data);
...
$tahun = $_GET['tahun'];
$paramfilter = "AND (p.NotUse = 0 or p.NotUse is null or p.NotUse = 1) 
                AND (p.FixPenggunaan = 0 or p.FixPenggunaan is null or p.FixPenggunaan = 1 )  
...
foreach ($data as $key => $value)
              ...
              if($value['Status']==1){
                  ...
                  $tindakan="<a href=\"{$url_rewrite}/module/penggunaanv2/dftr_review_usulan_penggunaan.php?id={$value[Penggunaan_ID]}\" class=\"btn btn-success btn-small\" onclick=\"return confirm('View Data');\" style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;View</a>";
              }else{
                  $label="warning";
                  $text="<span class=\"label label-{$label}\" >belum divalidasi</span>";

                  $tindakan="<a href=\"{$url_rewrite}/module/penggunaanv2/penghapusan_usulan_daftar_proses_hapus_penggunaan.php?id={$value[Penggunaan_ID]}\" class=\"btn btn-danger btn-small\" onclick=\"return confirm('Hapus Data');\" style=\"margin-top:3px\"><i class=\"fa fa-trash\"></i>&nbsp;Hapus</a>
                    <a href=\"{$url_rewrite}/module/penggunaanv2/dftr_review_usulan_penggunaan.php?id={$value[Penggunaan_ID]}\" class=\"btn btn-success btn-small\" onclick=\"return confirm('View Data');\"style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;View</a>";
