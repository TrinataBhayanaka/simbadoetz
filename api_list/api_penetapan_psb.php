...
foreach ($data as $key => $value)
              ...
              //     $text="sudah ditetapkan";
                // }
                 ...
                 if($value['Usulan_ID']!=""){
                   $tindakan="<a href=\"{$url_rewrite}/module/penghapusan/dftr_review_edit_penetapan_usulan_psb.php?id={$value[Penghapusan_ID]}\" class=\"btn btn-success btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-pencil-square-o\"></i> View</a>&nbsp;
              <a target=\"_blank\" href=\"{$url_rewrite}/report/template/PENGHAPUSAN/cetak_sk_penghapusan_sebagian.php?idpenetapan={$value[Penghapusan_ID]}&sk={$value[NoSKHapus]}&tglHapus={$value[TglHapus]}\" class=\"btn btn-info btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-file-pdf-o\"></i> Pdf</a>&nbsp;
              <a target=\"_blank\" href=\"{$url_rewrite}/report/template/PENGHAPUSAN/cetak_sk_penghapusan_sebagian.php?idpenetapan={$value[Penghapusan_ID]}&sk={$value[NoSKHapus]}&tglHapus={$value[TglHapus]}&tipe_file=2\" class=\"btn btn-info btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-file-excel-o\"></i> Excel</a>&nbsp;";
                }else{
                 $tindakan=" <a target=\"_blank\" href=\"{$url_rewrite}/report/template/PENGHAPUSAN/cetak_sk_penghapusan_sebagian.php?idpenetapan={$value[Penghapusan_ID]}&sk={$value[NoSKHapus]}&tglHapus={$value[TglHapus]}\" class=\"btn btn-info btn-small\"  style=\"margin-top:3px\"><i class=\"fa fa-file-pdf-o\"></i> Pdf</a>&nbsp;
                 <a target=\"_blank\" href=\"{$url_rewrite}/report/template/PENGHAPUSAN/cetak_sk_penghapusan_sebagian.php?idpenetapan={$value[Penghapusan_ID]}&sk={$value[NoSKHapus]}&tglHapus={$value[TglHapus]}&tipe_file=2\" class=\"btn btn-info btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-file-excel-o\"></i> Excel</a>&nbsp;";
