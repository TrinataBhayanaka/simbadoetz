...
$data = $PERENCANAAN->retrieve_daftar_perencanaan_pengadaan($dataParam); 
// pr($data);
// exit;
...
foreach ($data as $key => $value)
       ...
       //          }else{
       //           $tindakan=" <a target=\"_blank\" href=\"{$url_rewrite}/report/template/PENGHAPUSAN/cetak_sk_penghapusan.php?idpenetapan={$value[Penghapusan_ID]}&sk={$value[NoSKHapus]}\" class=\"btn btn-info btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-file-pdf-o\"></i> Report</a>&nbsp;
       //           <a target=\"_blank\" href=\"{$url_rewrite}/report/template/PENGHAPUSAN/cetak_sk_penghapusan.php?idpenetapan={$value[Penghapusan_ID]}&sk={$value[NoSKHapus]}&tipe_file=2\" class=\"btn btn-info btn-small\" style=\"margin-top:3px\"><i class=\"fa fa-file-excel-o\"></i> Excel</a>&nbsp;";
       ...
       //        $TotalAset=count($Asetditerima);
                             ...
                             // $row[]=$checkbox;
                             $row[]=$value['Uraian'] ;
                             $row[]=$value['NamaRekening'] ;
                             $row[]=$value['Kuantitas'] ;
                             $row[]= $value['Harga_satuan'] ;
                             $row[]= $value['Harga_satuan'] ;
                             // $row[]=$value['Kode_Kelompok'] ;
                             // $row[]=$value['Kode_Kelompok'] ;
