...
//retrieve html
$html=$REPORT->retrieve_html_penetapan_pemindahtanganan_cetak_seluruh($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan pemidahtanganan aset cetak seluruh data $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan pemidahtanganan aset cetak seluruh data $waktu.pdf";
