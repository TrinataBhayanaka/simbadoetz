...
$query= "SELECT BASPA.Aset_ID, A.NamaAset, A.LastSatker_ID, A.Info, A.AsalUsul, A.NomorReg, A.Alamat, L.KodeLokasi,
                ...
                WHERE BASP.FixPemindahtanganan=1 AND BASP.Status=1 AND BASP.BASP_ID='$id'
...
//retrieve_html_kir
$html=$REPORT->retrieve_html_penetapan_aset_yang_dipindahtangankan_tervalidasi($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan aset yang dipindahtangankan tervalidasi $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan aset yang dipindahtangankan tervalidasi $waktu.pdf";
