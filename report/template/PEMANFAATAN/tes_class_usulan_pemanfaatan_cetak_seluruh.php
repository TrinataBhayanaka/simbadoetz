...
$query= "SELECT A.LastSatker_ID, A.NamaAset, MGRA.Aset_ID, A.NomorReg, 
                ...
                $parameter MGRA.StatusUsulan=0
                ORDER BY MGRA.Aset_ID asc ";
...
//retrieve html
$html=$REPORT->retrieve_html_usulan_pemanfaatan_cetak_seluruh($result_query, $gambar);
...
$namafile="$path/report/output/Daftar usulan pemanfaatan cetak seluruh data $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar usulan pemanfaatan cetak seluruh data $waktu.pdf";
