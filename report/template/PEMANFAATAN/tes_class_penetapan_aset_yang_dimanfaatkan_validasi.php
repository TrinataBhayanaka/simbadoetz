...
$query= "SELECT PMNFA.Aset_ID, A.NamaAset, A.LastSatker_ID, A.Info, A.AsalUsul, A.NomorReg, A.Alamat, L.KodeLokasi,
                ...
                LEFT JOIN Pemanfaatan AS PMNF ON PMNFA.Pemanfaatan_ID=PMNF.Pemanfaatan_ID
                ...
                WHERE PMNF.FixPemanfaatan=1 AND PMNF.Status=1 AND PMNF.Pemanfaatan_ID='$id'
                ORDER BY PMNF.Pemanfaatan_ID asc limit 50";
...
//retrieve html
$html=$REPORT->retrieve_html_penetapan_aset_yang_dimanfaatkan_tervalidasi($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan aset yang dimanfaatkan tervalidasi $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan aset yang dimanfaatkan tervalidasi $waktu.pdf";
