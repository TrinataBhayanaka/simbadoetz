...
$query= "SELECT A.LastSatker_ID, A.NamaAset, PGNA.Aset_ID, A.NomorReg, 
                ...
                $parameter PGNA.Status=1 AND PGNA.StatusMenganggur=0 AND PGNA.StatusMutasi=0
...
//retrieve html
$html=$REPORT->retrieve_html_penetapan_bmd_menganggur_cetak_seluruh($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan bmd menganggur cetak seluruh data $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan bmd menganggur cetak seluruh data $waktu.pdf";
