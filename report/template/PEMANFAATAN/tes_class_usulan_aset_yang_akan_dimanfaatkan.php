...
$query= "SELECT UA.Aset_ID, A.NamaAset, A.LastSatker_ID, A.Info, A.AsalUsul, A.NomorReg, A.Alamat, L.KodeLokasi,
                ...
                WHERE UA.Jenis_Usulan='MNF' AND UA.StatusPenetapan=0 AND UA.Usulan_ID='$id' 
...
//retrieve html 
$html=$REPORT->retrieve_html_usulan_aset_yang_akan_dimanfaatkan($result_query, $gambar);
...
$namafile="$path/report/output/Daftar usulan aset yang akan dimanfaatkan $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar usulan aset yang akan dimanfaatkan $waktu.pdf";
