...
$query= "SELECT A.LastSatker_ID, A.NamaAset, UA.Aset_ID, A.NomorReg, 
                ...
                $parameter UA.StatusPenetapan=0 AND UA.Jenis_Usulan='MNF'
...
//retrieve html
$html=$REPORT->retrieve_html_penetapan_pemanfaatan_cetak_seluruh($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan pemanfaatan cetak seluruh data $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan pemanfaatan cetak seluruh data $waktu.pdf";
