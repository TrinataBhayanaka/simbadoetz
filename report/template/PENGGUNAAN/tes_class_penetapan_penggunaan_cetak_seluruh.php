...
$query= "SELECT A.LastSatker_ID, A.NamaAset, A.Aset_ID, A.NomorReg, 
                ...
                $parameter  A.NotUse=0 AND A.LastPenggunaan_ID IS NULL AND A.LastSatker_ID <> 0
                AND A.OriginDbSatker <> 0 AND A.OrigSatker_ID <>0 AND A.Status_Validasi_Barang=1
...
//retrieve html
$html=$REPORT->retrieve_html_penetapan_penggunaan_cetak_seluruh($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan penggunaan cetak daftar aset $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan penggunaan cetak daftar aset $waktu.pdf";
