...
$query= "SELECT PGNA.Aset_ID, A.NamaAset, A.LastSatker_ID, A.Info, A.AsalUsul, A.NomorReg,
                ...
                WHERE PGN.FixPenggunaan=1 AND PGN.Status=0 AND PGN.Penggunaan_ID='$id'
                ORDER BY PGN.Penggunaan_ID asc ";
...
//retrieve html
$html=$REPORT->retrieve_html_penetapan_aset_yang_digunakan($result_query, $gambar);
...
$namafile="$path/report/output/Daftar usulan aset yang digunakan $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar usulan aset yang digunakan $waktu.pdf";
