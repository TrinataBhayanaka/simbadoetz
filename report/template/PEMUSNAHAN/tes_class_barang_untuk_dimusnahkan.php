...
$query="SELECT UA.Aset_ID, A.NamaAset, A.LastSatker_ID, A.Info, A.AsalUsul, A.Alamat, L.KodeLokasi,
				...
				LEFT JOIN BAPemusnahanAset AS BAPA ON BAPA.Aset_ID=A.Aset_ID
				LEFT JOIN BAPemusnahan AS BAP ON BAP.BAPemusnahan_ID=BAPA.BAPemusnahan_ID
                WHERE UA.Jenis_Usulan='MSN' AND UA.StatusPenetapan=0 AND UA.Usulan_ID='$id'";
...
//retrieve html
$html=$REPORT->retrieve_html_barang_untuk_dimusnahkan($result_query, $gambar);
...
$namafile="$path/report/output/Daftar usulan aset untuk dimusnahkan $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar usulan aset untuk dimusnahkan $waktu.pdf";
