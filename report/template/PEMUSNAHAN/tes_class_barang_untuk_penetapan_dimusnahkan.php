...
$query="SELECT BAPA.Aset_ID, BAP.NoBAPemusnahan, A.NamaAset, A.LastSatker_ID, A.Info, A.AsalUsul, A.Alamat, L.KodeLokasi,
                ...
                WHERE BAP.FixPemusnahan=1 AND BAP.Status=0 AND
...
//retrieve html
$html=$REPORT->retrieve_html_barang_untuk_penetapan_dimusnahkan($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan pemusnahan aset $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan pemusnahan aset $waktu.pdf";
