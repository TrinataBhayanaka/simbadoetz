...
$query = "SELECT A.Aset_ID, A.NomorReg, K.Kode, A.NamaAset,
			...
			A.Usulan_Pemusnahan_ID IS NULL
			";
...
//retrieve html
$html=$REPORT->retrieve_html_daftar_pemusnahan_filter_cetak_seluruh($result_query, $gambar);
...
$namafile="$path/report/output/Daftar usulan pemusnahan aset cetak seluruh data $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar usulan pemusnahan aset cetak seluruh data $waktu.pdf";
