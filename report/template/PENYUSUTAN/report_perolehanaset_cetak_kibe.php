...
//retrieve html
$html=$REPORT->retrieve_html_penyusutan_e($result, $gambar);
/*$count = count($html);
...
$namafile="$path/report/output/Penyusutan E $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Penyusutan E $waktu.pdf";
...
else 
{
	...
	$waktu=date("d-m-y_h:i:s");
	$filename ="PENYUSUTAN-E_$waktu.xls";
