...
$kelompok=$_REQUEST['kelompok_id11'];
$tglawaltransfer = $_REQUEST['gdg_cdg_lapem_tglawal'];
$tglakhirtransfer = $_REQUEST['gdg_cdg_lapem_tglakhir'];
...
$namafile="$path/report/output/Laporan Pemeriksaan Barang atau Gudang $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Laporan Pemeriksaan Barang atau Gudang $waktu.pdf";
