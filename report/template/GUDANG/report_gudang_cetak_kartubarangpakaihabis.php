...
$tglawaltransfer = $_REQUEST['gdg_cdgkarph_tglawal'];
$tglakhirtransfer = $_REQUEST['gdg_cdgkarph_tglakhir'];
...
$namafile="$path/report/output/Kartu Barang Pakai Habis_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Kartu Barang Pakai Habis_$waktu.pdf";
