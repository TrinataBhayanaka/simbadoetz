...
$mode = $_REQUEST['mode'];
$tab = $_REQUEST['tab'];
$tahun = $_REQUEST['gdg_cdgperph_tahun'];
...
$namafile="$path/report/output/Persediaan Barang Pakai Habis $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Persediaan Barang Pakai Habis $waktu.pdf";
