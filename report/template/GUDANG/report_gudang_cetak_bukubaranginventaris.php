...
$namafile="$path/report/output/Buku Barang Inventaris $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Buku Barang Inventaris $waktu.pdf";
