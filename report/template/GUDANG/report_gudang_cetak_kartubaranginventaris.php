...
$tglawaltransfer = $_REQUEST['gdg_cdgkar1_tglawal'];
$tglakhirtransfer = $_REQUEST['gdg_cdgkar1_tglakhir'];
...
$namafile="$path/report/output/Kartu Barang Inventaris_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Kartu Barang Inventaris_$waktu.pdf";
