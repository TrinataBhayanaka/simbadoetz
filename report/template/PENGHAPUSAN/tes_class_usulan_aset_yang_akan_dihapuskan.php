...
$namafile="$path/report/output/Daftar usulan aset yang akan dihapuskan $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar usulan aset yang akan dihapuskan $waktu.pdf";
