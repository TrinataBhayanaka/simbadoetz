...
$tglawalperolehan = $_REQUEST['tglPerolehanAwalNonAset'];
$tglakhirperolehan = $_REQUEST['tglPerolehanAkhirNonAset'];
...
$url = "report_perolehanaset_cetak_non_aset.php?$paramater_url";
