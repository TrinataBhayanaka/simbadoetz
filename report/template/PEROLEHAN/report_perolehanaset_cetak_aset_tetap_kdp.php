...
//retrieve html
//$html=$REPORT->retrieve_html_asetTetapkdp($resultParamGol,$gambar,$skpd_id,$tglawalperolehan,$tglakhirperolehan,$TAHUN_AKTIF);
$html=$REPORT->retrieve_html_asetTetapkdp($resultParamGol,$gambar,$skpd_id,$tglawalperolehan,$tglakhirperolehan,$tahunNeraca,$status);
...
$namafile="$path/report/output/Daftar Aset Tetap KDP_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Daftar Aset Tetap KDP_$waktu.pdf";
