...
function show_table_neraca($kodekelompok,$Aset_ID){
    ...
    if($param == '01') {
        ...
        $tabel = 'nasetlainnya_bangunan2017';
        ...
        $tabel = 'nasetlainnya_jaringan2017';
        ...
        $tabel = 'nasetlainnya_asetlain2017';
        $keterangan="";

    } elseif($param == '06') {

        $tabel = 'nasetlainnya_kdp2017';
