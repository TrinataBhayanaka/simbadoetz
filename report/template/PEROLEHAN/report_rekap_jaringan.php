...
//retrieve html
$html=$REPORT->retrieve_rekap_jaringan($resultParamGol,$gambar,$skpd_id,$tglawalperolehan,$tglakhirperolehan);
/*$count = count($html);
	for ($i = 0; $i < $count; $i++) {
		 echo $html[$i];     
	}
...
$namafile="$path/report/output/Rekap Jaringan_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rekap Jaringan_$waktu.pdf";
...
{
	$waktu=date("d-m-y_h:i:s");
	$filename ="Rekap_Jaringan_$waktu.xls";
