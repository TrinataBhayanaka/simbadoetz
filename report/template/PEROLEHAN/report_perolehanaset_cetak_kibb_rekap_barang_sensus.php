...
$namafile="$path/report/output/Rekap Kartu Inventaris Barang Sensus B $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rekap Kartu Inventaris Barang Sensus B $waktu.pdf";
...
else
{
	...
	$waktu=date("d-m-y_h:i:s");
	$filename ="Rekap_Kartu_Inventaris_Barang_Sensus_B_$waktu.xls";
