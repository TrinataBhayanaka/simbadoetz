...
$namafile="$path/report/output/Kartu Barang B_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Kartu Barang B_$waktu.pdf";
...
else
{
	// echo $DATABARU;*/
	$waktu=date("d-m-y_h:i:s");
	$filename ="Kartu_Barang_B_$waktu.xls";
