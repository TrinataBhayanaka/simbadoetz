...
$tglawalperolehan = $_REQUEST['tglPerolehanAwalAst'];
$tglakhirperolehan = $_REQUEST['tglPerolehanAkhirAst'];
...
$url = "report_perolehanaset_cetak_aset_tetap_lainnya.php?$paramater_url";
