...
$namafile="$path/report/output/Rekap Kartu Inventaris Barang B $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rekap Kartu Inventaris Barang B $waktu.pdf";
...
{
	$waktu=date("d-m-y_h:i:s");
	$filename ="Rekap_Kartu_Inventaris_Barang_B_$waktu.xls";
