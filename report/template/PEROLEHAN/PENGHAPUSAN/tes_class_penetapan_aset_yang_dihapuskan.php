...
$query= "SELECT PHPSA.Aset_ID, A.NamaAset, A.LastSatker_ID, A.Info, A.AsalUsul, A.NomorReg,
                ...
                WHERE PHPS.FixPenghapusan=1 AND PHPS.Status=0 AND PHPS.Penghapusan_ID='$id'
...
//retrieve_html_kir
$html=$REPORT->retrieve_html_penetapan_aset_yang_dihapuskan($result_query, $gambar);
...
$waktu=date("dmyhis");
$namafile="$path/report/output/Daftar Cetak Usulan Aset yang Dihapuskan_$waktu.pdf";

$mpdf->Output("$namafile",'F');

$namafile_web= "$url_rewrite/report/output/Daftar Cetak Usulan Aset yang Dihapuskan_$waktu.pdf";

echo "<script>window.location.href='$namafile_web';</script>";
//$mpdf->Output('Daftar Cetak Usulan Aset yang Dihapuskan.pdf', 'D');
