...
$waktu=date("dmyhis");
$namafile="$path/report/output/Daftar Cetak Penetapan Aset yang Dihapuskan Tervalidasi_$waktu.pdf";

$mpdf->Output("$namafile",'F');

$namafile_web= "$url_rewrite/report/output/Daftar Cetak Penetapan Aset yang Dihapuskan Tervalidasi_$waktu.pdf";

echo "<script>window.location.href='$namafile_web';</script>";
//$mpdf->Output('Daftar Cetak Usulan Aset yang Dihapuskan Tervalidasi.pdf', 'D');
