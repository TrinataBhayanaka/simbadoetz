...
$namafile="$path/report/output/Daftar Aset Tetap Mesin_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Daftar Aset Tetap Mesin_$waktu.pdf";
...
{
	$waktu=date("d-m-y_h:i:s");
	$filename ="Daftar_Aset_Tetap_Mesin_$waktu.xls";
