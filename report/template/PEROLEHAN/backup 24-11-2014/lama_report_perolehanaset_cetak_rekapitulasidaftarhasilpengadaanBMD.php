...
$waktu=date("dymhis");
$namafile="$path/report/output/Rekapitulasi Daftar Hasil Pengadaan BMD_$waktu.pdf";

$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rekapitulasi Daftar Hasil Pengadaan BMD_$waktu.pdf";
