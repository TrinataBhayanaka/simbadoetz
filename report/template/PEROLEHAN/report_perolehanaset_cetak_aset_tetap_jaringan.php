...
$namafile="$path/report/output/Daftar Aset Tetap Jaringan $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Daftar Aset Tetap Jaringan $waktu.pdf";
