...
$html=$REPORT->retrieve_html_asetTetapJaringan($resultParamGol,$gambar,$skpd_id,$tglawalperolehan,$tglakhirperolehan,$tahunNeraca,$status);
...
$namafile="$path/report/output/Daftar Aset Tetap Jaringan_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Daftar Aset Tetap Jaringan_$waktu.pdf";
...
{
	$waktu=date("d-m-y_h:i:s");
	$filename ="Daftar_Aset_Tetap_Jaringan_$waktu.xls";
