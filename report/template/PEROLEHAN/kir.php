...
$kir = $_REQUEST['kir'];
// pr($_REQUEST);
$paramater_url="menuID=$modul&mode=$mode&tab=$tab&skpd_id=$skpd_id&tglawalperolehan=$tglawalperolehan&tglakhirperolehan=$tglakhirperolehan&kodeRuangan=$kodeRuangan&kir=$kir&tglcetak=$tglcetak&tipe_file=$tipe";
