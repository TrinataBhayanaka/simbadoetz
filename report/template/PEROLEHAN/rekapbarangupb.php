...
$mode = $_REQUEST['mode'];
$tab = $_REQUEST['tab'];
$skpd_id = $_REQUEST['kodeSatker14'];
$tglawalperolehan = $_REQUEST['tglPerolehanAwalrbupb'];
$tglakhirperolehan = $_REQUEST['tglPerolehanAkhirrbupb'];
...
$url = "report_perolehanaset_cetak_rekap_barang_upb.php?$paramater_url";
