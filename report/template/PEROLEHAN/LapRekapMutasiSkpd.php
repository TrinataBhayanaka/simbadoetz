...
$tglawalperolehan = $_REQUEST['tglPerolehanAwalRekapLapMutasi'];
$tglakhirperolehan = $_REQUEST['tglPerolehanAkhirRekapLapMutasi'];
...
$url = "report_perolehanaset_cetak_rekap_mutasi_barang.php?$paramater_url";
