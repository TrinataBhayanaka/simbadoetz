...
echo '</pre>';
*/
$result_query = $REPORT->get_report_rekap_penerimaan_pihak_ketiga($get_satker, $date_awal, $date_akhir);
...
$waktu=date("dymhis");
$namafile="$path/report/output/Rekapitulasi Penerimaan Pihak Ketiga BMD_$waktu.pdf";

$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rekapitulasi Penerimaan Pihak Ketiga_$waktu.pdf";
