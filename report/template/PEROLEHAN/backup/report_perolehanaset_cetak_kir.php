...
$waktu=date("dymhis");
$namafile="$path/report/output/Kartu Inventaris Ruangan_$waktu.pdf";

$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Kartu Inventaris Ruangan_$waktu.pdf";
