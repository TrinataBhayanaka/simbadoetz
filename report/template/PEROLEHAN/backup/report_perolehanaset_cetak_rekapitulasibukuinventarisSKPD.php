...
echo '</pre>';
*/
$result_query = $REPORT->get_report_rekap_inv_skpd($get_satker);
...
$waktu=date("dymhis");
$namafile="$path/report/output/Rekapitulasi Buku Inventaris SKPD_$waktu.pdf";

$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rekapitulasi Buku Inventaris SKPD_$waktu.pdf";
