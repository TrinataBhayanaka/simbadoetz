...
//exit;
$result_query = $REPORT->get_report_rekap_pengadaan_BMD($get_satker, $date_awal, $tgl_akhir);

//print_r($result_query);
//exit;
//$html = $REPORT->retrieve_html_1($result_query, $gambar,$tglawalperolehan, $tglakhirperolehan);
...
$waktu=date("dymhis");
$namafile="$path/report/output/Rekapitulasi Pengadaan BMD_$waktu.pdf";

$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rekapitulasi Pengadaan BMD_$waktu.pdf";
