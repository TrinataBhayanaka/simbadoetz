...
//retrieve html
//$html=$REPORT->retrieve_html_asetTetapGedung($resultParamGol,$gambar,$skpd_id,$tglawalperolehan,$tglakhirperolehan,$TAHUN_AKTIF);
$html=$REPORT->retrieve_html_asetTetapGedung($resultParamGol,$gambar,$skpd_id,$tglawalperolehan,$tglakhirperolehan,$tahunNeraca,$status);
...
$namafile="$path/report/output/Daftar Aset Tetap Bangunan_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Daftar Aset Tetap Bangunan_$waktu.pdf";
