...
$tglawalperolehan = $_REQUEST['tglPerolehanAwalKdp'];
$tglakhirperolehan = $_REQUEST['tglPerolehanAkhirKdp'];
...
$url = "report_perolehanaset_cetak_aset_tetap_kdp.php?$paramater_url";
