...
$namafile="$path/report/output/Daftar Kebutuhan Pemeliharaan Barang Milik Daerah $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Daftar Kebutuhan Pemeliharaan Barang Milik Daerah $waktu.pdf";
