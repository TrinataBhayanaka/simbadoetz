...
$namafile="$path/report/output/Rencana Tahunan Pemeliharaan Barang $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rencana Tahunan Pemeliharaan Barang $waktu.pdf";
