...
//retrieve html
$html=$REPORT->retrieve_html_rkbu($result_query, $gambar);
...
$waktu=date("dymhis");
$namafile="$path/report/output/RKBU_$waktu.pdf";

$mpdf->Output("$namafile",'F');
$REPORT->show_status_download();
$namafile_web="$url_rewrite/report/output/RKBU_$waktu.pdf";
