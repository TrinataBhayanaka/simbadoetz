...
$mode = $_REQUEST['mode'];
$tab = $_REQUEST['tab'];
$kelompok=$_REQUEST['kelompok_id8'];
$skpd_id = $_REQUEST['skpd_id6'];
$lokasi = $_REQUEST['lokasi_id6'];
$tahun = $_REQUEST['tahun_7'];
$status_prc = '1';
...
/*$query = "select PRC.NamaAset,PRC.Merk,PRC.Kuantitas,PRC.Lokasi_ID,PRC.KodeRekening,PRC.Tahun,PRC.KeteranganPerencanaan,
...
//retrieve html
$html=$REPORT->retrieve_html_dkbmd($result_query, $gambar);
...
$waktu=date("dymhis");
$namafile="$path/report/output/DKBMD_$waktu.pdf";

$mpdf->Output("$namafile",'F');
$REPORT->show_status_download();
$namafile_web="$url_rewrite/report/output/DKBMD_$waktu.pdf";
