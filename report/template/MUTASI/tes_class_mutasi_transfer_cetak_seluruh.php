...
//retrieve html
$html=$REPORT->retrieve_html_mutasi_cetak_seluruh($result_query, $gambar);
...
$namafile="$path/report/output/Daftar penetapan mutasi aset cetak seluruh data $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar penetapan mutasi aset cetak seluruh data $waktu.pdf";
