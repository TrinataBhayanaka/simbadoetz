...
$namafile="$path/report/output/Daftar mutasi transfer antar skpd $waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web= "$url_rewrite/report/output/Daftar mutasi transfer antar skpd $waktu.pdf";
