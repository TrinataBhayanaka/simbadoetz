...
$waktu=date("dmyhis");
$namafile="$path/report/output/Daftar Cetak Seluruh Usulan Penghapusan_$waktu.pdf";

$mpdf->Output("$namafile",'F');

$namafile_web= "$url_rewrite/report/output/Daftar Cetak Seluruh Usulan Penghapusan_$waktu.pdf";
echo "<script>window.location.href='$namafile_web';</script>";

//$mpdf->Output('Daftar Cetak Seluruh Usulan Penghapusan.pdf', 'D');
